...
private slots:
    ...
    void clickActivatesClosesAndAdds() {
        ...
        model.openTranscript(QStringLiteral("s-1"),
                             QStringLiteral("Alpha")); // chip 0: x0=0  x1=9  closeX=7
        model.openTranscript(QStringLiteral("s-2"),
                             QStringLiteral("Beta")); // chip 1: x0=9  x1=17 closeX=15
                                                      // "+":     x0=17 x1=20
