...
// Chip pulls in QtQuick.Controls (Label/ToolTip), whose QML modules live in the
// Qt installation's qml dir; TEST_QML_IMPORT_PATH is baked in at configure time
// so the imports resolve offscreen (Basic style).
class ChipTestSetup : public QObject {
    Q_OBJECT
...
QUICK_TEST_MAIN_WITH_SETUP(tst_chip, ChipTestSetup)

#include "tst_chip_main.moc"
