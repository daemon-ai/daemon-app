...
static bool decode_repeated_completion_notice_ref_call_id(zcbor_state_t *state, struct completion_notice_ref_call_id_r *result);
static bool decode_completion_notice_ref(zcbor_state_t *state, struct completion_notice_ref *result);
static bool decode_repeated_user_msg_notice(zcbor_state_t *state, struct user_msg_notice_r *result);
...
static bool decode_repeated_origin_sender(zcbor_state_t *state, struct origin_sender_r *result);
...
static bool decode_repeated_Approved_reason(zcbor_state_t *state, struct Approved_reason_r *result);
...
static bool decode_repeated_SessionCreate_session(zcbor_state_t *state, struct SessionCreate_session_r *result);
static bool decode_repeated_SessionCreate_profile(zcbor_state_t *state, struct SessionCreate_profile_r *result);
static bool decode_request_session_create(zcbor_state_t *state, struct request_session_create *result);
static bool decode_request_cancel(zcbor_state_t *state, struct request_cancel *result);
static bool decode_repeated_Tree_after(zcbor_state_t *state, struct Tree_after_r *result);
static bool decode_request_tree(zcbor_state_t *state, struct request_tree *result);
...
static bool decode_repeated_DeliverySessions_after(zcbor_state_t *state, struct DeliverySessions_after_r *result);
...
static bool decode_repeated_ApprovalDecide_reason(zcbor_state_t *state, struct ApprovalDecide_reason_r *result);
static bool decode_request_approval_decide(zcbor_state_t *state, struct request_approval_decide *result);
static bool decode_request_fingerprint_list(zcbor_state_t *state, struct request_fingerprint_list *result);
static bool decode_request_fingerprint_revoke(zcbor_state_t *state, struct request_fingerprint_revoke *result);
...
static bool decode_engine_foreign_agent(zcbor_state_t *state, struct engine_foreign_agent *result);
static bool decode_engine_foreign(zcbor_state_t *state, struct engine_foreign *result);
...
static bool decode_foreign_backend_agent_native(zcbor_state_t *state, struct foreign_backend_agent_native *result);
static bool decode_foreign_backend_node_provider(zcbor_state_t *state, struct foreign_backend_node_provider *result);
static bool decode_foreign_backend(zcbor_state_t *state, struct foreign_backend_r *result);
static bool decode_repeated_profile_spec_foreign_backend(zcbor_state_t *state, struct profile_spec_foreign_backend *result);
...
static bool decode_repeated_profile_spec_created_by(zcbor_state_t *state, struct profile_spec_created_by_r *result);
static bool decode_repeated_profile_spec_owner(zcbor_state_t *state, struct profile_spec_owner_r *result);
...
static bool decode_repeated_skill_bundle_signature(zcbor_state_t *state, struct skill_bundle_signature_r *result);
...
static bool decode_repeated_ProfileHistory_after(zcbor_state_t *state, struct ProfileHistory_after_r *result);
...
static bool decode_repeated_CredentialSetLabel_label(zcbor_state_t *state, struct CredentialSetLabel_label_r *result);
static bool decode_request_credential_set_label(zcbor_state_t *state, struct request_credential_set_label *result);
...
static bool decode_repeated_ModelFiles_after(zcbor_state_t *state, struct ModelFiles_after_r *result);
...
static bool decode_repeated_ProviderModels_after(zcbor_state_t *state, struct ProviderModels_after_r *result);
static bool decode_request_provider_models(zcbor_state_t *state, struct request_provider_models *result);
static bool decode_repeated_custom_provider_credential_ref(zcbor_state_t *state, struct custom_provider_credential_ref_r *result);
static bool decode_custom_provider_source_t(zcbor_state_t *state, struct custom_provider_source_t_r *result);
static bool decode_custom_provider(zcbor_state_t *state, struct custom_provider *result);
static bool decode_request_custom_provider_set(zcbor_state_t *state, struct request_custom_provider_set *result);
static bool decode_request_custom_provider_remove(zcbor_state_t *state, struct request_custom_provider_remove *result);
...
static bool decode_repeated_Fields_tstrtstr(zcbor_state_t *state, struct Fields_tstrtstr *result);
static bool decode_auth_step_input_fields(zcbor_state_t *state, struct auth_step_input_fields *result);
static bool decode_auth_step_input_callback(zcbor_state_t *state, struct auth_step_input_callback *result);
static bool decode_auth_step_input(zcbor_state_t *state, struct auth_step_input_r *result);
static bool decode_auth_step_request(zcbor_state_t *state, struct auth_step_request *result);
static bool decode_request_auth_step(zcbor_state_t *state, struct request_auth_step *result);
...
static bool decode_repeated_CheckpointList_after(zcbor_state_t *state, struct CheckpointList_after_r *result);
...
static bool decode_request_session_recap(zcbor_state_t *state, struct request_session_recap *result);
...
static bool decode_repeated_agent_recipe_program(zcbor_state_t *state, struct agent_recipe_program_r *result);
static bool decode_repeated_agent_recipe_args(zcbor_state_t *state, struct agent_recipe_args_r *result);
static bool decode_kv_pair(zcbor_state_t *state, struct kv_pair *result);
static bool decode_repeated_agent_recipe_env(zcbor_state_t *state, struct agent_recipe_env_r *result);
static bool decode_repeated_agent_recipe_endpoint(zcbor_state_t *state, struct agent_recipe_endpoint_r *result);
static bool decode_agent_recipe(zcbor_state_t *state, struct agent_recipe *result);
static bool decode_agent_source(zcbor_state_t *state, struct agent_source_r *result);
static bool decode_agent_protocol(zcbor_state_t *state, struct agent_protocol_r *result);
static bool decode_repeated_agent_entry_protocol(zcbor_state_t *state, struct agent_entry_protocol *result);
static bool decode_repeated_agent_entry_installed(zcbor_state_t *state, struct agent_entry_installed *result);
static bool decode_repeated_agent_entry_version(zcbor_state_t *state, struct agent_entry_version_r *result);
static bool decode_repeated_agent_entry_capabilities(zcbor_state_t *state, struct agent_entry_capabilities_r *result);
static bool decode_agent_verification(zcbor_state_t *state, struct agent_verification_r *result);
static bool decode_repeated_agent_entry_verification(zcbor_state_t *state, struct agent_entry_verification *result);
static bool decode_agent_entry(zcbor_state_t *state, struct agent_entry *result);
static bool decode_request_agent_register(zcbor_state_t *state, struct request_agent_register *result);
static bool decode_request_agent_remove(zcbor_state_t *state, struct request_agent_remove *result);
...
static bool decode_repeated_tool_info_requires(zcbor_state_t *state, struct tool_info_requires_r *result);
...
static bool decode_request_tool_set_enabled(zcbor_state_t *state, struct request_tool_set_enabled *result);
...
static bool decode_repeated_GatewaySet_addr(zcbor_state_t *state, struct GatewaySet_addr_r *result);
static bool decode_request_gateway_set(zcbor_state_t *state, struct request_gateway_set *result);
...
static bool decode_repeated_RoutingListChats_after(zcbor_state_t *state, struct RoutingListChats_after_r *result);
static bool decode_request_routing_list_chats(zcbor_state_t *state, struct request_routing_list_chats *result);
...
static bool decode_repeated_TransportRooms_after(zcbor_state_t *state, struct TransportRooms_after_r *result);
static bool decode_request_transport_rooms(zcbor_state_t *state, struct request_transport_rooms *result);
static bool decode_request_transport_disconnect(zcbor_state_t *state, struct request_transport_disconnect *result);
static bool decode_request_transport_remove(zcbor_state_t *state, struct request_transport_remove *result);
static bool decode_request_transport_connect(zcbor_state_t *state, struct request_transport_connect *result);
static bool decode_request_transport_set_enabled(zcbor_state_t *state, struct request_transport_set_enabled *result);
static bool decode_repeated_TransportSetLabel_label(zcbor_state_t *state, struct TransportSetLabel_label_r *result);
static bool decode_request_transport_set_label(zcbor_state_t *state, struct request_transport_set_label *result);
static bool decode_repeated_ConvList_after(zcbor_state_t *state, struct ConvList_after_r *result);
...
static bool decode_repeated_RosterList_after(zcbor_state_t *state, struct RosterList_after_r *result);
static bool decode_request_roster_list(zcbor_state_t *state, struct request_roster_list *result);
static bool decode_request_roster_add(zcbor_state_t *state, struct request_roster_add *result);
static bool decode_request_roster_update(zcbor_state_t *state, struct request_roster_update *result);
static bool decode_request_roster_remove(zcbor_state_t *state, struct request_roster_remove *result);
...
static bool decode_repeated_FsList_after(zcbor_state_t *state, struct FsList_after_r *result);
...
static bool decode_foreign_stage(zcbor_state_t *state, struct foreign_stage_r *result);
static bool decode_repeated_foreign_failure_agent(zcbor_state_t *state, struct foreign_failure_agent_r *result);
static bool decode_foreign_failure(zcbor_state_t *state, struct foreign_failure *result);
static bool decode_repeated_turn_summary_failure(zcbor_state_t *state, struct turn_summary_failure_r *result);
...
static bool decode_repeated_approval_info_fingerprint(zcbor_state_t *state, struct approval_info_fingerprint_r *result);
static bool decode_repeated_approval_info_detail(zcbor_state_t *state, struct approval_info_detail_r *result);
static bool decode_approval_info(zcbor_state_t *state, struct approval_info *result);
static bool decode_repeated_approval_page_next(zcbor_state_t *state, struct approval_page_next_r *result);
static bool decode_approval_page(zcbor_state_t *state, struct approval_page *result);
static bool decode_response_approvals(zcbor_state_t *state, struct response_approvals *result);
static bool decode_repeated_remembered_fingerprint_label(zcbor_state_t *state, struct remembered_fingerprint_label_r *result);
static bool decode_repeated_remembered_fingerprint_remembered_at_ms(zcbor_state_t *state, struct remembered_fingerprint_remembered_at_ms *result);
static bool decode_remembered_fingerprint(zcbor_state_t *state, struct remembered_fingerprint *result);
static bool decode_response_fingerprints(zcbor_state_t *state, struct response_fingerprints *result);
...
static bool decode_delegation_lifetime(zcbor_state_t *state, struct delegation_lifetime_r *result);
static bool decode_repeated_unit_node_lifetime(zcbor_state_t *state, struct unit_node_lifetime_r *result);
static bool decode_repeated_unit_node_engine(zcbor_state_t *state, struct unit_node_engine_r *result);
static bool decode_unit_node(zcbor_state_t *state, struct unit_node *result);
static bool decode_repeated_tree_report_next(zcbor_state_t *state, struct tree_report_next_r *result);
...
static bool decode_node_event_profiles_changed(zcbor_state_t *state, struct node_event_profiles_changed *result);
...
static bool decode_repeated_TransportChanged_presence(zcbor_state_t *state, struct TransportChanged_presence *result);
static bool decode_disconnect_reason(zcbor_state_t *state, struct disconnect_reason_r *result);
static bool decode_repeated_TransportChanged_reason(zcbor_state_t *state, struct TransportChanged_reason_r *result);
static bool decode_repeated_TransportChanged_message(zcbor_state_t *state, struct TransportChanged_message_r *result);
static bool decode_repeated_TransportChanged_fatal(zcbor_state_t *state, struct TransportChanged_fatal *result);
static bool decode_node_event_transport_changed(zcbor_state_t *state, struct node_event_transport_changed *result);
static bool decode_conv_change(zcbor_state_t *state, struct conv_change_r *result);
static bool decode_node_event_conversations_changed(zcbor_state_t *state, struct node_event_conversations_changed *result);
static bool decode_membership_change(zcbor_state_t *state, struct membership_change_r *result);
static bool decode_repeated_MembershipChanged_actor(zcbor_state_t *state, struct MembershipChanged_actor_r *result);
static bool decode_repeated_MembershipChanged_reason(zcbor_state_t *state, struct MembershipChanged_reason_r *result);
static bool decode_node_event_membership_changed(zcbor_state_t *state, struct node_event_membership_changed *result);
static bool decode_node_event_contacts_changed(zcbor_state_t *state, struct node_event_contacts_changed *result);
...
static bool decode_repeated_delivery_session_page_next(zcbor_state_t *state, struct delivery_session_page_next_r *result);
static bool decode_delivery_session_page(zcbor_state_t *state, struct delivery_session_page *result);
...
static bool decode_repeated_model_file_page_next(zcbor_state_t *state, struct model_file_page_next_r *result);
static bool decode_model_file_page(zcbor_state_t *state, struct model_file_page *result);
...
static bool decode_repeated_installed_model_mmproj_path(zcbor_state_t *state, struct installed_model_mmproj_path_r *result);
static bool decode_repeated_installed_model_sha256(zcbor_state_t *state, struct installed_model_sha256_r *result);
...
static bool decode_repeated_model_page_next(zcbor_state_t *state, struct model_page_next_r *result);
static bool decode_model_page(zcbor_state_t *state, struct model_page *result);
...
static bool decode_provider_sign_in(zcbor_state_t *state, struct provider_sign_in *result);
static bool decode_repeated_provider_descriptor_sign_in(zcbor_state_t *state, struct provider_descriptor_sign_in_r *result);
...
static bool decode_response_custom_providers(zcbor_state_t *state, struct response_custom_providers *result);
...
static bool decode_repeated_revision_page_next(zcbor_state_t *state, struct revision_page_next_r *result);
static bool decode_revision_page(zcbor_state_t *state, struct revision_page *result);
...
static bool decode_auth_challenge_redirect(zcbor_state_t *state, struct auth_challenge_redirect *result);
static bool decode_auth_challenge_form(zcbor_state_t *state, struct auth_challenge_form *result);
static bool decode_auth_challenge_qr(zcbor_state_t *state, struct auth_challenge_qr *result);
static bool decode_auth_challenge_message(zcbor_state_t *state, struct auth_challenge_message *result);
static bool decode_auth_challenge(zcbor_state_t *state, struct auth_challenge_r *result);
...
static bool decode_auth_step_result_challenge(zcbor_state_t *state, struct auth_step_result_challenge *result);
static bool decode_auth_complete_response(zcbor_state_t *state, struct auth_complete_response *result);
static bool decode_auth_step_result_completed(zcbor_state_t *state, struct auth_step_result_completed *result);
static bool decode_auth_step_result(zcbor_state_t *state, struct auth_step_result_r *result);
static bool decode_response_auth_stepped(zcbor_state_t *state, struct response_auth_stepped *result);
...
static bool decode_repeated_checkpoint_page_next(zcbor_state_t *state, struct checkpoint_page_next_r *result);
static bool decode_checkpoint_page(zcbor_state_t *state, struct checkpoint_page *result);
...
static bool decode_repeated_session_detail_engine(zcbor_state_t *state, struct session_detail_engine *result);
static bool decode_repeated_session_detail_foreign_backend(zcbor_state_t *state, struct session_detail_foreign_backend *result);
static bool decode_model_choice(zcbor_state_t *state, struct model_choice *result);
static bool decode_model_selector(zcbor_state_t *state, struct model_selector *result);
static bool decode_repeated_session_detail_model_selector(zcbor_state_t *state, struct session_detail_model_selector_r *result);
...
static bool decode_repeated_top_tools_name_l(zcbor_state_t *state, struct top_tools_name_l *result);
static bool decode_session_recap(zcbor_state_t *state, struct session_recap *result);
static bool decode_response_session_recap(zcbor_state_t *state, struct response_session_recap *result);
static bool decode_response_agent_catalog(zcbor_state_t *state, struct response_agent_catalog *result);
...
static bool decode_gateway_status(zcbor_state_t *state, struct gateway_status *result);
static bool decode_response_gateway_status(zcbor_state_t *state, struct response_gateway_status *result);
static bool decode_repeated_caps_report_max_composed_profiles(zcbor_state_t *state, struct caps_report_max_composed_profiles *result);
static bool decode_repeated_caps_report_max_ephemeral_per_session(zcbor_state_t *state, struct caps_report_max_ephemeral_per_session *result);
static bool decode_caps_report(zcbor_state_t *state, struct caps_report *result);
static bool decode_response_caps(zcbor_state_t *state, struct response_caps *result);
...
static bool decode_repeated_chat_route_page_next(zcbor_state_t *state, struct chat_route_page_next_r *result);
static bool decode_chat_route_page(zcbor_state_t *state, struct chat_route_page *result);
...
static bool decode_repeated_room_page_next(zcbor_state_t *state, struct room_page_next_r *result);
static bool decode_room_page(zcbor_state_t *state, struct room_page *result);
...
static bool decode_policy_entry(zcbor_state_t *state, struct policy_entry *result);
static bool decode_repeated_adapter_info_policies(zcbor_state_t *state, struct adapter_info_policies_r *result);
static bool decode_conversation_ops(zcbor_state_t *state, struct conversation_ops *result);
static bool decode_repeated_adapter_info_conversation_ops(zcbor_state_t *state, struct adapter_info_conversation_ops_r *result);
static bool decode_membership_ops(zcbor_state_t *state, struct membership_ops *result);
static bool decode_repeated_adapter_info_membership_ops(zcbor_state_t *state, struct adapter_info_membership_ops_r *result);
static bool decode_contacts_ops(zcbor_state_t *state, struct contacts_ops *result);
static bool decode_repeated_adapter_info_contacts_ops(zcbor_state_t *state, struct adapter_info_contacts_ops_r *result);
static bool decode_roster_ops(zcbor_state_t *state, struct roster_ops *result);
static bool decode_repeated_adapter_info_roster_ops(zcbor_state_t *state, struct adapter_info_roster_ops_r *result);
static bool decode_repeated_adapter_info_directory(zcbor_state_t *state, struct adapter_info_directory *result);
...
static bool decode_repeated_transport_instance_info_reason(zcbor_state_t *state, struct transport_instance_info_reason_r *result);
static bool decode_repeated_transport_instance_info_message(zcbor_state_t *state, struct transport_instance_info_message_r *result);
static bool decode_repeated_transport_instance_info_fatal(zcbor_state_t *state, struct transport_instance_info_fatal *result);
static bool decode_repeated_transport_instance_info_enabled(zcbor_state_t *state, struct transport_instance_info_enabled *result);
static bool decode_repeated_transport_instance_info_label(zcbor_state_t *state, struct transport_instance_info_label_r *result);
...
static bool decode_repeated_conv_page_next(zcbor_state_t *state, struct conv_page_next_r *result);
static bool decode_conv_page(zcbor_state_t *state, struct conv_page *result);
...
static bool decode_repeated_contact_page_next(zcbor_state_t *state, struct contact_page_next_r *result);
static bool decode_contact_page(zcbor_state_t *state, struct contact_page *result);
static bool decode_response_contact_page(zcbor_state_t *state, struct response_contact_page *result);
...
static bool decode_repeated_fs_list_page_next(zcbor_state_t *state, struct fs_list_page_next_r *result);
static bool decode_fs_list_page(zcbor_state_t *state, struct fs_list_page *result);
...
static bool decode_repeated_completion_notice_ref_call_id(
		zcbor_state_t *state, struct completion_notice_ref_call_id_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"call_id", tmp_str.len = sizeof("call_id") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).completion_notice_ref_call_id_tstr)))) && (((*result).completion_notice_ref_call_id_choice = completion_notice_ref_call_id_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).completion_notice_ref_call_id_choice = completion_notice_ref_call_id_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_completion_notice_ref(
		zcbor_state_t *state, struct completion_notice_ref *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"child", tmp_str.len = sizeof("child") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).completion_notice_ref_child))))
	&& zcbor_present_decode(&((*result).completion_notice_ref_call_id_present), (zcbor_decoder_t *)decode_repeated_completion_notice_ref_call_id, state, (&(*result).completion_notice_ref_call_id))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_completion_notice_ref_call_id(state, (&(*result).completion_notice_ref_call_id));
	}
...
static bool decode_repeated_user_msg_notice(
		zcbor_state_t *state, struct user_msg_notice_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"notice", tmp_str.len = sizeof("notice") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_completion_notice_ref(state, (&(*result).user_msg_notice_completion_notice_ref_m)))) && (((*result).user_msg_notice_choice = user_msg_notice_completion_notice_ref_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).user_msg_notice_choice = user_msg_notice_null_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct user_msg *result)
{
	...
	&& zcbor_present_decode(&((*result).user_msg_attachments_present), (zcbor_decoder_t *)decode_repeated_user_msg_attachments, state, (&(*result).user_msg_attachments))
	&& zcbor_present_decode(&((*result).user_msg_notice_present), (zcbor_decoder_t *)decode_repeated_user_msg_notice, state, (&(*result).user_msg_notice))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_user_msg_notice(state, (&(*result).user_msg_notice));
	}
...
static bool decode_repeated_origin_sender(
		zcbor_state_t *state, struct origin_sender_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"sender", tmp_str.len = sizeof("sender") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).origin_sender_sender_id_m)))) && (((*result).origin_sender_choice = origin_sender_sender_id_m_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).origin_sender_choice = origin_sender_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct origin *result)
{
	...
	&& (decode_origin_scope_t(state, (&(*result).origin_scope))))
	&& zcbor_present_decode(&((*result).origin_sender_present), (zcbor_decoder_t *)decode_repeated_origin_sender, state, (&(*result).origin_sender))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_origin_sender(state, (&(*result).origin_sender));
	}
...
static bool decode_repeated_Approved_reason(
		zcbor_state_t *state, struct Approved_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).Approved_reason_tstr)))) && (((*result).Approved_reason_choice = Approved_reason_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).Approved_reason_choice = Approved_reason_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct host_response_body_approved *result)
{
	...
	&& zcbor_present_decode(&((*result).Approved_allow_permanent_present), (zcbor_decoder_t *)decode_repeated_Approved_allow_permanent, state, (&(*result).Approved_allow_permanent))
	&& zcbor_present_decode(&((*result).Approved_reason_present), (zcbor_decoder_t *)decode_repeated_Approved_reason, state, (&(*result).Approved_reason))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_Approved_reason(state, (&(*result).Approved_reason));
	}
...
static bool decode_repeated_SessionCreate_session(
		zcbor_state_t *state, struct SessionCreate_session_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).SessionCreate_session_session_id_m)))) && (((*result).SessionCreate_session_choice = SessionCreate_session_session_id_m_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).SessionCreate_session_choice = SessionCreate_session_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_SessionCreate_profile(
		zcbor_state_t *state, struct SessionCreate_profile_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"profile", tmp_str.len = sizeof("profile") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).SessionCreate_profile_profile_ref_m)))) && (((*result).SessionCreate_profile_choice = SessionCreate_profile_profile_ref_m_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).SessionCreate_profile_choice = SessionCreate_profile_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_session_create(
		zcbor_state_t *state, struct request_session_create *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"SessionCreate", tmp_str.len = sizeof("SessionCreate") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && ((zcbor_present_decode(&((*result).SessionCreate_session_present), (zcbor_decoder_t *)decode_repeated_SessionCreate_session, state, (&(*result).SessionCreate_session))
	&& zcbor_present_decode(&((*result).SessionCreate_profile_present), (zcbor_decoder_t *)decode_repeated_SessionCreate_profile, state, (&(*result).SessionCreate_profile))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_SessionCreate_session(state, (&(*result).SessionCreate_session));
		decode_repeated_SessionCreate_profile(state, (&(*result).SessionCreate_profile));
	}
...
static bool decode_repeated_Tree_after(
		zcbor_state_t *state, struct Tree_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).Tree_after_tstr)))) && (((*result).Tree_after_choice = Tree_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).Tree_after_choice = Tree_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_tree(
		zcbor_state_t *state, struct request_tree *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_present_decode(&((*result).Tree_after_present), (zcbor_decoder_t *)decode_repeated_Tree_after, state, (&(*result).Tree_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_Tree_after(state, (&(*result).Tree_after));
	}
...
static bool decode_repeated_DeliverySessions_after(
		zcbor_state_t *state, struct DeliverySessions_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).DeliverySessions_after_tstr)))) && (((*result).DeliverySessions_after_choice = DeliverySessions_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).DeliverySessions_after_choice = DeliverySessions_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_delivery_sessions *result)
{
	...
	&& (zcbor_tstr_decode(state, (&(*result).DeliverySessions_transport))))
	&& zcbor_present_decode(&((*result).DeliverySessions_after_present), (zcbor_decoder_t *)decode_repeated_DeliverySessions_after, state, (&(*result).DeliverySessions_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_DeliverySessions_after(state, (&(*result).DeliverySessions_after));
	}
...
static bool decode_repeated_ApprovalsPending_after(
		zcbor_state_t *state, struct ApprovalsPending_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ApprovalsPending_after_tstr)))) && (((*result).ApprovalsPending_after_choice = ApprovalsPending_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ApprovalsPending_after_choice = ApprovalsPending_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_approvals_pending *result)
{
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_present_decode(&((*result).ApprovalsPending_session_present), (zcbor_decoder_t *)decode_repeated_ApprovalsPending_session, state, (&(*result).ApprovalsPending_session))
	&& zcbor_present_decode(&((*result).ApprovalsPending_after_present), (zcbor_decoder_t *)decode_repeated_ApprovalsPending_after, state, (&(*result).ApprovalsPending_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_ApprovalsPending_after(state, (&(*result).ApprovalsPending_after));
	}
...
static bool decode_repeated_ApprovalDecide_reason(
		zcbor_state_t *state, struct ApprovalDecide_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ApprovalDecide_reason_tstr)))) && (((*result).ApprovalDecide_reason_choice = ApprovalDecide_reason_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ApprovalDecide_reason_choice = ApprovalDecide_reason_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_approval_decide *result)
{
	...
	&& zcbor_present_decode(&((*result).ApprovalDecide_allow_permanent_present), (zcbor_decoder_t *)decode_repeated_ApprovalDecide_allow_permanent, state, (&(*result).ApprovalDecide_allow_permanent))
	&& zcbor_present_decode(&((*result).ApprovalDecide_reason_present), (zcbor_decoder_t *)decode_repeated_ApprovalDecide_reason, state, (&(*result).ApprovalDecide_reason))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_ApprovalDecide_reason(state, (&(*result).ApprovalDecide_reason));
	}
...
static bool decode_request_fingerprint_list(
		zcbor_state_t *state, struct request_fingerprint_list *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"FingerprintList", tmp_str.len = sizeof("FingerprintList") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).FingerprintList_session))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_fingerprint_revoke(
		zcbor_state_t *state, struct request_fingerprint_revoke *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"FingerprintRevoke", tmp_str.len = sizeof("FingerprintRevoke") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).FingerprintRevoke_session))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"fingerprint", tmp_str.len = sizeof("fingerprint") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).FingerprintRevoke_fingerprint))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_engine_foreign_agent(
		zcbor_state_t *state, struct engine_foreign_agent *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_tstr_decode(state, (&(*result).engine_foreign_agent_agent))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_engine_foreign(
		zcbor_state_t *state, struct engine_foreign *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Foreign", tmp_str.len = sizeof("Foreign") - 1, &tmp_str)))))
	&& (decode_engine_foreign_agent(state, (&(*result).engine_foreign_Foreign))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct engine_selector_r *result)
{
	...
	|| (((decode_engine_foreign(state, (&(*result).engine_selector_engine_foreign_m)))) && (((*result).engine_selector_choice = engine_selector_engine_foreign_m_c), true))), zcbor_union_end_code(state), int_res))));
...
static bool decode_foreign_backend_agent_native(
		zcbor_state_t *state, struct foreign_backend_agent_native *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AgentNative", tmp_str.len = sizeof("AgentNative") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"model", tmp_str.len = sizeof("model") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).AgentNative_model_tstr)))) && (((*result).AgentNative_model_choice = AgentNative_model_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).AgentNative_model_choice = AgentNative_model_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_foreign_backend_node_provider(
		zcbor_state_t *state, struct foreign_backend_node_provider *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"NodeProvider", tmp_str.len = sizeof("NodeProvider") - 1, &tmp_str)))))
	...
	&& (decode_provider_selector(state, (&(*result).NodeProvider_provider))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"model", tmp_str.len = sizeof("model") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).NodeProvider_model))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"credential_ref", tmp_str.len = sizeof("credential_ref") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).NodeProvider_credential_ref_tstr)))) && (((*result).NodeProvider_credential_ref_choice = NodeProvider_credential_ref_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).NodeProvider_credential_ref_choice = NodeProvider_credential_ref_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_foreign_backend(
		zcbor_state_t *state, struct foreign_backend_r *result)
{
	zcbor_log("%s\r\n", __func__);
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((decode_foreign_backend_agent_native(state, (&(*result).foreign_backend_agent_native_m)))) && (((*result).foreign_backend_choice = foreign_backend_agent_native_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_foreign_backend_node_provider(state, (&(*result).foreign_backend_node_provider_m)))) && (((*result).foreign_backend_choice = foreign_backend_node_provider_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_profile_spec_foreign_backend(
		zcbor_state_t *state, struct profile_spec_foreign_backend *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"foreign_backend", tmp_str.len = sizeof("foreign_backend") - 1, &tmp_str)))))
	&& (decode_foreign_backend(state, (&(*result).profile_spec_foreign_backend)))));
...
static bool decode_repeated_profile_spec_created_by(
		zcbor_state_t *state, struct profile_spec_created_by_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"created_by", tmp_str.len = sizeof("created_by") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_author(state, (&(*result).profile_spec_created_by_author_m)))) && (((*result).profile_spec_created_by_choice = profile_spec_created_by_author_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).profile_spec_created_by_choice = profile_spec_created_by_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_profile_spec_owner(
		zcbor_state_t *state, struct profile_spec_owner_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"owner", tmp_str.len = sizeof("owner") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).profile_spec_owner_tstr)))) && (((*result).profile_spec_owner_choice = profile_spec_owner_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).profile_spec_owner_choice = profile_spec_owner_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct profile_spec *result)
{
	...
	&& zcbor_present_decode(&((*result).profile_spec_engine_present), (zcbor_decoder_t *)decode_repeated_profile_spec_engine, state, (&(*result).profile_spec_engine))
	&& zcbor_present_decode(&((*result).profile_spec_foreign_backend_present), (zcbor_decoder_t *)decode_repeated_profile_spec_foreign_backend, state, (&(*result).profile_spec_foreign_backend))
	&& zcbor_present_decode(&((*result).profile_spec_created_by_present), (zcbor_decoder_t *)decode_repeated_profile_spec_created_by, state, (&(*result).profile_spec_created_by))
	&& zcbor_present_decode(&((*result).profile_spec_owner_present), (zcbor_decoder_t *)decode_repeated_profile_spec_owner, state, (&(*result).profile_spec_owner))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_profile_spec_foreign_backend(state, (&(*result).profile_spec_foreign_backend));
		decode_repeated_profile_spec_created_by(state, (&(*result).profile_spec_created_by));
		decode_repeated_profile_spec_owner(state, (&(*result).profile_spec_owner));
	}
...
static bool decode_repeated_skill_bundle_signature(
		zcbor_state_t *state, struct skill_bundle_signature_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"signature", tmp_str.len = sizeof("signature") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).skill_bundle_signature_tstr)))) && (((*result).skill_bundle_signature_choice = skill_bundle_signature_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).skill_bundle_signature_choice = skill_bundle_signature_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct skill_bundle *result)
{
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).files_tstrtstr_count, (zcbor_decoder_t *)decode_repeated_files_tstrtstr, state, (*&(*result).files_tstrtstr), sizeof(struct files_tstrtstr))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))
	&& zcbor_present_decode(&((*result).skill_bundle_signature_present), (zcbor_decoder_t *)decode_repeated_skill_bundle_signature, state, (&(*result).skill_bundle_signature))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_skill_bundle_signature(state, (&(*result).skill_bundle_signature));
	}
...
static bool decode_repeated_ProfileHistory_after(
		zcbor_state_t *state, struct ProfileHistory_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ProfileHistory_after_tstr)))) && (((*result).ProfileHistory_after_choice = ProfileHistory_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ProfileHistory_after_choice = ProfileHistory_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_profile_history *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ProfileHistory_id))))
	&& zcbor_present_decode(&((*result).ProfileHistory_after_present), (zcbor_decoder_t *)decode_repeated_ProfileHistory_after, state, (&(*result).ProfileHistory_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_ProfileHistory_after(state, (&(*result).ProfileHistory_after));
	}
...
static bool decode_repeated_SkillHistory_after(
		zcbor_state_t *state, struct SkillHistory_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).SkillHistory_after_tstr)))) && (((*result).SkillHistory_after_choice = SkillHistory_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).SkillHistory_after_choice = SkillHistory_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_skill_history *result)
{
	...
	&& (zcbor_tstr_decode(state, (&(*result).SkillHistory_name))))
	&& zcbor_present_decode(&((*result).SkillHistory_after_present), (zcbor_decoder_t *)decode_repeated_SkillHistory_after, state, (&(*result).SkillHistory_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_SkillHistory_after(state, (&(*result).SkillHistory_after));
	}
...
static bool decode_repeated_CredentialSetLabel_label(
		zcbor_state_t *state, struct CredentialSetLabel_label_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).CredentialSetLabel_label_tstr)))) && (((*result).CredentialSetLabel_label_choice = CredentialSetLabel_label_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).CredentialSetLabel_label_choice = CredentialSetLabel_label_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_credential_set_label(
		zcbor_state_t *state, struct request_credential_set_label *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CredentialSetLabel", tmp_str.len = sizeof("CredentialSetLabel") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"profile", tmp_str.len = sizeof("profile") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).CredentialSetLabel_profile))))
	&& zcbor_present_decode(&((*result).CredentialSetLabel_label_present), (zcbor_decoder_t *)decode_repeated_CredentialSetLabel_label, state, (&(*result).CredentialSetLabel_label))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_CredentialSetLabel_label(state, (&(*result).CredentialSetLabel_label));
	}
...
static bool decode_repeated_ModelFiles_after(
		zcbor_state_t *state, struct ModelFiles_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ModelFiles_after_tstr)))) && (((*result).ModelFiles_after_choice = ModelFiles_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ModelFiles_after_choice = ModelFiles_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_model_files *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (decode_model_engine(state, (&(*result).ModelFiles_engine))))
	&& zcbor_present_decode(&((*result).ModelFiles_after_present), (zcbor_decoder_t *)decode_repeated_ModelFiles_after, state, (&(*result).ModelFiles_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_ModelFiles_after(state, (&(*result).ModelFiles_after));
	}
...
static bool decode_repeated_Models_after(
		zcbor_state_t *state, struct Models_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).Models_after_tstr)))) && (((*result).Models_after_choice = Models_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).Models_after_choice = Models_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_models(
		zcbor_state_t *state, struct request_models *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_present_decode(&((*result).Models_after_present), (zcbor_decoder_t *)decode_repeated_Models_after, state, (&(*result).Models_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_Models_after(state, (&(*result).Models_after));
	}
...
static bool decode_repeated_ProviderModels_after(
		zcbor_state_t *state, struct ProviderModels_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ProviderModels_after_tstr)))) && (((*result).ProviderModels_after_choice = ProviderModels_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ProviderModels_after_choice = ProviderModels_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_provider_models *result)
{
	...
	&& zcbor_present_decode(&((*result).ProviderModels_transient_key_present), (zcbor_decoder_t *)decode_repeated_ProviderModels_transient_key, state, (&(*result).ProviderModels_transient_key))
	&& zcbor_present_decode(&((*result).ProviderModels_after_present), (zcbor_decoder_t *)decode_repeated_ProviderModels_after, state, (&(*result).ProviderModels_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_ProviderModels_after(state, (&(*result).ProviderModels_after));
	}
...
static bool decode_repeated_custom_provider_credential_ref(
		zcbor_state_t *state, struct custom_provider_credential_ref_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"credential_ref", tmp_str.len = sizeof("credential_ref") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).custom_provider_credential_ref_tstr)))) && (((*result).custom_provider_credential_ref_choice = custom_provider_credential_ref_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).custom_provider_credential_ref_choice = custom_provider_credential_ref_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_custom_provider_source_t(
		zcbor_state_t *state, struct custom_provider_source_t_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"config", tmp_str.len = sizeof("config") - 1, &tmp_str))))) && (((*result).custom_provider_source_t_choice = custom_provider_source_t_config_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"user", tmp_str.len = sizeof("user") - 1, &tmp_str))))) && (((*result).custom_provider_source_t_choice = custom_provider_source_t_user_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_custom_provider(
		zcbor_state_t *state, struct custom_provider *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).custom_provider_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"display_name", tmp_str.len = sizeof("display_name") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).custom_provider_display_name))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"base_url", tmp_str.len = sizeof("base_url") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).custom_provider_base_url))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"wire_selector", tmp_str.len = sizeof("wire_selector") - 1, &tmp_str)))))
	&& (decode_provider_selector(state, (&(*result).custom_provider_wire_selector))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"requires_key", tmp_str.len = sizeof("requires_key") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).custom_provider_requires_key))))
	&& zcbor_present_decode(&((*result).custom_provider_credential_ref_present), (zcbor_decoder_t *)decode_repeated_custom_provider_credential_ref, state, (&(*result).custom_provider_credential_ref))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"source", tmp_str.len = sizeof("source") - 1, &tmp_str)))))
	&& (decode_custom_provider_source_t(state, (&(*result).custom_provider_source))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_custom_provider_credential_ref(state, (&(*result).custom_provider_credential_ref));
	}
...
static bool decode_request_custom_provider_set(
		zcbor_state_t *state, struct request_custom_provider_set *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CustomProviderSet", tmp_str.len = sizeof("CustomProviderSet") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"provider", tmp_str.len = sizeof("provider") - 1, &tmp_str)))))
	&& (decode_custom_provider(state, (&(*result).CustomProviderSet_provider))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_custom_provider_remove(
		zcbor_state_t *state, struct request_custom_provider_remove *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CustomProviderRemove", tmp_str.len = sizeof("CustomProviderRemove") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).CustomProviderRemove_id))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_Fields_tstrtstr(
		zcbor_state_t *state, struct Fields_tstrtstr *result)
{
	zcbor_log("%s\r\n", __func__);

	bool res = ((((zcbor_tstr_decode(state, (&(*result).auth_step_input_fields_Fields_tstrtstr_key))))
	&& (zcbor_tstr_decode(state, (&(*result).Fields_tstrtstr)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_auth_step_input_fields(
		zcbor_state_t *state, struct auth_step_input_fields *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Fields", tmp_str.len = sizeof("Fields") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).Fields_tstrtstr_count, (zcbor_decoder_t *)decode_repeated_Fields_tstrtstr, state, (*&(*result).Fields_tstrtstr), sizeof(struct Fields_tstrtstr))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_Fields_tstrtstr(state, (*&(*result).Fields_tstrtstr));
	}
...
static bool decode_auth_step_input_callback(
		zcbor_state_t *state, struct auth_step_input_callback *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Callback", tmp_str.len = sizeof("Callback") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).auth_step_input_callback_Callback))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_auth_step_input(
		zcbor_state_t *state, struct auth_step_input_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((decode_auth_step_input_fields(state, (&(*result).auth_step_input_fields_m)))) && (((*result).auth_step_input_choice = auth_step_input_fields_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_auth_step_input_callback(state, (&(*result).auth_step_input_callback_m)))) && (((*result).auth_step_input_choice = auth_step_input_callback_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Poll", tmp_str.len = sizeof("Poll") - 1, &tmp_str))))) && (((*result).auth_step_input_choice = auth_step_input_Poll_tstr_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_auth_step_request(
		zcbor_state_t *state, struct auth_step_request *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_tstr_decode(state, (&(*result).auth_step_request_flow_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"input", tmp_str.len = sizeof("input") - 1, &tmp_str)))))
	&& (decode_auth_step_input(state, (&(*result).auth_step_request_input))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_auth_step(
		zcbor_state_t *state, struct request_auth_step *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AuthStep", tmp_str.len = sizeof("AuthStep") - 1, &tmp_str)))))
	&& (decode_auth_step_request(state, (&(*result).request_auth_step_AuthStep))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_CheckpointList_after(
		zcbor_state_t *state, struct CheckpointList_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).CheckpointList_after_tstr)))) && (((*result).CheckpointList_after_choice = CheckpointList_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).CheckpointList_after_choice = CheckpointList_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_checkpoint_list *result)
{
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_present_decode(&((*result).CheckpointList_session_present), (zcbor_decoder_t *)decode_repeated_CheckpointList_session, state, (&(*result).CheckpointList_session))
	&& zcbor_present_decode(&((*result).CheckpointList_after_present), (zcbor_decoder_t *)decode_repeated_CheckpointList_after, state, (&(*result).CheckpointList_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_CheckpointList_after(state, (&(*result).CheckpointList_after));
	}
...
static bool decode_request_session_recap(
		zcbor_state_t *state, struct request_session_recap *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"SessionRecap", tmp_str.len = sizeof("SessionRecap") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).SessionRecap_session))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_agent_recipe_program(
		zcbor_state_t *state, struct agent_recipe_program_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).agent_recipe_program_tstr)))) && (((*result).agent_recipe_program_choice = agent_recipe_program_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).agent_recipe_program_choice = agent_recipe_program_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_agent_recipe_args(
		zcbor_state_t *state, struct agent_recipe_args_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"args", tmp_str.len = sizeof("args") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).agent_recipe_args_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).agent_recipe_args_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		zcbor_tstr_decode(state, (*&(*result).agent_recipe_args_tstr));
	}
...
static bool decode_repeated_agent_recipe_env(
		zcbor_state_t *state, struct agent_recipe_env_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"env", tmp_str.len = sizeof("env") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).agent_recipe_env_kv_pair_m_count, (zcbor_decoder_t *)decode_kv_pair, state, (*&(*result).agent_recipe_env_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_kv_pair(state, (*&(*result).agent_recipe_env_kv_pair_m));
	}
...
static bool decode_repeated_agent_recipe_endpoint(
		zcbor_state_t *state, struct agent_recipe_endpoint_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).agent_recipe_endpoint_tstr)))) && (((*result).agent_recipe_endpoint_choice = agent_recipe_endpoint_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).agent_recipe_endpoint_choice = agent_recipe_endpoint_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_agent_recipe(
		zcbor_state_t *state, struct agent_recipe *result)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_map_start_decode(state) && ((zcbor_present_decode(&((*result).agent_recipe_program_present), (zcbor_decoder_t *)decode_repeated_agent_recipe_program, state, (&(*result).agent_recipe_program))
	&& zcbor_present_decode(&((*result).agent_recipe_args_present), (zcbor_decoder_t *)decode_repeated_agent_recipe_args, state, (&(*result).agent_recipe_args))
	&& zcbor_present_decode(&((*result).agent_recipe_env_present), (zcbor_decoder_t *)decode_repeated_agent_recipe_env, state, (&(*result).agent_recipe_env))
	&& zcbor_present_decode(&((*result).agent_recipe_endpoint_present), (zcbor_decoder_t *)decode_repeated_agent_recipe_endpoint, state, (&(*result).agent_recipe_endpoint))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_agent_recipe_program(state, (&(*result).agent_recipe_program));
		decode_repeated_agent_recipe_args(state, (&(*result).agent_recipe_args));
		decode_repeated_agent_recipe_env(state, (&(*result).agent_recipe_env));
		decode_repeated_agent_recipe_endpoint(state, (&(*result).agent_recipe_endpoint));
	}
...
static bool decode_agent_source(
		zcbor_state_t *state, struct agent_source_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Builtin", tmp_str.len = sizeof("Builtin") - 1, &tmp_str))))) && (((*result).agent_source_choice = agent_source_Builtin_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Manual", tmp_str.len = sizeof("Manual") - 1, &tmp_str))))) && (((*result).agent_source_choice = agent_source_Manual_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Endpoint", tmp_str.len = sizeof("Endpoint") - 1, &tmp_str))))) && (((*result).agent_source_choice = agent_source_Endpoint_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_agent_protocol(
		zcbor_state_t *state, struct agent_protocol_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Acp", tmp_str.len = sizeof("Acp") - 1, &tmp_str))))) && (((*result).agent_protocol_choice = agent_protocol_Acp_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"StreamJson", tmp_str.len = sizeof("StreamJson") - 1, &tmp_str))))) && (((*result).agent_protocol_choice = agent_protocol_StreamJson_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_agent_entry_protocol(
		zcbor_state_t *state, struct agent_entry_protocol *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"protocol", tmp_str.len = sizeof("protocol") - 1, &tmp_str)))))
	&& (decode_agent_protocol(state, (&(*result).agent_entry_protocol)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_agent_entry_installed(
		zcbor_state_t *state, struct agent_entry_installed *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"installed", tmp_str.len = sizeof("installed") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).agent_entry_installed)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_agent_entry_version(
		zcbor_state_t *state, struct agent_entry_version_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).agent_entry_version_tstr)))) && (((*result).agent_entry_version_choice = agent_entry_version_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).agent_entry_version_choice = agent_entry_version_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_agent_entry_capabilities(
		zcbor_state_t *state, struct agent_entry_capabilities_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"capabilities", tmp_str.len = sizeof("capabilities") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).agent_entry_capabilities_kv_pair_m_count, (zcbor_decoder_t *)decode_kv_pair, state, (*&(*result).agent_entry_capabilities_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_kv_pair(state, (*&(*result).agent_entry_capabilities_kv_pair_m));
	}
...
static bool decode_agent_verification(
		zcbor_state_t *state, struct agent_verification_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Verified", tmp_str.len = sizeof("Verified") - 1, &tmp_str))))) && (((*result).agent_verification_choice = agent_verification_Verified_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Unverified", tmp_str.len = sizeof("Unverified") - 1, &tmp_str))))) && (((*result).agent_verification_choice = agent_verification_Unverified_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"NotInstalled", tmp_str.len = sizeof("NotInstalled") - 1, &tmp_str))))) && (((*result).agent_verification_choice = agent_verification_NotInstalled_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_agent_entry_verification(
		zcbor_state_t *state, struct agent_entry_verification *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"verification", tmp_str.len = sizeof("verification") - 1, &tmp_str)))))
	&& (decode_agent_verification(state, (&(*result).agent_entry_verification)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_agent_entry(
		zcbor_state_t *state, struct agent_entry *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"name", tmp_str.len = sizeof("name") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).agent_entry_name))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"recipe", tmp_str.len = sizeof("recipe") - 1, &tmp_str)))))
	&& (decode_agent_recipe(state, (&(*result).agent_entry_recipe))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"source", tmp_str.len = sizeof("source") - 1, &tmp_str)))))
	&& (decode_agent_source(state, (&(*result).agent_entry_source))))
	&& zcbor_present_decode(&((*result).agent_entry_protocol_present), (zcbor_decoder_t *)decode_repeated_agent_entry_protocol, state, (&(*result).agent_entry_protocol))
	&& zcbor_present_decode(&((*result).agent_entry_installed_present), (zcbor_decoder_t *)decode_repeated_agent_entry_installed, state, (&(*result).agent_entry_installed))
	&& zcbor_present_decode(&((*result).agent_entry_version_present), (zcbor_decoder_t *)decode_repeated_agent_entry_version, state, (&(*result).agent_entry_version))
	&& zcbor_present_decode(&((*result).agent_entry_capabilities_present), (zcbor_decoder_t *)decode_repeated_agent_entry_capabilities, state, (&(*result).agent_entry_capabilities))
	&& zcbor_present_decode(&((*result).agent_entry_verification_present), (zcbor_decoder_t *)decode_repeated_agent_entry_verification, state, (&(*result).agent_entry_verification))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_agent_entry_protocol(state, (&(*result).agent_entry_protocol));
		decode_repeated_agent_entry_installed(state, (&(*result).agent_entry_installed));
		decode_repeated_agent_entry_version(state, (&(*result).agent_entry_version));
		decode_repeated_agent_entry_capabilities(state, (&(*result).agent_entry_capabilities));
		decode_repeated_agent_entry_verification(state, (&(*result).agent_entry_verification));
	}
...
static bool decode_request_agent_register(
		zcbor_state_t *state, struct request_agent_register *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AgentRegister", tmp_str.len = sizeof("AgentRegister") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"entry", tmp_str.len = sizeof("entry") - 1, &tmp_str)))))
	&& (decode_agent_entry(state, (&(*result).AgentRegister_entry))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_agent_remove(
		zcbor_state_t *state, struct request_agent_remove *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AgentRemove", tmp_str.len = sizeof("AgentRemove") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"name", tmp_str.len = sizeof("name") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).AgentRemove_name))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_tool_info_requires(
		zcbor_state_t *state, struct tool_info_requires_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"requires", tmp_str.len = sizeof("requires") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).tool_info_requires_tstr)))) && (((*result).tool_info_requires_choice = tool_info_requires_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).tool_info_requires_choice = tool_info_requires_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct tool_info *result)
{
	...
	&& zcbor_present_decode(&((*result).tool_info_description_present), (zcbor_decoder_t *)decode_repeated_tool_info_description, state, (&(*result).tool_info_description))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).tool_info_enabled))))
	&& zcbor_present_decode(&((*result).tool_info_requires_present), (zcbor_decoder_t *)decode_repeated_tool_info_requires, state, (&(*result).tool_info_requires))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_tool_info_requires(state, (&(*result).tool_info_requires));
	}
...
static bool decode_request_tool_set_enabled(
		zcbor_state_t *state, struct request_tool_set_enabled *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ToolSetEnabled", tmp_str.len = sizeof("ToolSetEnabled") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"tool", tmp_str.len = sizeof("tool") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ToolSetEnabled_tool))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).ToolSetEnabled_enabled))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_GatewaySet_addr(
		zcbor_state_t *state, struct GatewaySet_addr_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"addr", tmp_str.len = sizeof("addr") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).GatewaySet_addr_tstr)))) && (((*result).GatewaySet_addr_choice = GatewaySet_addr_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).GatewaySet_addr_choice = GatewaySet_addr_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_gateway_set(
		zcbor_state_t *state, struct request_gateway_set *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"GatewaySet", tmp_str.len = sizeof("GatewaySet") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).GatewaySet_enabled))))
	&& zcbor_present_decode(&((*result).GatewaySet_addr_present), (zcbor_decoder_t *)decode_repeated_GatewaySet_addr, state, (&(*result).GatewaySet_addr))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_GatewaySet_addr(state, (&(*result).GatewaySet_addr));
	}
...
static bool decode_repeated_RoutingListChats_after(
		zcbor_state_t *state, struct RoutingListChats_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).RoutingListChats_after_tstr)))) && (((*result).RoutingListChats_after_choice = RoutingListChats_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).RoutingListChats_after_choice = RoutingListChats_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_routing_list_chats(
		zcbor_state_t *state, struct request_routing_list_chats *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"RoutingListChats", tmp_str.len = sizeof("RoutingListChats") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && ((zcbor_present_decode(&((*result).RoutingListChats_after_present), (zcbor_decoder_t *)decode_repeated_RoutingListChats_after, state, (&(*result).RoutingListChats_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_RoutingListChats_after(state, (&(*result).RoutingListChats_after));
	}
...
static bool decode_repeated_TransportRooms_after(
		zcbor_state_t *state, struct TransportRooms_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).TransportRooms_after_tstr)))) && (((*result).TransportRooms_after_choice = TransportRooms_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).TransportRooms_after_choice = TransportRooms_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_transport_rooms *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).TransportRooms_transport))))
	&& zcbor_present_decode(&((*result).TransportRooms_after_present), (zcbor_decoder_t *)decode_repeated_TransportRooms_after, state, (&(*result).TransportRooms_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_TransportRooms_after(state, (&(*result).TransportRooms_after));
	}
...
static bool decode_request_transport_disconnect(
		zcbor_state_t *state, struct request_transport_disconnect *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"TransportDisconnect", tmp_str.len = sizeof("TransportDisconnect") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).TransportDisconnect_transport))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_transport_remove(
		zcbor_state_t *state, struct request_transport_remove *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"TransportRemove", tmp_str.len = sizeof("TransportRemove") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).TransportRemove_transport))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_transport_connect(
		zcbor_state_t *state, struct request_transport_connect *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"TransportConnect", tmp_str.len = sizeof("TransportConnect") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).TransportConnect_transport))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_transport_set_enabled(
		zcbor_state_t *state, struct request_transport_set_enabled *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"TransportSetEnabled", tmp_str.len = sizeof("TransportSetEnabled") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).TransportSetEnabled_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).TransportSetEnabled_enabled))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_TransportSetLabel_label(
		zcbor_state_t *state, struct TransportSetLabel_label_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).TransportSetLabel_label_tstr)))) && (((*result).TransportSetLabel_label_choice = TransportSetLabel_label_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).TransportSetLabel_label_choice = TransportSetLabel_label_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_transport_set_label(
		zcbor_state_t *state, struct request_transport_set_label *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"TransportSetLabel", tmp_str.len = sizeof("TransportSetLabel") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).TransportSetLabel_transport))))
	&& zcbor_present_decode(&((*result).TransportSetLabel_label_present), (zcbor_decoder_t *)decode_repeated_TransportSetLabel_label, state, (&(*result).TransportSetLabel_label))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_TransportSetLabel_label(state, (&(*result).TransportSetLabel_label));
	}
...
static bool decode_repeated_ConvList_after(
		zcbor_state_t *state, struct ConvList_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ConvList_after_tstr)))) && (((*result).ConvList_after_choice = ConvList_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ConvList_after_choice = ConvList_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_conv_list *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ConvList_transport))))
	&& zcbor_present_decode(&((*result).ConvList_after_present), (zcbor_decoder_t *)decode_repeated_ConvList_after, state, (&(*result).ConvList_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_ConvList_after(state, (&(*result).ConvList_after));
	}
...
static bool decode_repeated_RosterList_after(
		zcbor_state_t *state, struct RosterList_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).RosterList_after_tstr)))) && (((*result).RosterList_after_choice = RosterList_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).RosterList_after_choice = RosterList_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_roster_list(
		zcbor_state_t *state, struct request_roster_list *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"RosterList", tmp_str.len = sizeof("RosterList") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).RosterList_transport))))
	&& zcbor_present_decode(&((*result).RosterList_after_present), (zcbor_decoder_t *)decode_repeated_RosterList_after, state, (&(*result).RosterList_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_RosterList_after(state, (&(*result).RosterList_after));
	}
...
static bool decode_request_roster_add(
		zcbor_state_t *state, struct request_roster_add *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"RosterAdd", tmp_str.len = sizeof("RosterAdd") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).RosterAdd_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"contact", tmp_str.len = sizeof("contact") - 1, &tmp_str)))))
	&& (decode_contact_info(state, (&(*result).RosterAdd_contact))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_roster_update(
		zcbor_state_t *state, struct request_roster_update *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"RosterUpdate", tmp_str.len = sizeof("RosterUpdate") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).RosterUpdate_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"contact", tmp_str.len = sizeof("contact") - 1, &tmp_str)))))
	&& (decode_contact_info(state, (&(*result).RosterUpdate_contact))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_request_roster_remove(
		zcbor_state_t *state, struct request_roster_remove *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"RosterRemove", tmp_str.len = sizeof("RosterRemove") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).RosterRemove_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"contact", tmp_str.len = sizeof("contact") - 1, &tmp_str)))))
	&& (decode_contact_info(state, (&(*result).RosterRemove_contact))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_FsList_after(
		zcbor_state_t *state, struct FsList_after_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).FsList_after_tstr)))) && (((*result).FsList_after_choice = FsList_after_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).FsList_after_choice = FsList_after_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_fs_list *result)
{
	...
	&& zcbor_present_decode(&((*result).FsList_show_ignored_present), (zcbor_decoder_t *)decode_repeated_FsList_show_ignored, state, (&(*result).FsList_show_ignored))
	&& zcbor_present_decode(&((*result).FsList_after_present), (zcbor_decoder_t *)decode_repeated_FsList_after, state, (&(*result).FsList_after))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_FsList_after(state, (&(*result).FsList_after));
	}
...
static bool decode_response_session_created(
		zcbor_state_t *state, struct response_session_created *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"SessionCreated", tmp_str.len = sizeof("SessionCreated") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).SessionCreated_session))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_foreign_stage(
		zcbor_state_t *state, struct foreign_stage_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Spawn", tmp_str.len = sizeof("Spawn") - 1, &tmp_str))))) && (((*result).foreign_stage_choice = foreign_stage_Spawn_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Handshake", tmp_str.len = sizeof("Handshake") - 1, &tmp_str))))) && (((*result).foreign_stage_choice = foreign_stage_Handshake_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Turn", tmp_str.len = sizeof("Turn") - 1, &tmp_str))))) && (((*result).foreign_stage_choice = foreign_stage_Turn_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Unknown", tmp_str.len = sizeof("Unknown") - 1, &tmp_str))))) && (((*result).foreign_stage_choice = foreign_stage_Unknown_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_foreign_failure_agent(
		zcbor_state_t *state, struct foreign_failure_agent_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"agent", tmp_str.len = sizeof("agent") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).foreign_failure_agent_tstr)))) && (((*result).foreign_failure_agent_choice = foreign_failure_agent_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).foreign_failure_agent_choice = foreign_failure_agent_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_foreign_failure(
		zcbor_state_t *state, struct foreign_failure *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"stage", tmp_str.len = sizeof("stage") - 1, &tmp_str)))))
	&& (decode_foreign_stage(state, (&(*result).foreign_failure_stage))))
	&& zcbor_present_decode(&((*result).foreign_failure_agent_present), (zcbor_decoder_t *)decode_repeated_foreign_failure_agent, state, (&(*result).foreign_failure_agent))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_foreign_failure_agent(state, (&(*result).foreign_failure_agent));
	}
...
static bool decode_repeated_turn_summary_failure(
		zcbor_state_t *state, struct turn_summary_failure_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"failure", tmp_str.len = sizeof("failure") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_foreign_failure(state, (&(*result).turn_summary_failure_foreign_failure_m)))) && (((*result).turn_summary_failure_choice = turn_summary_failure_foreign_failure_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).turn_summary_failure_choice = turn_summary_failure_null_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct turn_summary *result)
{
	...
	&& (decode_usage_delta(state, (&(*result).turn_summary_usage))))
	&& zcbor_present_decode(&((*result).turn_summary_failure_present), (zcbor_decoder_t *)decode_repeated_turn_summary_failure, state, (&(*result).turn_summary_failure))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_turn_summary_failure(state, (&(*result).turn_summary_failure));
	}
...
static bool decode_repeated_approval_info_fingerprint(
		zcbor_state_t *state, struct approval_info_fingerprint_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"fingerprint", tmp_str.len = sizeof("fingerprint") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).approval_info_fingerprint_tstr)))) && (((*result).approval_info_fingerprint_choice = approval_info_fingerprint_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).approval_info_fingerprint_choice = approval_info_fingerprint_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_approval_info_detail(
		zcbor_state_t *state, struct approval_info_detail_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"detail", tmp_str.len = sizeof("detail") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_tool_detail(state, (&(*result).approval_info_detail_tool_detail_m)))) && (((*result).approval_info_detail_choice = approval_info_detail_tool_detail_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).approval_info_detail_choice = approval_info_detail_null_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct approval_info *result)
{
	...
	&& zcbor_present_decode(&((*result).approval_info_path_present), (zcbor_decoder_t *)decode_repeated_approval_info_path, state, (&(*result).approval_info_path))
	&& zcbor_present_decode(&((*result).approval_info_fingerprint_present), (zcbor_decoder_t *)decode_repeated_approval_info_fingerprint, state, (&(*result).approval_info_fingerprint))
	&& zcbor_present_decode(&((*result).approval_info_detail_present), (zcbor_decoder_t *)decode_repeated_approval_info_detail, state, (&(*result).approval_info_detail))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_approval_info_fingerprint(state, (&(*result).approval_info_fingerprint));
		decode_repeated_approval_info_detail(state, (&(*result).approval_info_detail));
	}
...
static bool decode_repeated_approval_page_next(
		zcbor_state_t *state, struct approval_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).approval_page_next_tstr)))) && (((*result).approval_page_next_choice = approval_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).approval_page_next_choice = approval_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_approval_page(
		zcbor_state_t *state, struct approval_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).approval_page_items_approval_info_m_count, (zcbor_decoder_t *)decode_approval_info, state, (*&(*result).approval_page_items_approval_info_m), sizeof(struct approval_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).approval_page_next_present), (zcbor_decoder_t *)decode_repeated_approval_page_next, state, (&(*result).approval_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_approval_info(state, (*&(*result).approval_page_items_approval_info_m));
		decode_repeated_approval_page_next(state, (&(*result).approval_page_next));
	}
		...
		zcbor_state_t *state, struct response_approvals *result)
{
	...
	&& (decode_approval_page(state, (&(*result).response_approvals_Approvals))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_remembered_fingerprint_label(
		zcbor_state_t *state, struct remembered_fingerprint_label_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).remembered_fingerprint_label_tstr)))) && (((*result).remembered_fingerprint_label_choice = remembered_fingerprint_label_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).remembered_fingerprint_label_choice = remembered_fingerprint_label_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_remembered_fingerprint_remembered_at_ms(
		zcbor_state_t *state, struct remembered_fingerprint_remembered_at_ms *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"remembered_at_ms", tmp_str.len = sizeof("remembered_at_ms") - 1, &tmp_str)))))
	&& (zcbor_uint64_decode(state, (&(*result).remembered_fingerprint_remembered_at_ms)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_remembered_fingerprint(
		zcbor_state_t *state, struct remembered_fingerprint *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"fingerprint", tmp_str.len = sizeof("fingerprint") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).remembered_fingerprint_fingerprint))))
	&& zcbor_present_decode(&((*result).remembered_fingerprint_label_present), (zcbor_decoder_t *)decode_repeated_remembered_fingerprint_label, state, (&(*result).remembered_fingerprint_label))
	&& zcbor_present_decode(&((*result).remembered_fingerprint_remembered_at_ms_present), (zcbor_decoder_t *)decode_repeated_remembered_fingerprint_remembered_at_ms, state, (&(*result).remembered_fingerprint_remembered_at_ms))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_remembered_fingerprint_label(state, (&(*result).remembered_fingerprint_label));
		decode_repeated_remembered_fingerprint_remembered_at_ms(state, (&(*result).remembered_fingerprint_remembered_at_ms));
	}
...
static bool decode_response_fingerprints(
		zcbor_state_t *state, struct response_fingerprints *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Fingerprints", tmp_str.len = sizeof("Fingerprints") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).response_fingerprints_Fingerprints_remembered_fingerprint_m_count, (zcbor_decoder_t *)decode_remembered_fingerprint, state, (*&(*result).response_fingerprints_Fingerprints_remembered_fingerprint_m), sizeof(struct remembered_fingerprint))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_delegation_lifetime(
		zcbor_state_t *state, struct delegation_lifetime_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Persistent", tmp_str.len = sizeof("Persistent") - 1, &tmp_str))))) && (((*result).delegation_lifetime_choice = delegation_lifetime_Persistent_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Ephemeral", tmp_str.len = sizeof("Ephemeral") - 1, &tmp_str))))) && (((*result).delegation_lifetime_choice = delegation_lifetime_Ephemeral_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_unit_node_lifetime(
		zcbor_state_t *state, struct unit_node_lifetime_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"lifetime", tmp_str.len = sizeof("lifetime") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_delegation_lifetime(state, (&(*result).unit_node_lifetime_delegation_lifetime_m)))) && (((*result).unit_node_lifetime_choice = unit_node_lifetime_delegation_lifetime_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).unit_node_lifetime_choice = unit_node_lifetime_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_unit_node_engine(
		zcbor_state_t *state, struct unit_node_engine_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_engine_selector(state, (&(*result).unit_node_engine_engine_selector_m)))) && (((*result).unit_node_engine_choice = unit_node_engine_engine_selector_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).unit_node_engine_choice = unit_node_engine_null_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct unit_node *result)
{
	...
	&& zcbor_present_decode(&((*result).unit_node_role_present), (zcbor_decoder_t *)decode_repeated_unit_node_role, state, (&(*result).unit_node_role))
	&& zcbor_present_decode(&((*result).unit_node_lifetime_present), (zcbor_decoder_t *)decode_repeated_unit_node_lifetime, state, (&(*result).unit_node_lifetime))
	&& zcbor_present_decode(&((*result).unit_node_engine_present), (zcbor_decoder_t *)decode_repeated_unit_node_engine, state, (&(*result).unit_node_engine))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_unit_node_lifetime(state, (&(*result).unit_node_lifetime));
		decode_repeated_unit_node_engine(state, (&(*result).unit_node_engine));
	}
...
static bool decode_repeated_tree_report_next(
		zcbor_state_t *state, struct tree_report_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).tree_report_next_tstr)))) && (((*result).tree_report_next_choice = tree_report_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).tree_report_next_choice = tree_report_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct tree_report *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).tree_report_nodes_unit_node_m_count, (zcbor_decoder_t *)decode_unit_node, state, (*&(*result).tree_report_nodes_unit_node_m), sizeof(struct unit_node))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).tree_report_next_present), (zcbor_decoder_t *)decode_repeated_tree_report_next, state, (&(*result).tree_report_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_tree_report_next(state, (&(*result).tree_report_next));
	}
...
static bool decode_node_event_profiles_changed(
		zcbor_state_t *state, struct node_event_profiles_changed *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ProfilesChanged", tmp_str.len = sizeof("ProfilesChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"rev", tmp_str.len = sizeof("rev") - 1, &tmp_str)))))
	&& (zcbor_uint64_decode(state, (&(*result).ProfilesChanged_rev))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct node_event_download_progress *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"state", tmp_str.len = sizeof("state") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).DownloadProgress_state))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"downloaded_bytes", tmp_str.len = sizeof("downloaded_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint64_decode(state, (&(*result).DownloadProgress_downloaded_bytes))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"total_bytes", tmp_str.len = sizeof("total_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint64_decode(state, (&(*result).DownloadProgress_total_bytes))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct connection_state_r *result)
{
	...
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Disconnecting", tmp_str.len = sizeof("Disconnecting") - 1, &tmp_str))))) && (((*result).connection_state_choice = connection_state_Disconnecting_tstr_c), true))
...
static bool decode_repeated_TransportChanged_presence(
		zcbor_state_t *state, struct TransportChanged_presence *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"presence", tmp_str.len = sizeof("presence") - 1, &tmp_str)))))
	&& (decode_presence_state(state, (&(*result).TransportChanged_presence)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_disconnect_reason(
		zcbor_state_t *state, struct disconnect_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"UserRequested", tmp_str.len = sizeof("UserRequested") - 1, &tmp_str))))) && (((*result).disconnect_reason_choice = disconnect_reason_UserRequested_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"NetworkError", tmp_str.len = sizeof("NetworkError") - 1, &tmp_str))))) && (((*result).disconnect_reason_choice = disconnect_reason_NetworkError_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AuthenticationFailed", tmp_str.len = sizeof("AuthenticationFailed") - 1, &tmp_str))))) && (((*result).disconnect_reason_choice = disconnect_reason_AuthenticationFailed_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ReplacedByOtherClient", tmp_str.len = sizeof("ReplacedByOtherClient") - 1, &tmp_str))))) && (((*result).disconnect_reason_choice = disconnect_reason_ReplacedByOtherClient_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"InvalidSettings", tmp_str.len = sizeof("InvalidSettings") - 1, &tmp_str))))) && (((*result).disconnect_reason_choice = disconnect_reason_InvalidSettings_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CertificateError", tmp_str.len = sizeof("CertificateError") - 1, &tmp_str))))) && (((*result).disconnect_reason_choice = disconnect_reason_CertificateError_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Other", tmp_str.len = sizeof("Other") - 1, &tmp_str))))) && (((*result).disconnect_reason_choice = disconnect_reason_Other_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_TransportChanged_reason(
		zcbor_state_t *state, struct TransportChanged_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_disconnect_reason(state, (&(*result).TransportChanged_reason_disconnect_reason_m)))) && (((*result).TransportChanged_reason_choice = TransportChanged_reason_disconnect_reason_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).TransportChanged_reason_choice = TransportChanged_reason_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_TransportChanged_message(
		zcbor_state_t *state, struct TransportChanged_message_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).TransportChanged_message_tstr)))) && (((*result).TransportChanged_message_choice = TransportChanged_message_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).TransportChanged_message_choice = TransportChanged_message_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_TransportChanged_fatal(
		zcbor_state_t *state, struct TransportChanged_fatal *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"fatal", tmp_str.len = sizeof("fatal") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).TransportChanged_fatal)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_node_event_transport_changed(
		zcbor_state_t *state, struct node_event_transport_changed *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"TransportChanged", tmp_str.len = sizeof("TransportChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).TransportChanged_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"connection", tmp_str.len = sizeof("connection") - 1, &tmp_str)))))
	&& (decode_connection_state(state, (&(*result).TransportChanged_connection))))
	&& zcbor_present_decode(&((*result).TransportChanged_presence_present), (zcbor_decoder_t *)decode_repeated_TransportChanged_presence, state, (&(*result).TransportChanged_presence))
	&& zcbor_present_decode(&((*result).TransportChanged_reason_present), (zcbor_decoder_t *)decode_repeated_TransportChanged_reason, state, (&(*result).TransportChanged_reason))
	&& zcbor_present_decode(&((*result).TransportChanged_message_present), (zcbor_decoder_t *)decode_repeated_TransportChanged_message, state, (&(*result).TransportChanged_message))
	&& zcbor_present_decode(&((*result).TransportChanged_fatal_present), (zcbor_decoder_t *)decode_repeated_TransportChanged_fatal, state, (&(*result).TransportChanged_fatal))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_TransportChanged_presence(state, (&(*result).TransportChanged_presence));
		decode_repeated_TransportChanged_reason(state, (&(*result).TransportChanged_reason));
		decode_repeated_TransportChanged_message(state, (&(*result).TransportChanged_message));
		decode_repeated_TransportChanged_fatal(state, (&(*result).TransportChanged_fatal));
	}
...
static bool decode_conv_change(
		zcbor_state_t *state, struct conv_change_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Added", tmp_str.len = sizeof("Added") - 1, &tmp_str))))) && (((*result).conv_change_choice = conv_change_Added_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Removed", tmp_str.len = sizeof("Removed") - 1, &tmp_str))))) && (((*result).conv_change_choice = conv_change_Removed_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_node_event_conversations_changed(
		zcbor_state_t *state, struct node_event_conversations_changed *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ConversationsChanged", tmp_str.len = sizeof("ConversationsChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ConversationsChanged_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ConversationsChanged_conv))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"change", tmp_str.len = sizeof("change") - 1, &tmp_str)))))
	&& (decode_conv_change(state, (&(*result).ConversationsChanged_change))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_membership_change(
		zcbor_state_t *state, struct membership_change_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Joined", tmp_str.len = sizeof("Joined") - 1, &tmp_str))))) && (((*result).membership_change_choice = membership_change_Joined_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Left", tmp_str.len = sizeof("Left") - 1, &tmp_str))))) && (((*result).membership_change_choice = membership_change_Left_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Invited", tmp_str.len = sizeof("Invited") - 1, &tmp_str))))) && (((*result).membership_change_choice = membership_change_Invited_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Kicked", tmp_str.len = sizeof("Kicked") - 1, &tmp_str))))) && (((*result).membership_change_choice = membership_change_Kicked_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Banned", tmp_str.len = sizeof("Banned") - 1, &tmp_str))))) && (((*result).membership_change_choice = membership_change_Banned_tstr_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_MembershipChanged_actor(
		zcbor_state_t *state, struct MembershipChanged_actor_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"actor", tmp_str.len = sizeof("actor") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).MembershipChanged_actor_tstr)))) && (((*result).MembershipChanged_actor_choice = MembershipChanged_actor_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).MembershipChanged_actor_choice = MembershipChanged_actor_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_MembershipChanged_reason(
		zcbor_state_t *state, struct MembershipChanged_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).MembershipChanged_reason_tstr)))) && (((*result).MembershipChanged_reason_choice = MembershipChanged_reason_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).MembershipChanged_reason_choice = MembershipChanged_reason_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_node_event_membership_changed(
		zcbor_state_t *state, struct node_event_membership_changed *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"MembershipChanged", tmp_str.len = sizeof("MembershipChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MembershipChanged_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MembershipChanged_conv))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"member", tmp_str.len = sizeof("member") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MembershipChanged_member))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"change", tmp_str.len = sizeof("change") - 1, &tmp_str)))))
	&& (decode_membership_change(state, (&(*result).MembershipChanged_change))))
	&& zcbor_present_decode(&((*result).MembershipChanged_actor_present), (zcbor_decoder_t *)decode_repeated_MembershipChanged_actor, state, (&(*result).MembershipChanged_actor))
	&& zcbor_present_decode(&((*result).MembershipChanged_reason_present), (zcbor_decoder_t *)decode_repeated_MembershipChanged_reason, state, (&(*result).MembershipChanged_reason))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"is_self", tmp_str.len = sizeof("is_self") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).MembershipChanged_is_self))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_MembershipChanged_actor(state, (&(*result).MembershipChanged_actor));
		decode_repeated_MembershipChanged_reason(state, (&(*result).MembershipChanged_reason));
	}
...
static bool decode_node_event_contacts_changed(
		zcbor_state_t *state, struct node_event_contacts_changed *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ContactsChanged", tmp_str.len = sizeof("ContactsChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ContactsChanged_transport))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct node_event_r *result)
{
	...
	|| (zcbor_union_elem_code(state) && (((decode_node_event_profiles_changed(state, (&(*result).node_event_profiles_changed_m)))) && (((*result).node_event_choice = node_event_profiles_changed_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CatalogChanged", tmp_str.len = sizeof("CatalogChanged") - 1, &tmp_str))))) && (((*result).node_event_choice = node_event_catalog_changed_m_c), true)))
	|| (((decode_node_event_transport_changed(state, (&(*result).node_event_transport_changed_m)))) && (((*result).node_event_choice = node_event_transport_changed_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_node_event_conversations_changed(state, (&(*result).node_event_conversations_changed_m)))) && (((*result).node_event_choice = node_event_conversations_changed_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_node_event_membership_changed(state, (&(*result).node_event_membership_changed_m)))) && (((*result).node_event_choice = node_event_membership_changed_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_node_event_contacts_changed(state, (&(*result).node_event_contacts_changed_m)))) && (((*result).node_event_choice = node_event_contacts_changed_m_c), true)))
...
static bool decode_repeated_delivery_session_page_next(
		zcbor_state_t *state, struct delivery_session_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).delivery_session_page_next_tstr)))) && (((*result).delivery_session_page_next_choice = delivery_session_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).delivery_session_page_next_choice = delivery_session_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_delivery_session_page(
		zcbor_state_t *state, struct delivery_session_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).delivery_session_page_items_session_id_m_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).delivery_session_page_items_session_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).delivery_session_page_next_present), (zcbor_decoder_t *)decode_repeated_delivery_session_page_next, state, (&(*result).delivery_session_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		zcbor_tstr_decode(state, (*&(*result).delivery_session_page_items_session_id_m));
		decode_repeated_delivery_session_page_next(state, (&(*result).delivery_session_page_next));
	}
		...
		zcbor_state_t *state, struct response_delivery_sessions *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"DeliverySessions", tmp_str.len = sizeof("DeliverySessions") - 1, &tmp_str)))))
	&& (decode_delivery_session_page(state, (&(*result).response_delivery_sessions_DeliverySessions))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct model_file *result)
{
	...
	&& (zcbor_bool_decode(state, (&(*result).model_file_is_first_shard))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"is_mmproj", tmp_str.len = sizeof("is_mmproj") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).model_file_is_mmproj))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_model_file_page_next(
		zcbor_state_t *state, struct model_file_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).model_file_page_next_tstr)))) && (((*result).model_file_page_next_choice = model_file_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).model_file_page_next_choice = model_file_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_model_file_page(
		zcbor_state_t *state, struct model_file_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).model_file_page_items_model_file_m_count, (zcbor_decoder_t *)decode_model_file, state, (*&(*result).model_file_page_items_model_file_m), sizeof(struct model_file))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).model_file_page_next_present), (zcbor_decoder_t *)decode_repeated_model_file_page_next, state, (&(*result).model_file_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_model_file(state, (*&(*result).model_file_page_items_model_file_m));
		decode_repeated_model_file_page_next(state, (&(*result).model_file_page_next));
	}
		...
		zcbor_state_t *state, struct response_model_files *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ModelFiles", tmp_str.len = sizeof("ModelFiles") - 1, &tmp_str)))))
	&& (decode_model_file_page(state, (&(*result).response_model_files_ModelFiles))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_installed_model_mmproj_path(
		zcbor_state_t *state, struct installed_model_mmproj_path_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"mmproj_path", tmp_str.len = sizeof("mmproj_path") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).installed_model_mmproj_path_tstr)))) && (((*result).installed_model_mmproj_path_choice = installed_model_mmproj_path_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).installed_model_mmproj_path_choice = installed_model_mmproj_path_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_installed_model_sha256(
		zcbor_state_t *state, struct installed_model_sha256_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"sha256", tmp_str.len = sizeof("sha256") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).installed_model_sha256_tstr)))) && (((*result).installed_model_sha256_choice = installed_model_sha256_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).installed_model_sha256_choice = installed_model_sha256_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct installed_model *result)
{
	...
	&& zcbor_present_decode(&((*result).installed_model_file_type_present), (zcbor_decoder_t *)decode_repeated_installed_model_file_type, state, (&(*result).installed_model_file_type))
	&& zcbor_present_decode(&((*result).installed_model_mmproj_path_present), (zcbor_decoder_t *)decode_repeated_installed_model_mmproj_path, state, (&(*result).installed_model_mmproj_path))
	&& zcbor_present_decode(&((*result).installed_model_sha256_present), (zcbor_decoder_t *)decode_repeated_installed_model_sha256, state, (&(*result).installed_model_sha256))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_installed_model_mmproj_path(state, (&(*result).installed_model_mmproj_path));
		decode_repeated_installed_model_sha256(state, (&(*result).installed_model_sha256));
	}
...
static bool decode_repeated_profile_info_created_by(
		zcbor_state_t *state, struct profile_info_created_by_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"created_by", tmp_str.len = sizeof("created_by") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_author(state, (&(*result).profile_info_created_by_author_m)))) && (((*result).profile_info_created_by_choice = profile_info_created_by_author_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).profile_info_created_by_choice = profile_info_created_by_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_profile_info_owner(
		zcbor_state_t *state, struct profile_info_owner_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"owner", tmp_str.len = sizeof("owner") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).profile_info_owner_tstr)))) && (((*result).profile_info_owner_choice = profile_info_owner_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).profile_info_owner_choice = profile_info_owner_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct profile_info *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"bound_accounts", tmp_str.len = sizeof("bound_accounts") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).profile_info_bound_accounts_bound_account_m_count, (zcbor_decoder_t *)decode_bound_account, state, (*&(*result).profile_info_bound_accounts_bound_account_m), sizeof(struct bound_account))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).profile_info_created_by_present), (zcbor_decoder_t *)decode_repeated_profile_info_created_by, state, (&(*result).profile_info_created_by))
	&& zcbor_present_decode(&((*result).profile_info_owner_present), (zcbor_decoder_t *)decode_repeated_profile_info_owner, state, (&(*result).profile_info_owner))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_profile_info_created_by(state, (&(*result).profile_info_created_by));
		decode_repeated_profile_info_owner(state, (&(*result).profile_info_owner));
	}
		...
		zcbor_state_t *state, struct credential_info_label_r *result)
{
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).credential_info_label_tstr)))) && (((*result).credential_info_label_choice = credential_info_label_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).credential_info_label_choice = credential_info_label_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct credential_info *result)
{
	...
	&& (zcbor_tstr_decode(state, (&(*result).credential_info_hint))))
	&& zcbor_present_decode(&((*result).credential_info_label_present), (zcbor_decoder_t *)decode_repeated_credential_info_label, state, (&(*result).credential_info_label))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_credential_info_label(state, (&(*result).credential_info_label));
	}
...
static bool decode_repeated_model_page_next(
		zcbor_state_t *state, struct model_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).model_page_next_tstr)))) && (((*result).model_page_next_choice = model_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).model_page_next_choice = model_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_model_page(
		zcbor_state_t *state, struct model_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).model_page_items_model_descriptor_m_count, (zcbor_decoder_t *)decode_model_descriptor, state, (*&(*result).model_page_items_model_descriptor_m), sizeof(struct model_descriptor))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).model_page_next_present), (zcbor_decoder_t *)decode_repeated_model_page_next, state, (&(*result).model_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_model_descriptor(state, (*&(*result).model_page_items_model_descriptor_m));
		decode_repeated_model_page_next(state, (&(*result).model_page_next));
	}
		...
		zcbor_state_t *state, struct response_models *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Models", tmp_str.len = sizeof("Models") - 1, &tmp_str)))))
	&& (decode_model_page(state, (&(*result).response_models_Models))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_provider_sign_in(
		zcbor_state_t *state, struct provider_sign_in *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"family", tmp_str.len = sizeof("family") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).provider_sign_in_family))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).provider_sign_in_label))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_provider_descriptor_sign_in(
		zcbor_state_t *state, struct provider_descriptor_sign_in_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"sign_in", tmp_str.len = sizeof("sign_in") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_provider_sign_in(state, (&(*result).provider_descriptor_sign_in_provider_sign_in_m)))) && (((*result).provider_descriptor_sign_in_choice = provider_descriptor_sign_in_provider_sign_in_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).provider_descriptor_sign_in_choice = provider_descriptor_sign_in_null_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct provider_descriptor *result)
{
	...
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).provider_descriptor_default_base_url_choice = provider_descriptor_default_base_url_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& zcbor_present_decode(&((*result).provider_descriptor_sign_in_present), (zcbor_decoder_t *)decode_repeated_provider_descriptor_sign_in, state, (&(*result).provider_descriptor_sign_in))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_provider_descriptor_sign_in(state, (&(*result).provider_descriptor_sign_in));
	}
		...
		zcbor_state_t *state, struct response_provider_models *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ProviderModels", tmp_str.len = sizeof("ProviderModels") - 1, &tmp_str)))))
	&& (decode_model_page(state, (&(*result).response_provider_models_ProviderModels))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_response_custom_providers(
		zcbor_state_t *state, struct response_custom_providers *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CustomProviders", tmp_str.len = sizeof("CustomProviders") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).response_custom_providers_CustomProviders_custom_provider_m_count, (zcbor_decoder_t *)decode_custom_provider, state, (*&(*result).response_custom_providers_CustomProviders_custom_provider_m), sizeof(struct custom_provider))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_custom_provider(state, (*&(*result).response_custom_providers_CustomProviders_custom_provider_m));
	}
...
static bool decode_repeated_revision_page_next(
		zcbor_state_t *state, struct revision_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).revision_page_next_tstr)))) && (((*result).revision_page_next_choice = revision_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).revision_page_next_choice = revision_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_revision_page(
		zcbor_state_t *state, struct revision_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).revision_page_items_revision_m_count, (zcbor_decoder_t *)decode_revision, state, (*&(*result).revision_page_items_revision_m), sizeof(struct revision))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).revision_page_next_present), (zcbor_decoder_t *)decode_repeated_revision_page_next, state, (&(*result).revision_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_revision(state, (*&(*result).revision_page_items_revision_m));
		decode_repeated_revision_page_next(state, (&(*result).revision_page_next));
	}
		...
		zcbor_state_t *state, struct response_revisions *result)
{
	...
	&& (decode_revision_page(state, (&(*result).response_revisions_Revisions))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_auth_challenge_redirect(
		zcbor_state_t *state, struct auth_challenge_redirect *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Redirect", tmp_str.len = sizeof("Redirect") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"authorization_url", tmp_str.len = sizeof("authorization_url") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).Redirect_authorization_url))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_auth_challenge_form(
		zcbor_state_t *state, struct auth_challenge_form *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Form", tmp_str.len = sizeof("Form") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"title", tmp_str.len = sizeof("title") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).Form_title))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"fields", tmp_str.len = sizeof("fields") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).Form_fields_auth_param_field_m_count, (zcbor_decoder_t *)decode_auth_param_field, state, (*&(*result).Form_fields_auth_param_field_m), sizeof(struct auth_param_field))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_auth_param_field(state, (*&(*result).Form_fields_auth_param_field_m));
	}
...
static bool decode_auth_challenge_qr(
		zcbor_state_t *state, struct auth_challenge_qr *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Qr", tmp_str.len = sizeof("Qr") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"payload", tmp_str.len = sizeof("payload") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).Qr_payload))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"image", tmp_str.len = sizeof("image") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_bstr_decode(state, (&(*result).Qr_image_byte_array_m)))) && (((*result).Qr_image_choice = Qr_image_byte_array_m_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).Qr_image_choice = Qr_image_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"poll_interval_ms", tmp_str.len = sizeof("poll_interval_ms") - 1, &tmp_str)))))
	&& (zcbor_uint64_decode(state, (&(*result).Qr_poll_interval_ms))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_auth_challenge_message(
		zcbor_state_t *state, struct auth_challenge_message *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
...
static bool decode_auth_challenge(
		zcbor_state_t *state, struct auth_challenge_r *result)
{
	zcbor_log("%s\r\n", __func__);
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((decode_auth_challenge_redirect(state, (&(*result).auth_challenge_redirect_m)))) && (((*result).auth_challenge_choice = auth_challenge_redirect_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_auth_challenge_form(state, (&(*result).auth_challenge_form_m)))) && (((*result).auth_challenge_choice = auth_challenge_form_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_auth_challenge_qr(state, (&(*result).auth_challenge_qr_m)))) && (((*result).auth_challenge_choice = auth_challenge_qr_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_auth_challenge_message(state, (&(*result).auth_challenge_message_m)))) && (((*result).auth_challenge_choice = auth_challenge_message_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct auth_begin_response *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"challenge", tmp_str.len = sizeof("challenge") - 1, &tmp_str)))))
	&& (decode_auth_challenge(state, (&(*result).auth_begin_response_challenge))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"expires_at", tmp_str.len = sizeof("expires_at") - 1, &tmp_str)))))
	&& (zcbor_uint64_decode(state, (&(*result).auth_begin_response_expires_at))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_auth_step_result_challenge(
		zcbor_state_t *state, struct auth_step_result_challenge *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Challenge", tmp_str.len = sizeof("Challenge") - 1, &tmp_str)))))
	&& (decode_auth_challenge(state, (&(*result).auth_step_result_challenge_Challenge))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_auth_step_result_completed(
		zcbor_state_t *state, struct auth_step_result_completed *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Completed", tmp_str.len = sizeof("Completed") - 1, &tmp_str)))))
	&& (decode_auth_complete_response(state, (&(*result).auth_step_result_completed_Completed))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_auth_step_result(
		zcbor_state_t *state, struct auth_step_result_r *result)
{
	zcbor_log("%s\r\n", __func__);
	bool int_res;

	bool res = (((zcbor_union_start_code(state) && (int_res = ((((decode_auth_step_result_challenge(state, (&(*result).auth_step_result_challenge_m)))) && (((*result).auth_step_result_choice = auth_step_result_challenge_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_auth_step_result_completed(state, (&(*result).auth_step_result_completed_m)))) && (((*result).auth_step_result_choice = auth_step_result_completed_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_response_auth_stepped(
		zcbor_state_t *state, struct response_auth_stepped *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AuthStepped", tmp_str.len = sizeof("AuthStepped") - 1, &tmp_str)))))
	&& (decode_auth_step_result(state, (&(*result).response_auth_stepped_AuthStepped))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct auth_flow_kind_r *result)
{
	...
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"OAuth2Pkce", tmp_str.len = sizeof("OAuth2Pkce") - 1, &tmp_str))))) && (((*result).auth_flow_kind_choice = auth_flow_kind_OAuth2Pkce_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"BotToken", tmp_str.len = sizeof("BotToken") - 1, &tmp_str))))) && (((*result).auth_flow_kind_choice = auth_flow_kind_BotToken_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"UserToken", tmp_str.len = sizeof("UserToken") - 1, &tmp_str))))) && (((*result).auth_flow_kind_choice = auth_flow_kind_UserToken_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"PhoneOtp", tmp_str.len = sizeof("PhoneOtp") - 1, &tmp_str))))) && (((*result).auth_flow_kind_choice = auth_flow_kind_PhoneOtp_tstr_c), true))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"QrPairing", tmp_str.len = sizeof("QrPairing") - 1, &tmp_str))))) && (((*result).auth_flow_kind_choice = auth_flow_kind_QrPairing_tstr_c), true))), zcbor_union_end_code(state), int_res))));
...
static bool decode_repeated_checkpoint_page_next(
		zcbor_state_t *state, struct checkpoint_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).checkpoint_page_next_tstr)))) && (((*result).checkpoint_page_next_choice = checkpoint_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).checkpoint_page_next_choice = checkpoint_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_checkpoint_page(
		zcbor_state_t *state, struct checkpoint_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).checkpoint_page_items_checkpoint_info_m_count, (zcbor_decoder_t *)decode_checkpoint_info, state, (*&(*result).checkpoint_page_items_checkpoint_info_m), sizeof(struct checkpoint_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).checkpoint_page_next_present), (zcbor_decoder_t *)decode_repeated_checkpoint_page_next, state, (&(*result).checkpoint_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_checkpoint_info(state, (*&(*result).checkpoint_page_items_checkpoint_info_m));
		decode_repeated_checkpoint_page_next(state, (&(*result).checkpoint_page_next));
	}
		...
		zcbor_state_t *state, struct response_checkpoints *result)
{
	...
	&& (decode_checkpoint_page(state, (&(*result).response_checkpoints_Checkpoints))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_session_detail_engine(
		zcbor_state_t *state, struct session_detail_engine *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (decode_engine_selector(state, (&(*result).session_detail_engine)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_session_detail_foreign_backend(
		zcbor_state_t *state, struct session_detail_foreign_backend *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"foreign_backend", tmp_str.len = sizeof("foreign_backend") - 1, &tmp_str)))))
	&& (decode_foreign_backend(state, (&(*result).session_detail_foreign_backend)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_model_choice(
		zcbor_state_t *state, struct model_choice *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).model_choice_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).model_choice_label))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_model_selector(
		zcbor_state_t *state, struct model_selector *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"option_id", tmp_str.len = sizeof("option_id") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).model_selector_option_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"current", tmp_str.len = sizeof("current") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).model_selector_current))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"choices", tmp_str.len = sizeof("choices") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).model_selector_choices_model_choice_m_count, (zcbor_decoder_t *)decode_model_choice, state, (*&(*result).model_selector_choices_model_choice_m), sizeof(struct model_choice))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_model_choice(state, (*&(*result).model_selector_choices_model_choice_m));
	}
...
static bool decode_repeated_session_detail_model_selector(
		zcbor_state_t *state, struct session_detail_model_selector_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"model_selector", tmp_str.len = sizeof("model_selector") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_model_selector(state, (&(*result).session_detail_model_selector_model_selector_m)))) && (((*result).session_detail_model_selector_choice = session_detail_model_selector_model_selector_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).session_detail_model_selector_choice = session_detail_model_selector_null_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct session_detail *result)
{
	...
	&& zcbor_present_decode(&((*result).session_detail_checkpoints_present), (zcbor_decoder_t *)decode_repeated_session_detail_checkpoints, state, (&(*result).session_detail_checkpoints))
	&& zcbor_present_decode(&((*result).session_detail_engine_present), (zcbor_decoder_t *)decode_repeated_session_detail_engine, state, (&(*result).session_detail_engine))
	&& zcbor_present_decode(&((*result).session_detail_foreign_backend_present), (zcbor_decoder_t *)decode_repeated_session_detail_foreign_backend, state, (&(*result).session_detail_foreign_backend))
	&& zcbor_present_decode(&((*result).session_detail_model_selector_present), (zcbor_decoder_t *)decode_repeated_session_detail_model_selector, state, (&(*result).session_detail_model_selector))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_session_detail_engine(state, (&(*result).session_detail_engine));
		decode_repeated_session_detail_foreign_backend(state, (&(*result).session_detail_foreign_backend));
		decode_repeated_session_detail_model_selector(state, (&(*result).session_detail_model_selector));
	}
...
static bool decode_repeated_top_tools_name_l(
		zcbor_state_t *state, struct top_tools_name_l *result)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_list_start_decode(state) && ((((zcbor_tstr_decode(state, (&(*result).top_tools_name_l_name))))
	&& ((zcbor_uint32_decode(state, (&(*result).top_tools_name_l_count))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_session_recap(
		zcbor_state_t *state, struct session_recap *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"title", tmp_str.len = sizeof("title") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).session_recap_title_tstr)))) && (((*result).session_recap_title_choice = session_recap_title_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).session_recap_title_choice = session_recap_title_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"user_turns", tmp_str.len = sizeof("user_turns") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).session_recap_user_turns))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"assistant_turns", tmp_str.len = sizeof("assistant_turns") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).session_recap_assistant_turns))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"tool_results", tmp_str.len = sizeof("tool_results") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).session_recap_tool_results))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"top_tools", tmp_str.len = sizeof("top_tools") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).top_tools_name_l_count, (zcbor_decoder_t *)decode_repeated_top_tools_name_l, state, (*&(*result).top_tools_name_l), sizeof(struct top_tools_name_l))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"files_touched", tmp_str.len = sizeof("files_touched") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).session_recap_files_touched_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).session_recap_files_touched_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"last_ask", tmp_str.len = sizeof("last_ask") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).session_recap_last_ask_tstr)))) && (((*result).session_recap_last_ask_choice = session_recap_last_ask_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).session_recap_last_ask_choice = session_recap_last_ask_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"last_reply", tmp_str.len = sizeof("last_reply") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).session_recap_last_reply_tstr)))) && (((*result).session_recap_last_reply_choice = session_recap_last_reply_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).session_recap_last_reply_choice = session_recap_last_reply_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_top_tools_name_l(state, (*&(*result).top_tools_name_l));
		zcbor_tstr_decode(state, (*&(*result).session_recap_files_touched_tstr));
	}
...
static bool decode_response_session_recap(
		zcbor_state_t *state, struct response_session_recap *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"SessionRecap", tmp_str.len = sizeof("SessionRecap") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_session_recap(state, (&(*result).response_session_recap_SessionRecap_session_recap_m)))) && (((*result).response_session_recap_SessionRecap_choice = response_session_recap_SessionRecap_session_recap_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).response_session_recap_SessionRecap_choice = response_session_recap_SessionRecap_null_m_c), true)))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_response_agent_catalog(
		zcbor_state_t *state, struct response_agent_catalog *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AgentCatalog", tmp_str.len = sizeof("AgentCatalog") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).response_agent_catalog_AgentCatalog_agent_entry_m_count, (zcbor_decoder_t *)decode_agent_entry, state, (*&(*result).response_agent_catalog_AgentCatalog_agent_entry_m), sizeof(struct agent_entry))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_gateway_status(
		zcbor_state_t *state, struct gateway_status *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).gateway_status_enabled))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"addr", tmp_str.len = sizeof("addr") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).gateway_status_addr_tstr)))) && (((*result).gateway_status_addr_choice = gateway_status_addr_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).gateway_status_addr_choice = gateway_status_addr_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"listening", tmp_str.len = sizeof("listening") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).gateway_status_listening))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"last_error", tmp_str.len = sizeof("last_error") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).gateway_status_last_error_tstr)))) && (((*result).gateway_status_last_error_choice = gateway_status_last_error_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).gateway_status_last_error_choice = gateway_status_last_error_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_response_gateway_status(
		zcbor_state_t *state, struct response_gateway_status *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"GatewayStatus", tmp_str.len = sizeof("GatewayStatus") - 1, &tmp_str)))))
	&& (decode_gateway_status(state, (&(*result).response_gateway_status_GatewayStatus))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_caps_report_max_composed_profiles(
		zcbor_state_t *state, struct caps_report_max_composed_profiles *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"max_composed_profiles", tmp_str.len = sizeof("max_composed_profiles") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).caps_report_max_composed_profiles)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_caps_report_max_ephemeral_per_session(
		zcbor_state_t *state, struct caps_report_max_ephemeral_per_session *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"max_ephemeral_per_session", tmp_str.len = sizeof("max_ephemeral_per_session") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).caps_report_max_ephemeral_per_session)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_caps_report(
		zcbor_state_t *state, struct caps_report *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"orchestrate_max_depth", tmp_str.len = sizeof("orchestrate_max_depth") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).caps_report_orchestrate_max_depth))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"orchestrate_max_fanout", tmp_str.len = sizeof("orchestrate_max_fanout") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).caps_report_orchestrate_max_fanout))))
	&& zcbor_present_decode(&((*result).caps_report_max_composed_profiles_present), (zcbor_decoder_t *)decode_repeated_caps_report_max_composed_profiles, state, (&(*result).caps_report_max_composed_profiles))
	&& zcbor_present_decode(&((*result).caps_report_max_ephemeral_per_session_present), (zcbor_decoder_t *)decode_repeated_caps_report_max_ephemeral_per_session, state, (&(*result).caps_report_max_ephemeral_per_session))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_caps_report_max_composed_profiles(state, (&(*result).caps_report_max_composed_profiles));
		decode_repeated_caps_report_max_ephemeral_per_session(state, (&(*result).caps_report_max_ephemeral_per_session));
	}
...
static bool decode_response_caps(
		zcbor_state_t *state, struct response_caps *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Caps", tmp_str.len = sizeof("Caps") - 1, &tmp_str)))))
	&& (decode_caps_report(state, (&(*result).response_caps_Caps))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_chat_route_page_next(
		zcbor_state_t *state, struct chat_route_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).chat_route_page_next_tstr)))) && (((*result).chat_route_page_next_choice = chat_route_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).chat_route_page_next_choice = chat_route_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_chat_route_page(
		zcbor_state_t *state, struct chat_route_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).chat_route_page_items_chat_route_m_count, (zcbor_decoder_t *)decode_chat_route, state, (*&(*result).chat_route_page_items_chat_route_m), sizeof(struct chat_route))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).chat_route_page_next_present), (zcbor_decoder_t *)decode_repeated_chat_route_page_next, state, (&(*result).chat_route_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_chat_route(state, (*&(*result).chat_route_page_items_chat_route_m));
		decode_repeated_chat_route_page_next(state, (&(*result).chat_route_page_next));
	}
		...
		zcbor_state_t *state, struct response_chat_routes *result)
{
	...
	&& (decode_chat_route_page(state, (&(*result).response_chat_routes_ChatRoutes))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_room_page_next(
		zcbor_state_t *state, struct room_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).room_page_next_tstr)))) && (((*result).room_page_next_choice = room_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).room_page_next_choice = room_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_room_page(
		zcbor_state_t *state, struct room_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).room_page_items_room_info_m_count, (zcbor_decoder_t *)decode_room_info, state, (*&(*result).room_page_items_room_info_m), sizeof(struct room_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).room_page_next_present), (zcbor_decoder_t *)decode_repeated_room_page_next, state, (&(*result).room_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_room_info(state, (*&(*result).room_page_items_room_info_m));
		decode_repeated_room_page_next(state, (&(*result).room_page_next));
	}
		...
		zcbor_state_t *state, struct response_rooms *result)
{
	...
	&& (decode_room_page(state, (&(*result).response_rooms_Rooms))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_policy_entry(
		zcbor_state_t *state, struct policy_entry *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"key", tmp_str.len = sizeof("key") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).policy_entry_key))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).policy_entry_label))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"value", tmp_str.len = sizeof("value") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).policy_entry_value))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_adapter_info_policies(
		zcbor_state_t *state, struct adapter_info_policies_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"policies", tmp_str.len = sizeof("policies") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).adapter_info_policies_policy_entry_m_count, (zcbor_decoder_t *)decode_policy_entry, state, (*&(*result).adapter_info_policies_policy_entry_m), sizeof(struct policy_entry))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_policy_entry(state, (*&(*result).adapter_info_policies_policy_entry_m));
	}
...
static bool decode_conversation_ops(
		zcbor_state_t *state, struct conversation_ops *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"create", tmp_str.len = sizeof("create") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_create))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"join_channel", tmp_str.len = sizeof("join_channel") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_join_channel))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"leave", tmp_str.len = sizeof("leave") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_leave))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"delete", tmp_str.len = sizeof("delete") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_delete))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"send", tmp_str.len = sizeof("send") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_send))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"set_topic", tmp_str.len = sizeof("set_topic") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_set_topic))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"set_title", tmp_str.len = sizeof("set_title") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_set_title))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"set_description", tmp_str.len = sizeof("set_description") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).conversation_ops_set_description))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_adapter_info_conversation_ops(
		zcbor_state_t *state, struct adapter_info_conversation_ops_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conversation_ops", tmp_str.len = sizeof("conversation_ops") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_conversation_ops(state, (&(*result).adapter_info_conversation_ops_conversation_ops_m)))) && (((*result).adapter_info_conversation_ops_choice = adapter_info_conversation_ops_conversation_ops_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).adapter_info_conversation_ops_choice = adapter_info_conversation_ops_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_membership_ops(
		zcbor_state_t *state, struct membership_ops *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"invite", tmp_str.len = sizeof("invite") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).membership_ops_invite))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"remove", tmp_str.len = sizeof("remove") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).membership_ops_remove))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ban", tmp_str.len = sizeof("ban") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).membership_ops_ban))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"set_role", tmp_str.len = sizeof("set_role") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).membership_ops_set_role))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_adapter_info_membership_ops(
		zcbor_state_t *state, struct adapter_info_membership_ops_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"membership_ops", tmp_str.len = sizeof("membership_ops") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_membership_ops(state, (&(*result).adapter_info_membership_ops_membership_ops_m)))) && (((*result).adapter_info_membership_ops_choice = adapter_info_membership_ops_membership_ops_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).adapter_info_membership_ops_choice = adapter_info_membership_ops_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_contacts_ops(
		zcbor_state_t *state, struct contacts_ops *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"get_profile", tmp_str.len = sizeof("get_profile") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).contacts_ops_get_profile))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"action_menu", tmp_str.len = sizeof("action_menu") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).contacts_ops_action_menu))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"set_alias", tmp_str.len = sizeof("set_alias") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).contacts_ops_set_alias))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_adapter_info_contacts_ops(
		zcbor_state_t *state, struct adapter_info_contacts_ops_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"contacts_ops", tmp_str.len = sizeof("contacts_ops") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_contacts_ops(state, (&(*result).adapter_info_contacts_ops_contacts_ops_m)))) && (((*result).adapter_info_contacts_ops_choice = adapter_info_contacts_ops_contacts_ops_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).adapter_info_contacts_ops_choice = adapter_info_contacts_ops_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_roster_ops(
		zcbor_state_t *state, struct roster_ops *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"list", tmp_str.len = sizeof("list") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).roster_ops_list))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"add", tmp_str.len = sizeof("add") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).roster_ops_add))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"update", tmp_str.len = sizeof("update") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).roster_ops_update))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"remove", tmp_str.len = sizeof("remove") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).roster_ops_remove))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_adapter_info_roster_ops(
		zcbor_state_t *state, struct adapter_info_roster_ops_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"roster_ops", tmp_str.len = sizeof("roster_ops") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_roster_ops(state, (&(*result).adapter_info_roster_ops_roster_ops_m)))) && (((*result).adapter_info_roster_ops_choice = adapter_info_roster_ops_roster_ops_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).adapter_info_roster_ops_choice = adapter_info_roster_ops_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_adapter_info_directory(
		zcbor_state_t *state, struct adapter_info_directory *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"directory", tmp_str.len = sizeof("directory") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).adapter_info_directory)))));
		...
		zcbor_state_t *state, struct adapter_info *result)
{
	...
	&& zcbor_present_decode(&((*result).adapter_info_account_schema_present), (zcbor_decoder_t *)decode_repeated_adapter_info_account_schema, state, (&(*result).adapter_info_account_schema))
	&& zcbor_present_decode(&((*result).adapter_info_policies_present), (zcbor_decoder_t *)decode_repeated_adapter_info_policies, state, (&(*result).adapter_info_policies))
	&& zcbor_present_decode(&((*result).adapter_info_conversation_ops_present), (zcbor_decoder_t *)decode_repeated_adapter_info_conversation_ops, state, (&(*result).adapter_info_conversation_ops))
	&& zcbor_present_decode(&((*result).adapter_info_membership_ops_present), (zcbor_decoder_t *)decode_repeated_adapter_info_membership_ops, state, (&(*result).adapter_info_membership_ops))
	&& zcbor_present_decode(&((*result).adapter_info_contacts_ops_present), (zcbor_decoder_t *)decode_repeated_adapter_info_contacts_ops, state, (&(*result).adapter_info_contacts_ops))
	&& zcbor_present_decode(&((*result).adapter_info_roster_ops_present), (zcbor_decoder_t *)decode_repeated_adapter_info_roster_ops, state, (&(*result).adapter_info_roster_ops))
	&& zcbor_present_decode(&((*result).adapter_info_directory_present), (zcbor_decoder_t *)decode_repeated_adapter_info_directory, state, (&(*result).adapter_info_directory))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_adapter_info_policies(state, (&(*result).adapter_info_policies));
		decode_repeated_adapter_info_conversation_ops(state, (&(*result).adapter_info_conversation_ops));
		decode_repeated_adapter_info_membership_ops(state, (&(*result).adapter_info_membership_ops));
		decode_repeated_adapter_info_contacts_ops(state, (&(*result).adapter_info_contacts_ops));
		decode_repeated_adapter_info_roster_ops(state, (&(*result).adapter_info_roster_ops));
		decode_repeated_adapter_info_directory(state, (&(*result).adapter_info_directory));
	}
...
static bool decode_repeated_transport_instance_info_reason(
		zcbor_state_t *state, struct transport_instance_info_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_disconnect_reason(state, (&(*result).transport_instance_info_reason_disconnect_reason_m)))) && (((*result).transport_instance_info_reason_choice = transport_instance_info_reason_disconnect_reason_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).transport_instance_info_reason_choice = transport_instance_info_reason_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_transport_instance_info_message(
		zcbor_state_t *state, struct transport_instance_info_message_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).transport_instance_info_message_tstr)))) && (((*result).transport_instance_info_message_choice = transport_instance_info_message_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).transport_instance_info_message_choice = transport_instance_info_message_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_transport_instance_info_fatal(
		zcbor_state_t *state, struct transport_instance_info_fatal *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"fatal", tmp_str.len = sizeof("fatal") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).transport_instance_info_fatal)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_transport_instance_info_enabled(
		zcbor_state_t *state, struct transport_instance_info_enabled *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).transport_instance_info_enabled)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_transport_instance_info_label(
		zcbor_state_t *state, struct transport_instance_info_label_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).transport_instance_info_label_tstr)))) && (((*result).transport_instance_info_label_choice = transport_instance_info_label_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).transport_instance_info_label_choice = transport_instance_info_label_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct transport_instance_info *result)
{
	...
	&& zcbor_present_decode(&((*result).transport_instance_info_bound_profile_present), (zcbor_decoder_t *)decode_repeated_transport_instance_info_bound_profile, state, (&(*result).transport_instance_info_bound_profile))
	&& zcbor_present_decode(&((*result).transport_instance_info_reason_present), (zcbor_decoder_t *)decode_repeated_transport_instance_info_reason, state, (&(*result).transport_instance_info_reason))
	&& zcbor_present_decode(&((*result).transport_instance_info_message_present), (zcbor_decoder_t *)decode_repeated_transport_instance_info_message, state, (&(*result).transport_instance_info_message))
	&& zcbor_present_decode(&((*result).transport_instance_info_fatal_present), (zcbor_decoder_t *)decode_repeated_transport_instance_info_fatal, state, (&(*result).transport_instance_info_fatal))
	&& zcbor_present_decode(&((*result).transport_instance_info_enabled_present), (zcbor_decoder_t *)decode_repeated_transport_instance_info_enabled, state, (&(*result).transport_instance_info_enabled))
	&& zcbor_present_decode(&((*result).transport_instance_info_label_present), (zcbor_decoder_t *)decode_repeated_transport_instance_info_label, state, (&(*result).transport_instance_info_label))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
	...
	if (false) {
		...
		decode_repeated_transport_instance_info_reason(state, (&(*result).transport_instance_info_reason));
		decode_repeated_transport_instance_info_message(state, (&(*result).transport_instance_info_message));
		decode_repeated_transport_instance_info_fatal(state, (&(*result).transport_instance_info_fatal));
		decode_repeated_transport_instance_info_enabled(state, (&(*result).transport_instance_info_enabled));
		decode_repeated_transport_instance_info_label(state, (&(*result).transport_instance_info_label));
	}
...
static bool decode_repeated_conv_page_next(
		zcbor_state_t *state, struct conv_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).conv_page_next_tstr)))) && (((*result).conv_page_next_choice = conv_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).conv_page_next_choice = conv_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_conv_page(
		zcbor_state_t *state, struct conv_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).conv_page_items_conversation_info_m_count, (zcbor_decoder_t *)decode_conversation_info, state, (*&(*result).conv_page_items_conversation_info_m), sizeof(struct conversation_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).conv_page_next_present), (zcbor_decoder_t *)decode_repeated_conv_page_next, state, (&(*result).conv_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_conversation_info(state, (*&(*result).conv_page_items_conversation_info_m));
		decode_repeated_conv_page_next(state, (&(*result).conv_page_next));
	}
		...
		zcbor_state_t *state, struct response_conversations *result)
{
	...
	&& (decode_conv_page(state, (&(*result).response_conversations_Conversations))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_contact_page_next(
		zcbor_state_t *state, struct contact_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).contact_page_next_tstr)))) && (((*result).contact_page_next_choice = contact_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).contact_page_next_choice = contact_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_contact_page(
		zcbor_state_t *state, struct contact_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).contact_page_items_contact_info_m_count, (zcbor_decoder_t *)decode_contact_info, state, (*&(*result).contact_page_items_contact_info_m), sizeof(struct contact_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).contact_page_next_present), (zcbor_decoder_t *)decode_repeated_contact_page_next, state, (&(*result).contact_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_contact_info(state, (*&(*result).contact_page_items_contact_info_m));
		decode_repeated_contact_page_next(state, (&(*result).contact_page_next));
	}
...
static bool decode_response_contact_page(
		zcbor_state_t *state, struct response_contact_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ContactPage", tmp_str.len = sizeof("ContactPage") - 1, &tmp_str)))))
	&& (decode_contact_page(state, (&(*result).response_contact_page_ContactPage))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_fs_list_page_next(
		zcbor_state_t *state, struct fs_list_page_next_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).fs_list_page_next_tstr)))) && (((*result).fs_list_page_next_choice = fs_list_page_next_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).fs_list_page_next_choice = fs_list_page_next_null_m_c), true))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_fs_list_page(
		zcbor_state_t *state, struct fs_list_page *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 64, &(*result).fs_list_page_items_fs_entry_m_count, (zcbor_decoder_t *)decode_fs_entry, state, (*&(*result).fs_list_page_items_fs_entry_m), sizeof(struct fs_entry))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& zcbor_present_decode(&((*result).fs_list_page_next_present), (zcbor_decoder_t *)decode_repeated_fs_list_page_next, state, (&(*result).fs_list_page_next))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_fs_entry(state, (*&(*result).fs_list_page_items_fs_entry_m));
		decode_repeated_fs_list_page_next(state, (&(*result).fs_list_page_next));
	}
		...
		zcbor_state_t *state, struct response_fs_list *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"FsList", tmp_str.len = sizeof("FsList") - 1, &tmp_str)))))
	&& (decode_fs_list_page(state, (&(*result).response_fs_list_FsList))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct api_response_r *result)
{
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_session_created(state, (&(*result).api_response_response_session_created_m)))) && (((*result).api_response_choice = api_response_response_session_created_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_fingerprints(state, (&(*result).api_response_response_fingerprints_m)))) && (((*result).api_response_choice = api_response_response_fingerprints_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_custom_providers(state, (&(*result).api_response_response_custom_providers_m)))) && (((*result).api_response_choice = api_response_response_custom_providers_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_auth_stepped(state, (&(*result).api_response_response_auth_stepped_m)))) && (((*result).api_response_choice = api_response_response_auth_stepped_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_session_recap(state, (&(*result).api_response_response_session_recap_m)))) && (((*result).api_response_choice = api_response_response_session_recap_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_response_agent_catalog(state, (&(*result).api_response_response_agent_catalog_m)))) && (((*result).api_response_choice = api_response_response_agent_catalog_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_gateway_status(state, (&(*result).api_response_response_gateway_status_m)))) && (((*result).api_response_choice = api_response_response_gateway_status_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_response_caps(state, (&(*result).api_response_response_caps_m)))) && (((*result).api_response_choice = api_response_response_caps_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_contact_page(state, (&(*result).api_response_response_contact_page_m)))) && (((*result).api_response_choice = api_response_response_contact_page_m_c), true)))
		...
		zcbor_state_t *state, struct api_request_r *result)
{
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_session_create(state, (&(*result).api_request_request_session_create_m)))) && (((*result).api_request_choice = api_request_request_session_create_m_c), true)))
	...
	|| (((decode_request_tree(state, (&(*result).api_request_request_tree_m)))) && (((*result).api_request_choice = api_request_request_tree_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_request_unit(state, (&(*result).api_request_request_unit_m)))) && (((*result).api_request_choice = api_request_request_unit_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_fingerprint_list(state, (&(*result).api_request_request_fingerprint_list_m)))) && (((*result).api_request_choice = api_request_request_fingerprint_list_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_fingerprint_revoke(state, (&(*result).api_request_request_fingerprint_revoke_m)))) && (((*result).api_request_choice = api_request_request_fingerprint_revoke_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_credential_set_label(state, (&(*result).api_request_request_credential_set_label_m)))) && (((*result).api_request_choice = api_request_request_credential_set_label_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CustomProviderList", tmp_str.len = sizeof("CustomProviderList") - 1, &tmp_str))))) && (((*result).api_request_choice = api_request_request_custom_provider_list_m_c), true)))
	|| (((decode_request_custom_provider_set(state, (&(*result).api_request_request_custom_provider_set_m)))) && (((*result).api_request_choice = api_request_request_custom_provider_set_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_request_custom_provider_remove(state, (&(*result).api_request_request_custom_provider_remove_m)))) && (((*result).api_request_choice = api_request_request_custom_provider_remove_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_auth_step(state, (&(*result).api_request_request_auth_step_m)))) && (((*result).api_request_choice = api_request_request_auth_step_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_session_search(state, (&(*result).api_request_request_session_search_m)))) && (((*result).api_request_choice = api_request_request_session_search_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_session_recap(state, (&(*result).api_request_request_session_recap_m)))) && (((*result).api_request_choice = api_request_request_session_recap_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AgentDiscover", tmp_str.len = sizeof("AgentDiscover") - 1, &tmp_str))))) && (((*result).api_request_choice = api_request_request_agent_discover_m_c), true)))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"AgentCatalog", tmp_str.len = sizeof("AgentCatalog") - 1, &tmp_str))))) && (((*result).api_request_choice = api_request_request_agent_catalog_m_c), true))
	|| (((decode_request_agent_register(state, (&(*result).api_request_request_agent_register_m)))) && (((*result).api_request_choice = api_request_request_agent_register_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_request_agent_remove(state, (&(*result).api_request_request_agent_remove_m)))) && (((*result).api_request_choice = api_request_request_agent_remove_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_tool_set_enabled(state, (&(*result).api_request_request_tool_set_enabled_m)))) && (((*result).api_request_choice = api_request_request_tool_set_enabled_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Caps", tmp_str.len = sizeof("Caps") - 1, &tmp_str))))) && (((*result).api_request_choice = api_request_request_caps_m_c), true)))
	|| (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ConfigGet", tmp_str.len = sizeof("ConfigGet") - 1, &tmp_str))))) && (((*result).api_request_choice = api_request_request_config_get_m_c), true))
	...
	|| (zcbor_union_elem_code(state) && (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"GatewayGet", tmp_str.len = sizeof("GatewayGet") - 1, &tmp_str))))) && (((*result).api_request_choice = api_request_request_gateway_get_m_c), true)))
	|| (((decode_request_gateway_set(state, (&(*result).api_request_request_gateway_set_m)))) && (((*result).api_request_choice = api_request_request_gateway_set_m_c), true))
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_routing_list_chats(state, (&(*result).api_request_request_routing_list_chats_m)))) && (((*result).api_request_choice = api_request_request_routing_list_chats_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_routing_get(state, (&(*result).api_request_request_routing_get_m)))) && (((*result).api_request_choice = api_request_request_routing_get_m_c), true)))
	...
	|| (((decode_request_transport_disconnect(state, (&(*result).api_request_request_transport_disconnect_m)))) && (((*result).api_request_choice = api_request_request_transport_disconnect_m_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_request_transport_remove(state, (&(*result).api_request_request_transport_remove_m)))) && (((*result).api_request_choice = api_request_request_transport_remove_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_transport_connect(state, (&(*result).api_request_request_transport_connect_m)))) && (((*result).api_request_choice = api_request_request_transport_connect_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_transport_set_enabled(state, (&(*result).api_request_request_transport_set_enabled_m)))) && (((*result).api_request_choice = api_request_request_transport_set_enabled_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_transport_set_label(state, (&(*result).api_request_request_transport_set_label_m)))) && (((*result).api_request_choice = api_request_request_transport_set_label_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_conv_list(state, (&(*result).api_request_request_conv_list_m)))) && (((*result).api_request_choice = api_request_request_conv_list_m_c), true)))
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_roster_list(state, (&(*result).api_request_request_roster_list_m)))) && (((*result).api_request_choice = api_request_request_roster_list_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_roster_add(state, (&(*result).api_request_request_roster_add_m)))) && (((*result).api_request_choice = api_request_request_roster_add_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_roster_update(state, (&(*result).api_request_request_roster_update_m)))) && (((*result).api_request_choice = api_request_request_roster_update_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_roster_remove(state, (&(*result).api_request_request_roster_remove_m)))) && (((*result).api_request_choice = api_request_request_roster_remove_m_c), true)))
