...
static bool decode_request_profile_create(zcbor_state_t *state, void *result);
static bool decode_request_profile_update(zcbor_state_t *state, void *result);
...
static bool decode_repeated_ConvSend_from(zcbor_state_t *state, struct ConvSend_from_r *result);
...
static bool decode_repeated_ConvHistory_after_cursor(zcbor_state_t *state, struct ConvHistory_after_cursor *result);
static bool decode_repeated_ConvHistory_max(zcbor_state_t *state, struct ConvHistory_max *result);
static bool decode_request_conv_history(zcbor_state_t *state, struct request_conv_history *result);
static bool decode_repeated_MemberInvite_message(zcbor_state_t *state, struct MemberInvite_message_r *result);
static bool decode_request_member_invite(zcbor_state_t *state, struct request_member_invite *result);
static bool decode_repeated_MemberRemove_reason(zcbor_state_t *state, struct MemberRemove_reason_r *result);
static bool decode_request_member_remove(zcbor_state_t *state, struct request_member_remove *result);
static bool decode_repeated_MemberBan_reason(zcbor_state_t *state, struct MemberBan_reason_r *result);
...
static bool decode_repeated_FsWrite_base_revision(zcbor_state_t *state, struct FsWrite_base_revision_r *result);
static bool decode_repeated_FsWrite_force(zcbor_state_t *state, struct FsWrite_force *result);
...
static bool decode_repeated_FsWriteFromBlob_base_revision(zcbor_state_t *state, struct FsWriteFromBlob_base_revision_r *result);
static bool decode_repeated_FsWriteFromBlob_force(zcbor_state_t *state, struct FsWriteFromBlob_force *result);
...
static bool decode_response_profile(zcbor_state_t *state, void *result);
		...
		zcbor_state_t *state, struct byte_array *result)
{
	...
	bool res = (((zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).byte_array_uint_count, (zcbor_decoder_t *)zcbor_uint32_decode, state, (*&(*result).byte_array_uint), sizeof(uint32_t))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct agent_command_observe *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Observe_request_id))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct agent_command_snapshot *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).Snapshot_request_id))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct rewind_anchor_user_turn *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).UserTurn_ordinal))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct rewind_anchor_reply_after *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ordinal", tmp_str.len = sizeof("ordinal") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ReplyAfter_ordinal))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct rewind_anchor_cursor *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).Cursor_seq))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct agent_command_rewind_to *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).RewindTo_request_id))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct host_response *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).host_response_request_id))))
		...
		zcbor_state_t *state, struct request_session_history *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).SessionHistory_after_cursor))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct request_record_meta *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).RecordMeta_session))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"origin", tmp_str.len = sizeof("origin") - 1, &tmp_str)))))
	&& (decode_origin(state, (&(*result).RecordMeta_origin))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct request_unit_history *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after_cursor", tmp_str.len = sizeof("after_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).UnitHistory_after_cursor))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, void *result)
{
	...
	&& (zcbor_any_skip(state, NULL)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct skill_bundle *result)
{
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).files_tstrtstr_count, (zcbor_decoder_t *)decode_repeated_files_tstrtstr, state, (*&(*result).files_tstrtstr), sizeof(struct files_tstrtstr))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct distribution_head_seq_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).distribution_head_seq_uint)))) && (((*result).distribution_head_seq_choice = distribution_head_seq_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).distribution_head_seq_choice = distribution_head_seq_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct distribution *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).distribution_skills_skill_bundle_m_count, (zcbor_decoder_t *)decode_skill_bundle, state, (*&(*result).distribution_skills_skill_bundle_m), sizeof(struct skill_bundle))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
		...
		zcbor_state_t *state, struct request_profile_at *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).ProfileAt_seq))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_profile_revert *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ProfileRevert_seq))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_skill_at *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).SkillAt_seq))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_skill_revert *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).SkillRevert_seq))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_model_cancel *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ModelCancel_id))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_model_pause *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ModelPause_id))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_model_resume *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ModelResume_id))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_model_recommend *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"repo", tmp_str.len = sizeof("repo") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ModelRecommend_repo))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"revision", tmp_str.len = sizeof("revision") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ModelRecommend_revision_tstr)))) && (((*result).ModelRecommend_revision_choice = ModelRecommend_revision_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ModelRecommend_revision_choice = ModelRecommend_revision_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (decode_model_engine(state, (&(*result).ModelRecommend_engine))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"budget_bytes", tmp_str.len = sizeof("budget_bytes") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).ModelRecommend_budget_bytes_uint)))) && (((*result).ModelRecommend_budget_bytes_choice = ModelRecommend_budget_bytes_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ModelRecommend_budget_bytes_choice = ModelRecommend_budget_bytes_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct request_model_quantize *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"repo", tmp_str.len = sizeof("repo") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ModelQuantize_repo))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"revision", tmp_str.len = sizeof("revision") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ModelQuantize_revision_tstr)))) && (((*result).ModelQuantize_revision_choice = ModelQuantize_revision_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ModelQuantize_revision_choice = ModelQuantize_revision_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"target_quant", tmp_str.len = sizeof("target_quant") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ModelQuantize_target_quant))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"source_file", tmp_str.len = sizeof("source_file") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).ModelQuantize_source_file_tstr)))) && (((*result).ModelQuantize_source_file_choice = ModelQuantize_source_file_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).ModelQuantize_source_file_choice = ModelQuantize_source_file_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct auth_begin_request *result)
{
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).params_tstrtstr_count, (zcbor_decoder_t *)decode_repeated_params_tstrtstr, state, (*&(*result).params_tstrtstr), sizeof(struct params_tstrtstr))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))
		...
		zcbor_state_t *state, struct acp_recipe_args_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).acp_recipe_args_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).acp_recipe_args_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct acp_recipe_env_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).acp_recipe_env_kv_pair_m_count, (zcbor_decoder_t *)decode_kv_pair, state, (*&(*result).acp_recipe_env_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct acp_agent_entry_capabilities_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).acp_agent_entry_capabilities_kv_pair_m_count, (zcbor_decoder_t *)decode_kv_pair, state, (*&(*result).acp_agent_entry_capabilities_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct cron_spec_context_from_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).cron_spec_context_from_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).cron_spec_context_from_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct cron_spec_enabled_toolsets_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).enabled_toolsets_tstr_l_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).enabled_toolsets_tstr_l_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))) && (((*result).cron_spec_enabled_toolsets_choice = enabled_toolsets_tstr_l_c), true))
		...
		zcbor_state_t *state, struct cron_spec_skills_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).cron_spec_skills_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).cron_spec_skills_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct presence_idle_since_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).presence_idle_since_uint)))) && (((*result).presence_idle_since_choice = presence_idle_since_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).presence_idle_since_choice = presence_idle_since_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct account_settings_schema_fields_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).account_settings_schema_fields_auth_param_field_m_count, (zcbor_decoder_t *)decode_auth_param_field, state, (*&(*result).account_settings_schema_fields_auth_param_field_m), sizeof(struct auth_param_field))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct account_settings_values_values_r *result)
{
	...
	&& (zcbor_map_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).values_tstrtstr_count, (zcbor_decoder_t *)decode_repeated_values_tstrtstr, state, (*&(*result).values_tstrtstr), sizeof(struct values_tstrtstr))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_ConvSend_from(
		zcbor_state_t *state, struct ConvSend_from_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_participant(state, (&(*result).ConvSend_from_participant_m)))) && (((*result).ConvSend_from_choice = ConvSend_from_participant_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).ConvSend_from_choice = ConvSend_from_null_m_c), true)))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_conv_send *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ConvSend_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ConvSend_conv))))
	&& zcbor_present_decode(&((*result).ConvSend_from_present), (zcbor_decoder_t *)decode_repeated_ConvSend_from, state, (&(*result).ConvSend_from))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (decode_user_msg(state, (&(*result).ConvSend_message))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_ConvSend_from(state, (&(*result).ConvSend_from));
	}
...
static bool decode_repeated_ConvHistory_after_cursor(
		zcbor_state_t *state, struct ConvHistory_after_cursor *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after_cursor", tmp_str.len = sizeof("after_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ConvHistory_after_cursor)))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_ConvHistory_max(
		zcbor_state_t *state, struct ConvHistory_max *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ConvHistory_max)))));
		...
		zcbor_state_t *state, struct request_conv_history *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ConvHistory_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).ConvHistory_conv))))
	&& zcbor_present_decode(&((*result).ConvHistory_after_cursor_present), (zcbor_decoder_t *)decode_repeated_ConvHistory_after_cursor, state, (&(*result).ConvHistory_after_cursor))
	&& zcbor_present_decode(&((*result).ConvHistory_max_present), (zcbor_decoder_t *)decode_repeated_ConvHistory_max, state, (&(*result).ConvHistory_max))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_ConvHistory_after_cursor(state, (&(*result).ConvHistory_after_cursor));
		decode_repeated_ConvHistory_max(state, (&(*result).ConvHistory_max));
	}
...
static bool decode_repeated_MemberInvite_message(
		zcbor_state_t *state, struct MemberInvite_message_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).MemberInvite_message_tstr)))) && (((*result).MemberInvite_message_choice = MemberInvite_message_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).MemberInvite_message_choice = MemberInvite_message_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_member_invite *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberInvite_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberInvite_conv))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (decode_participant(state, (&(*result).MemberInvite_who))))
	&& zcbor_present_decode(&((*result).MemberInvite_message_present), (zcbor_decoder_t *)decode_repeated_MemberInvite_message, state, (&(*result).MemberInvite_message))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_MemberInvite_message(state, (&(*result).MemberInvite_message));
	}
...
static bool decode_repeated_MemberRemove_reason(
		zcbor_state_t *state, struct MemberRemove_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).MemberRemove_reason_tstr)))) && (((*result).MemberRemove_reason_choice = MemberRemove_reason_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).MemberRemove_reason_choice = MemberRemove_reason_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_member_remove *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberRemove_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberRemove_conv))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (decode_participant(state, (&(*result).MemberRemove_who))))
	&& zcbor_present_decode(&((*result).MemberRemove_reason_present), (zcbor_decoder_t *)decode_repeated_MemberRemove_reason, state, (&(*result).MemberRemove_reason))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_MemberRemove_reason(state, (&(*result).MemberRemove_reason));
	}
...
static bool decode_repeated_MemberBan_reason(
		zcbor_state_t *state, struct MemberBan_reason_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_tstr_decode(state, (&(*result).MemberBan_reason_tstr)))) && (((*result).MemberBan_reason_choice = MemberBan_reason_tstr_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).MemberBan_reason_choice = MemberBan_reason_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct request_member_ban *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberBan_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberBan_conv))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (decode_participant(state, (&(*result).MemberBan_who))))
	&& zcbor_present_decode(&((*result).MemberBan_reason_present), (zcbor_decoder_t *)decode_repeated_MemberBan_reason, state, (&(*result).MemberBan_reason))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	if (false) {
		/* For testing that the types of the arguments are correct.
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_MemberBan_reason(state, (&(*result).MemberBan_reason));
	}
		...
		zcbor_state_t *state, struct request_member_set_role *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberSetRole_transport))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).MemberSetRole_conv))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (decode_participant(state, (&(*result).MemberSetRole_who))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"role", tmp_str.len = sizeof("role") - 1, &tmp_str)))))
	&& (decode_member_role(state, (&(*result).MemberSetRole_role))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct FsRead_max_bytes *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).FsRead_max_bytes)))));
		...
		zcbor_state_t *state, struct fs_revision *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).fs_revision_mtime_ms))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"size", tmp_str.len = sizeof("size") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).fs_revision_size))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_FsWrite_base_revision(
		zcbor_state_t *state, struct FsWrite_base_revision_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_fs_revision(state, (&(*result).FsWrite_base_revision_fs_revision_m)))) && (((*result).FsWrite_base_revision_choice = FsWrite_base_revision_fs_revision_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).FsWrite_base_revision_choice = FsWrite_base_revision_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_FsWrite_force(
		zcbor_state_t *state, struct FsWrite_force *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"force", tmp_str.len = sizeof("force") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).FsWrite_force)))));
		...
		zcbor_state_t *state, struct request_fs_write *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"root", tmp_str.len = sizeof("root") - 1, &tmp_str)))))
	&& (decode_fs_root_id_t(state, (&(*result).FsWrite_root))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"path", tmp_str.len = sizeof("path") - 1, &tmp_str)))))
	...
	if (false) {
		 ...
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_FsWrite_base_revision(state, (&(*result).FsWrite_base_revision));
		decode_repeated_FsWrite_force(state, (&(*result).FsWrite_force));
	}
		...
		zcbor_state_t *state, struct request_fs_watch_poll *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"root", tmp_str.len = sizeof("root") - 1, &tmp_str)))))
	&& (decode_fs_root_id_t(state, (&(*result).FsWatchPoll_root))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"dir", tmp_str.len = sizeof("dir") - 1, &tmp_str)))))
	&& (zcbor_tstr_decode(state, (&(*result).FsWatchPoll_dir))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"after_seq", tmp_str.len = sizeof("after_seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).FsWatchPoll_after_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).FsWatchPoll_max))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct byte_range *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).byte_range_offset))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"len", tmp_str.len = sizeof("len") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).byte_range_len))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
...
static bool decode_repeated_FsWriteFromBlob_base_revision(
		zcbor_state_t *state, struct FsWriteFromBlob_base_revision_r *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	bool int_res;
	...
	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"base_revision", tmp_str.len = sizeof("base_revision") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((decode_fs_revision(state, (&(*result).FsWriteFromBlob_base_revision_fs_revision_m)))) && (((*result).FsWriteFromBlob_base_revision_choice = FsWriteFromBlob_base_revision_fs_revision_m_c), true))
	|| (zcbor_union_elem_code(state) && (((zcbor_nil_expect(state, NULL))) && (((*result).FsWriteFromBlob_base_revision_choice = FsWriteFromBlob_base_revision_null_m_c), true)))), zcbor_union_end_code(state), int_res))));

	log_result(state, res, __func__);
	return res;
}

static bool decode_repeated_FsWriteFromBlob_force(
		zcbor_state_t *state, struct FsWriteFromBlob_force *result)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"force", tmp_str.len = sizeof("force") - 1, &tmp_str)))))
	&& (zcbor_bool_decode(state, (&(*result).FsWriteFromBlob_force)))));
		...
		zcbor_state_t *state, struct request_fs_write_from_blob *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"root", tmp_str.len = sizeof("root") - 1, &tmp_str)))))
	&& (decode_fs_root_id_t(state, (&(*result).FsWriteFromBlob_root))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"path", tmp_str.len = sizeof("path") - 1, &tmp_str)))))
	...
	if (false) {
		 ...
		 * A compiler error here means a bug in zcbor.
		 */
		decode_repeated_FsWriteFromBlob_base_revision(state, (&(*result).FsWriteFromBlob_base_revision));
		decode_repeated_FsWriteFromBlob_force(state, (&(*result).FsWriteFromBlob_force));
	}
		...
		zcbor_state_t *state, struct agent_event_turn_started *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).TurnStarted_seq))))
		...
		zcbor_state_t *state, struct agent_event_text_delta *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).TextDelta_seq))))
		...
		zcbor_state_t *state, struct agent_event_reasoning_delta *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ReasoningDelta_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"text", tmp_str.len = sizeof("text") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct agent_event_content_delta *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ContentDelta_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct agent_event_tool_started *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ToolStarted_seq))))
		...
		zcbor_state_t *state, struct agent_event_tool_finished *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).ToolFinished_seq))))
		...
		zcbor_state_t *state, struct usage_delta *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).usage_delta_input_tokens))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"output_tokens", tmp_str.len = sizeof("output_tokens") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).usage_delta_output_tokens))))
		...
		zcbor_state_t *state, struct agent_event_usage *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Usage_seq))))
		...
		zcbor_state_t *state, struct context_status *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).context_status_used_tokens))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"max_tokens", tmp_str.len = sizeof("max_tokens") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).context_status_max_tokens_uint)))) && (((*result).context_status_max_tokens_choice = context_status_max_tokens_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).context_status_max_tokens_choice = context_status_max_tokens_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"budget_tokens", tmp_str.len = sizeof("budget_tokens") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).context_status_budget_tokens_uint)))) && (((*result).context_status_budget_tokens_choice = context_status_budget_tokens_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).context_status_budget_tokens_choice = context_status_budget_tokens_null_m_c), true))), zcbor_union_end_code(state), int_res)))
		...
		zcbor_state_t *state, struct agent_event_context *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Context_seq))))
		...
		zcbor_state_t *state, struct rate_limit_snapshot *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).rate_limit_snapshot_remaining_uint)))) && (((*result).rate_limit_snapshot_remaining_choice = rate_limit_snapshot_remaining_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).rate_limit_snapshot_remaining_choice = rate_limit_snapshot_remaining_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"limit", tmp_str.len = sizeof("limit") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).rate_limit_snapshot_limit_uint)))) && (((*result).rate_limit_snapshot_limit_choice = rate_limit_snapshot_limit_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).rate_limit_snapshot_limit_choice = rate_limit_snapshot_limit_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"reset_ms", tmp_str.len = sizeof("reset_ms") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).rate_limit_snapshot_reset_ms_uint)))) && (((*result).rate_limit_snapshot_reset_ms_choice = rate_limit_snapshot_reset_ms_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).rate_limit_snapshot_reset_ms_choice = rate_limit_snapshot_reset_ms_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct agent_event_rate_limit *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).RateLimit_seq))))
		...
		zcbor_state_t *state, struct agent_event_turn_finished *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).TurnFinished_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"summary", tmp_str.len = sizeof("summary") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct agent_event_error *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Error_seq))))
		...
		zcbor_state_t *state, struct agent_event_steered *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Steered_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Steered_request_id))))
		...
		zcbor_state_t *state, struct conv_view *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).conv_view_epoch))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"turns", tmp_str.len = sizeof("turns") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).conv_view_turns_conv_turn_view_m_count, (zcbor_decoder_t *)decode_conv_turn_view, state, (*&(*result).conv_view_turns_conv_turn_view_m), sizeof(struct conv_turn_view))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"waiting_for", tmp_str.len = sizeof("waiting_for") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).conv_view_waiting_for_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).conv_view_waiting_for_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct agent_event_snapshot *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Snapshot", tmp_str.len = sizeof("Snapshot") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Snapshot_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Snapshot_request_id))))
		...
		zcbor_state_t *state, struct agent_event_rewound *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Rewound_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Rewound_request_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"to_cursor", tmp_str.len = sizeof("to_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Rewound_to_cursor))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"epoch", tmp_str.len = sizeof("epoch") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Rewound_epoch))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct host_request_kind_choice *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).Choice_options_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).Choice_options_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct budget *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).budget_tokens_uint)))) && (((*result).budget_tokens_choice = budget_tokens_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).budget_tokens_choice = budget_tokens_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"wall_ms", tmp_str.len = sizeof("wall_ms") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).budget_wall_ms_uint)))) && (((*result).budget_wall_ms_choice = budget_wall_ms_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).budget_wall_ms_choice = budget_wall_ms_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct host_request *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).host_request_request_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct telemetry_dump *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).telemetry_dump_events))))
	...
	&& (zcbor_uint32_decode(state, (&(*result).telemetry_dump_pending_jobs))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"pending_wakes", tmp_str.len = sizeof("pending_wakes") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).telemetry_dump_pending_wakes))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"sessions", tmp_str.len = sizeof("sessions") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).telemetry_dump_sessions))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"active", tmp_str.len = sizeof("active") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).telemetry_dump_active))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct session_info_last_activity_ms_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).session_info_last_activity_ms_uint)))) && (((*result).session_info_last_activity_ms_choice = session_info_last_activity_ms_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).session_info_last_activity_ms_choice = session_info_last_activity_ms_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct fleet_report *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).fleet_report_children_unit_id_m_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).fleet_report_children_unit_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"usage", tmp_str.len = sizeof("usage") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct unit_node *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).unit_node_children_unit_id_m_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).unit_node_children_unit_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
		...
		zcbor_state_t *state, struct manage_event_view_started *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Started_seq))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct manage_event_view_progress *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Progress_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"text", tmp_str.len = sizeof("text") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct manage_event_view_finished *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Finished", tmp_str.len = sizeof("Finished") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Finished_seq))))
		...
		zcbor_state_t *state, struct manage_event_view_subagent *result)
{
	...
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Subagent_seq))))
		...
		zcbor_state_t *state, struct transcript_block_request *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Request", tmp_str.len = sizeof("Request") - 1, &tmp_str)))))
	&& (zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).Request_request_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct journal_record *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"cursor", tmp_str.len = sizeof("cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).journal_record_cursor))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"segment", tmp_str.len = sizeof("segment") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).journal_record_segment))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).journal_record_seq))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"epoch", tmp_str.len = sizeof("epoch") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).journal_record_epoch))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"trace", tmp_str.len = sizeof("trace") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).journal_record_trace))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_decode(state, (&(*result).journal_record_timestamp_ms))))
		...
		zcbor_state_t *state, struct journal_page_view *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).journal_page_view_entries_journal_record_m_count, (zcbor_decoder_t *)decode_journal_record, state, (*&(*result).journal_page_view_entries_journal_record_m), sizeof(struct journal_record))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next_cursor", tmp_str.len = sizeof("next_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).journal_page_view_next_cursor))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"head_cursor", tmp_str.len = sizeof("head_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).journal_page_view_head_cursor))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"sealed_after", tmp_str.len = sizeof("sealed_after") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).journal_page_view_sealed_after_uint)))) && (((*result).journal_page_view_sealed_after_choice = journal_page_view_sealed_after_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).journal_page_view_sealed_after_choice = journal_page_view_sealed_after_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_delivery_sessions *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"DeliverySessions", tmp_str.len = sizeof("DeliverySessions") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_delivery_sessions_DeliverySessions_session_id_m_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).response_delivery_sessions_DeliverySessions_session_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct search_hit *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).search_hit_downloads))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"likes", tmp_str.len = sizeof("likes") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).search_hit_likes))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"num_parameters", tmp_str.len = sizeof("num_parameters") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).search_hit_num_parameters_uint)))) && (((*result).search_hit_num_parameters_choice = search_hit_num_parameters_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).search_hit_num_parameters_choice = search_hit_num_parameters_null_m_c), true))), zcbor_union_end_code(state), int_res)))
		...
		zcbor_state_t *state, struct search_page *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).search_page_results_search_hit_m_count, (zcbor_decoder_t *)decode_search_hit, state, (*&(*result).search_page_results_search_hit_m), sizeof(struct search_hit))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
		...
		zcbor_state_t *state, struct model_file *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).model_file_size_bytes))))
		...
		zcbor_state_t *state, struct response_model_files *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ModelFiles", tmp_str.len = sizeof("ModelFiles") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_model_files_ModelFiles_model_file_m_count, (zcbor_decoder_t *)decode_model_file, state, (*&(*result).response_model_files_ModelFiles_model_file_m), sizeof(struct model_file))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_model_download_started *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).response_model_download_started_ModelDownloadStarted))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct download_status *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).download_status_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"model", tmp_str.len = sizeof("model") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_decode(state, (&(*result).download_status_downloaded_bytes))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"total_bytes", tmp_str.len = sizeof("total_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).download_status_total_bytes))))
		...
		zcbor_state_t *state, struct installed_model *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).installed_model_size_bytes))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"quant", tmp_str.len = sizeof("quant") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_decode(state, (&(*result).installed_model_installed_at_ms))))
		...
		zcbor_state_t *state, struct response_model_catalog *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_model_catalog_ModelCatalog_installed_model_m_count, (zcbor_decoder_t *)decode_installed_model, state, (*&(*result).response_model_catalog_ModelCatalog_installed_model_m), sizeof(struct installed_model))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct quant_candidate *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).quant_candidate_size_bytes_uint)))) && (((*result).quant_candidate_size_bytes_choice = quant_candidate_size_bytes_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).quant_candidate_size_bytes_choice = quant_candidate_size_bytes_null_m_c), true))), zcbor_union_end_code(state), int_res)))
		...
		zcbor_state_t *state, struct quant_recommendation *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).quant_recommendation_size_bytes_uint)))) && (((*result).quant_recommendation_size_bytes_choice = quant_recommendation_size_bytes_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).quant_recommendation_size_bytes_choice = quant_recommendation_size_bytes_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"budget_bytes", tmp_str.len = sizeof("budget_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).quant_recommendation_budget_bytes))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"fits", tmp_str.len = sizeof("fits") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct response_model_quantize_started *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).response_model_quantize_started_ModelQuantizeStarted))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct quantize_status *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).quantize_status_id))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"repo", tmp_str.len = sizeof("repo") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct gguf_info *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).gguf_info_parameter_count_uint)))) && (((*result).gguf_info_parameter_count_choice = gguf_info_parameter_count_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).gguf_info_parameter_count_choice = gguf_info_parameter_count_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).gguf_info_size_bytes))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct profile_info *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).profile_info_bound_accounts_bound_account_m_count, (zcbor_decoder_t *)decode_bound_account, state, (*&(*result).profile_info_bound_accounts_bound_account_m), sizeof(struct bound_account))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, void *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"Profile", tmp_str.len = sizeof("Profile") - 1, &tmp_str)))))
	&& (zcbor_any_skip(state, NULL)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct model_descriptor *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).model_descriptor_input_price_micros_per_mtok_uint)))) && (((*result).model_descriptor_input_price_micros_per_mtok_choice = model_descriptor_input_price_micros_per_mtok_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).model_descriptor_input_price_micros_per_mtok_choice = model_descriptor_input_price_micros_per_mtok_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).model_descriptor_output_price_micros_per_mtok_uint)))) && (((*result).model_descriptor_output_price_micros_per_mtok_choice = model_descriptor_output_price_micros_per_mtok_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).model_descriptor_output_price_micros_per_mtok_choice = model_descriptor_output_price_micros_per_mtok_null_m_c), true))), zcbor_union_end_code(state), int_res)))
		...
		zcbor_state_t *state, struct response_models *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_models_Models_model_descriptor_m_count, (zcbor_decoder_t *)decode_model_descriptor, state, (*&(*result).response_models_Models_model_descriptor_m), sizeof(struct model_descriptor))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct revision *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).revision_seq))))
	...
	&& (zcbor_uint32_decode(state, (&(*result).revision_ts_ms))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_revisions *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_revisions_Revisions_revision_m_count, (zcbor_decoder_t *)decode_revision, state, (*&(*result).response_revisions_Revisions_revision_m), sizeof(struct revision))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct skill_usage *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).skill_usage_use_count))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"view_count", tmp_str.len = sizeof("view_count") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).skill_usage_view_count))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"patch_count", tmp_str.len = sizeof("patch_count") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).skill_usage_patch_count))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"created_at_ms", tmp_str.len = sizeof("created_at_ms") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).skill_usage_created_at_ms))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"last_used_ms", tmp_str.len = sizeof("last_used_ms") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).skill_usage_last_used_ms_uint)))) && (((*result).skill_usage_last_used_ms_choice = skill_usage_last_used_ms_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).skill_usage_last_used_ms_choice = skill_usage_last_used_ms_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"last_viewed_ms", tmp_str.len = sizeof("last_viewed_ms") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).skill_usage_last_viewed_ms_uint)))) && (((*result).skill_usage_last_viewed_ms_choice = skill_usage_last_viewed_ms_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).skill_usage_last_viewed_ms_choice = skill_usage_last_viewed_ms_null_m_c), true))), zcbor_union_end_code(state), int_res)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"last_patched_ms", tmp_str.len = sizeof("last_patched_ms") - 1, &tmp_str)))))
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).skill_usage_last_patched_ms_uint)))) && (((*result).skill_usage_last_patched_ms_choice = skill_usage_last_patched_ms_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).skill_usage_last_patched_ms_choice = skill_usage_last_patched_ms_null_m_c), true))), zcbor_union_end_code(state), int_res)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_curator_skills *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_curator_skills_CuratorSkills_curator_entry_m_count, (zcbor_decoder_t *)decode_curator_entry, state, (*&(*result).response_curator_skills_CuratorSkills_curator_entry_m), sizeof(struct curator_entry))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_curator_run *result)
{
	...
	bool res = (((zcbor_map_start_decode(state) && (((((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"CuratorRun", tmp_str.len = sizeof("CuratorRun") - 1, &tmp_str)))))
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_curator_run_CuratorRun_curator_change_m_count, (zcbor_decoder_t *)decode_curator_change, state, (*&(*result).response_curator_run_CuratorRun_curator_change_m), sizeof(struct curator_change))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct auth_begin_response *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).auth_begin_response_expires_at))))
		...
		zcbor_state_t *state, struct checkpoint_info_turn_ordinal_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).checkpoint_info_turn_ordinal_uint)))) && (((*result).checkpoint_info_turn_ordinal_choice = checkpoint_info_turn_ordinal_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).checkpoint_info_turn_ordinal_choice = checkpoint_info_turn_ordinal_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct checkpoint_info_cursor_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).checkpoint_info_cursor_uint)))) && (((*result).checkpoint_info_cursor_choice = checkpoint_info_cursor_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).checkpoint_info_cursor_choice = checkpoint_info_cursor_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct checkpoint_info *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).checkpoint_info_created_unix))))
		...
		zcbor_state_t *state, struct response_checkpoints *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_checkpoints_Checkpoints_checkpoint_info_m_count, (zcbor_decoder_t *)decode_checkpoint_info, state, (*&(*result).response_checkpoints_Checkpoints_checkpoint_info_m), sizeof(struct checkpoint_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct session_detail_delivery_targets_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).session_detail_delivery_targets_delivery_target_m_count, (zcbor_decoder_t *)decode_delivery_target, state, (*&(*result).session_detail_delivery_targets_delivery_target_m), sizeof(struct delivery_target))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct session_detail_children_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).session_detail_children_session_id_m_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).session_detail_children_session_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct response_sessions_by_profile *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).SessionsByProfile_profile_l_count, (zcbor_decoder_t *)decode_repeated_SessionsByProfile_profile_l, state, (*&(*result).SessionsByProfile_profile_l), sizeof(struct SessionsByProfile_profile_l))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_acp_catalog *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_acp_catalog_AcpCatalog_acp_agent_entry_m_count, (zcbor_decoder_t *)decode_acp_agent_entry, state, (*&(*result).response_acp_catalog_AcpCatalog_acp_agent_entry_m), sizeof(struct acp_agent_entry))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_providers *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_providers_Providers_provider_info_m_count, (zcbor_decoder_t *)decode_provider_info, state, (*&(*result).response_providers_Providers_provider_info_m), sizeof(struct provider_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct cron_job_next_fire_unix_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).cron_job_next_fire_unix_uint)))) && (((*result).cron_job_next_fire_unix_choice = cron_job_next_fire_unix_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).cron_job_next_fire_unix_choice = cron_job_next_fire_unix_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct cron_job_last_run_unix_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).cron_job_last_run_unix_uint)))) && (((*result).cron_job_last_run_unix_choice = cron_job_last_run_unix_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).cron_job_last_run_unix_choice = cron_job_last_run_unix_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct cron_run_finished_unix_r *result)
{
	...
	&& (zcbor_union_start_code(state) && (int_res = ((((zcbor_uint32_decode(state, (&(*result).cron_run_finished_unix_uint)))) && (((*result).cron_run_finished_unix_choice = cron_run_finished_unix_uint_c), true))
	|| (((zcbor_nil_expect(state, NULL))) && (((*result).cron_run_finished_unix_choice = cron_run_finished_unix_null_m_c), true))), zcbor_union_end_code(state), int_res))));
		...
		zcbor_state_t *state, struct cron_run *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).cron_run_started_unix))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"ok", tmp_str.len = sizeof("ok") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct response_adapters *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_adapters_Adapters_adapter_info_m_count, (zcbor_decoder_t *)decode_adapter_info, state, (*&(*result).response_adapters_Adapters_adapter_info_m), sizeof(struct adapter_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_transport_instances *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_transport_instances_TransportInstances_transport_instance_info_m_count, (zcbor_decoder_t *)decode_transport_instance_info, state, (*&(*result).response_transport_instances_TransportInstances_transport_instance_info_m), sizeof(struct transport_instance_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_conversations *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_conversations_Conversations_conversation_info_m_count, (zcbor_decoder_t *)decode_conversation_info, state, (*&(*result).response_conversations_Conversations_conversation_info_m), sizeof(struct conversation_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct response_contacts *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).response_contacts_Contacts_contact_info_m_count, (zcbor_decoder_t *)decode_contact_info, state, (*&(*result).response_contacts_Contacts_contact_info_m), sizeof(struct contact_info))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		zcbor_state_t *state, struct action_menu_items_r *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).action_menu_items_tstr_count, (zcbor_decoder_t *)zcbor_tstr_decode, state, (*&(*result).action_menu_items_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
		...
		zcbor_state_t *state, struct fs_entry *result)
{
	...
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"size", tmp_str.len = sizeof("size") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).fs_entry_size))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"mtime_ms", tmp_str.len = sizeof("mtime_ms") - 1, &tmp_str)))))
	&& (zcbor_uint32_decode(state, (&(*result).fs_entry_mtime_ms))))
		...
		zcbor_state_t *state, struct fs_search_page *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).fs_search_page_hits_fs_search_hit_m_count, (zcbor_decoder_t *)decode_fs_search_hit, state, (*&(*result).fs_search_page_hits_fs_search_hit_m), sizeof(struct fs_search_hit))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
		...
		zcbor_state_t *state, struct fs_watch_page_view *result)
{
	...
	&& (zcbor_list_start_decode(state) && ((zcbor_multi_decode(0, 16, &(*result).fs_watch_page_view_events_fs_change_m_count, (zcbor_decoder_t *)decode_fs_change, state, (*&(*result).fs_watch_page_view_events_fs_change_m), sizeof(struct fs_change))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state)))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"next_seq", tmp_str.len = sizeof("next_seq") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct blob_stat *result)
{
	...
	&& (zcbor_uint32_decode(state, (&(*result).blob_stat_size))))
	&& (((zcbor_tstr_expect(state, ((tmp_str.value = (uint8_t *)"present", tmp_str.len = sizeof("present") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, struct api_response_r *result)
{
	...
	|| (zcbor_union_elem_code(state) && (((decode_response_profile(state, NULL))) && (((*result).api_response_choice = api_response_response_profile_m_c), true)))
		...
		zcbor_state_t *state, struct api_request_r *result)
{
	...
	|| (zcbor_union_elem_code(state) && (((decode_request_profile_create(state, NULL))) && (((*result).api_request_choice = api_request_request_profile_create_m_c), true)))
	|| (zcbor_union_elem_code(state) && (((decode_request_profile_update(state, NULL))) && (((*result).api_request_choice = api_request_request_profile_update_m_c), true)))
