...
static bool encode_repeated_completion_notice_ref_call_id(zcbor_state_t *state, const struct completion_notice_ref_call_id_r *input);
static bool encode_completion_notice_ref(zcbor_state_t *state, const struct completion_notice_ref *input);
static bool encode_repeated_user_msg_notice(zcbor_state_t *state, const struct user_msg_notice_r *input);
...
static bool encode_repeated_origin_sender(zcbor_state_t *state, const struct origin_sender_r *input);
...
static bool encode_repeated_Approved_reason(zcbor_state_t *state, const struct Approved_reason_r *input);
...
static bool encode_repeated_Tree_after(zcbor_state_t *state, const struct Tree_after_r *input);
static bool encode_request_tree(zcbor_state_t *state, const struct request_tree *input);
...
static bool encode_repeated_DeliverySessions_after(zcbor_state_t *state, const struct DeliverySessions_after_r *input);
...
static bool encode_repeated_ApprovalDecide_reason(zcbor_state_t *state, const struct ApprovalDecide_reason_r *input);
static bool encode_request_approval_decide(zcbor_state_t *state, const struct request_approval_decide *input);
static bool encode_request_fingerprint_list(zcbor_state_t *state, const struct request_fingerprint_list *input);
static bool encode_request_fingerprint_revoke(zcbor_state_t *state, const struct request_fingerprint_revoke *input);
...
static bool encode_engine_foreign_agent(zcbor_state_t *state, const struct engine_foreign_agent *input);
static bool encode_engine_foreign(zcbor_state_t *state, const struct engine_foreign *input);
...
static bool encode_foreign_backend_agent_native(zcbor_state_t *state, const struct foreign_backend_agent_native *input);
static bool encode_foreign_backend_node_provider(zcbor_state_t *state, const struct foreign_backend_node_provider *input);
static bool encode_foreign_backend(zcbor_state_t *state, const struct foreign_backend_r *input);
static bool encode_repeated_profile_spec_foreign_backend(zcbor_state_t *state, const struct profile_spec_foreign_backend *input);
...
static bool encode_repeated_profile_spec_created_by(zcbor_state_t *state, const struct profile_spec_created_by_r *input);
static bool encode_repeated_profile_spec_owner(zcbor_state_t *state, const struct profile_spec_owner_r *input);
...
static bool encode_repeated_skill_bundle_signature(zcbor_state_t *state, const struct skill_bundle_signature_r *input);
...
static bool encode_repeated_distribution_soul(zcbor_state_t *state, const struct distribution_soul_r *input);
...
static bool encode_repeated_ProfileHistory_after(zcbor_state_t *state, const struct ProfileHistory_after_r *input);
...
static bool encode_request_soul_get(zcbor_state_t *state, const struct request_soul_get *input);
static bool encode_request_soul_set(zcbor_state_t *state, const struct request_soul_set *input);
static bool encode_repeated_SkillHistory_after(zcbor_state_t *state, const struct SkillHistory_after_r *input);
...
static bool encode_repeated_CredentialSetLabel_label(zcbor_state_t *state, const struct CredentialSetLabel_label_r *input);
static bool encode_request_credential_set_label(zcbor_state_t *state, const struct request_credential_set_label *input);
...
static bool encode_repeated_ModelFiles_after(zcbor_state_t *state, const struct ModelFiles_after_r *input);
...
static bool encode_repeated_Models_after(zcbor_state_t *state, const struct Models_after_r *input);
static bool encode_request_models(zcbor_state_t *state, const struct request_models *input);
...
static bool encode_repeated_CheckpointList_after(zcbor_state_t *state, const struct CheckpointList_after_r *input);
...
static bool encode_request_session_recap(zcbor_state_t *state, const struct request_session_recap *input);
...
static bool encode_repeated_agent_recipe_program(zcbor_state_t *state, const struct agent_recipe_program_r *input);
static bool encode_repeated_agent_recipe_args(zcbor_state_t *state, const struct agent_recipe_args_r *input);
static bool encode_kv_pair(zcbor_state_t *state, const struct kv_pair *input);
static bool encode_repeated_agent_recipe_env(zcbor_state_t *state, const struct agent_recipe_env_r *input);
static bool encode_repeated_agent_recipe_endpoint(zcbor_state_t *state, const struct agent_recipe_endpoint_r *input);
static bool encode_agent_recipe(zcbor_state_t *state, const struct agent_recipe *input);
static bool encode_agent_source(zcbor_state_t *state, const struct agent_source_r *input);
static bool encode_agent_protocol(zcbor_state_t *state, const struct agent_protocol_r *input);
static bool encode_repeated_agent_entry_protocol(zcbor_state_t *state, const struct agent_entry_protocol *input);
static bool encode_repeated_agent_entry_installed(zcbor_state_t *state, const struct agent_entry_installed *input);
static bool encode_repeated_agent_entry_version(zcbor_state_t *state, const struct agent_entry_version_r *input);
static bool encode_repeated_agent_entry_capabilities(zcbor_state_t *state, const struct agent_entry_capabilities_r *input);
static bool encode_agent_verification(zcbor_state_t *state, const struct agent_verification_r *input);
static bool encode_repeated_agent_entry_verification(zcbor_state_t *state, const struct agent_entry_verification *input);
static bool encode_agent_entry(zcbor_state_t *state, const struct agent_entry *input);
static bool encode_request_agent_register(zcbor_state_t *state, const struct request_agent_register *input);
static bool encode_request_agent_remove(zcbor_state_t *state, const struct request_agent_remove *input);
...
static bool encode_repeated_tool_info_requires(zcbor_state_t *state, const struct tool_info_requires_r *input);
...
static bool encode_request_tool_set_enabled(zcbor_state_t *state, const struct request_tool_set_enabled *input);
...
static bool encode_repeated_GatewaySet_addr(zcbor_state_t *state, const struct GatewaySet_addr_r *input);
static bool encode_request_gateway_set(zcbor_state_t *state, const struct request_gateway_set *input);
...
static bool encode_repeated_RoutingListChats_after(zcbor_state_t *state, const struct RoutingListChats_after_r *input);
static bool encode_request_routing_list_chats(zcbor_state_t *state, const struct request_routing_list_chats *input);
...
static bool encode_repeated_TransportRooms_after(zcbor_state_t *state, const struct TransportRooms_after_r *input);
static bool encode_request_transport_rooms(zcbor_state_t *state, const struct request_transport_rooms *input);
static bool encode_request_transport_disconnect(zcbor_state_t *state, const struct request_transport_disconnect *input);
static bool encode_request_transport_remove(zcbor_state_t *state, const struct request_transport_remove *input);
static bool encode_request_transport_connect(zcbor_state_t *state, const struct request_transport_connect *input);
static bool encode_request_transport_set_enabled(zcbor_state_t *state, const struct request_transport_set_enabled *input);
static bool encode_repeated_TransportSetLabel_label(zcbor_state_t *state, const struct TransportSetLabel_label_r *input);
static bool encode_request_transport_set_label(zcbor_state_t *state, const struct request_transport_set_label *input);
static bool encode_repeated_ConvList_after(zcbor_state_t *state, const struct ConvList_after_r *input);
...
static bool encode_auth_field_kind(zcbor_state_t *state, const struct auth_field_kind_r *input);
static bool encode_repeated_auth_param_field_kind(zcbor_state_t *state, const struct auth_param_field_kind *input);
static bool encode_repeated_auth_param_field_default(zcbor_state_t *state, const struct auth_param_field_default_r *input);
static bool encode_repeated_auth_param_field_placeholder(zcbor_state_t *state, const struct auth_param_field_placeholder_r *input);
static bool encode_repeated_auth_param_field_choices(zcbor_state_t *state, const struct auth_param_field_choices_r *input);
...
static bool encode_repeated_FsList_after(zcbor_state_t *state, const struct FsList_after_r *input);
...
static bool encode_feedback_kind(zcbor_state_t *state, const struct feedback_kind_r *input);
static bool encode_repeated_feedback_target_trace(zcbor_state_t *state, const struct feedback_target_trace_r *input);
static bool encode_feedback_target(zcbor_state_t *state, const struct feedback_target *input);
static bool encode_repeated_FeedbackSubmit_target(zcbor_state_t *state, const struct FeedbackSubmit_target_r *input);
static bool encode_feedback_rating(zcbor_state_t *state, const struct feedback_rating_r *input);
static bool encode_repeated_FeedbackSubmit_rating(zcbor_state_t *state, const struct FeedbackSubmit_rating_r *input);
static bool encode_repeated_FeedbackSubmit_comment(zcbor_state_t *state, const struct FeedbackSubmit_comment_r *input);
static bool encode_repeated_feedback_diagnostics_app_version(zcbor_state_t *state, const struct feedback_diagnostics_app_version_r *input);
static bool encode_repeated_feedback_diagnostics_os(zcbor_state_t *state, const struct feedback_diagnostics_os_r *input);
static bool encode_feedback_diagnostics(zcbor_state_t *state, const struct feedback_diagnostics *input);
...
static bool encode_request_transport_settings(zcbor_state_t *state, const struct request_transport_settings *input);
static bool encode_request_transport_configure(zcbor_state_t *state, const struct request_transport_configure *input);
...
static bool encode_foreign_stage(zcbor_state_t *state, const struct foreign_stage_r *input);
static bool encode_repeated_foreign_failure_agent(zcbor_state_t *state, const struct foreign_failure_agent_r *input);
static bool encode_foreign_failure(zcbor_state_t *state, const struct foreign_failure *input);
static bool encode_repeated_turn_summary_failure(zcbor_state_t *state, const struct turn_summary_failure_r *input);
...
static bool encode_repeated_approval_info_fingerprint(zcbor_state_t *state, const struct approval_info_fingerprint_r *input);
static bool encode_repeated_approval_info_detail(zcbor_state_t *state, const struct approval_info_detail_r *input);
static bool encode_approval_info(zcbor_state_t *state, const struct approval_info *input);
static bool encode_repeated_approval_page_next(zcbor_state_t *state, const struct approval_page_next_r *input);
static bool encode_approval_page(zcbor_state_t *state, const struct approval_page *input);
static bool encode_response_approvals(zcbor_state_t *state, const struct response_approvals *input);
static bool encode_repeated_remembered_fingerprint_label(zcbor_state_t *state, const struct remembered_fingerprint_label_r *input);
static bool encode_repeated_remembered_fingerprint_remembered_at_ms(zcbor_state_t *state, const struct remembered_fingerprint_remembered_at_ms *input);
static bool encode_remembered_fingerprint(zcbor_state_t *state, const struct remembered_fingerprint *input);
static bool encode_response_fingerprints(zcbor_state_t *state, const struct response_fingerprints *input);
...
static bool encode_delegation_lifetime(zcbor_state_t *state, const struct delegation_lifetime_r *input);
static bool encode_repeated_unit_node_lifetime(zcbor_state_t *state, const struct unit_node_lifetime_r *input);
static bool encode_repeated_unit_node_engine(zcbor_state_t *state, const struct unit_node_engine_r *input);
static bool encode_unit_node(zcbor_state_t *state, const struct unit_node *input);
static bool encode_repeated_tree_report_next(zcbor_state_t *state, const struct tree_report_next_r *input);
...
static bool encode_node_event_profiles_changed(zcbor_state_t *state, const struct node_event_profiles_changed *input);
...
static bool encode_repeated_TransportChanged_presence(zcbor_state_t *state, const struct TransportChanged_presence *input);
static bool encode_disconnect_reason(zcbor_state_t *state, const struct disconnect_reason_r *input);
static bool encode_repeated_TransportChanged_reason(zcbor_state_t *state, const struct TransportChanged_reason_r *input);
static bool encode_repeated_TransportChanged_message(zcbor_state_t *state, const struct TransportChanged_message_r *input);
static bool encode_repeated_TransportChanged_fatal(zcbor_state_t *state, const struct TransportChanged_fatal *input);
static bool encode_node_event_transport_changed(zcbor_state_t *state, const struct node_event_transport_changed *input);
static bool encode_conv_change(zcbor_state_t *state, const struct conv_change_r *input);
static bool encode_node_event_conversations_changed(zcbor_state_t *state, const struct node_event_conversations_changed *input);
static bool encode_membership_change(zcbor_state_t *state, const struct membership_change_r *input);
...
static bool encode_node_event_messages_changed(zcbor_state_t *state, const struct node_event_messages_changed *input);
...
static bool encode_repeated_delivery_session_page_next(zcbor_state_t *state, const struct delivery_session_page_next_r *input);
static bool encode_delivery_session_page(zcbor_state_t *state, const struct delivery_session_page *input);
...
static bool encode_repeated_model_file_page_next(zcbor_state_t *state, const struct model_file_page_next_r *input);
static bool encode_model_file_page(zcbor_state_t *state, const struct model_file_page *input);
...
static bool encode_repeated_installed_model_mmproj_path(zcbor_state_t *state, const struct installed_model_mmproj_path_r *input);
static bool encode_repeated_installed_model_sha256(zcbor_state_t *state, const struct installed_model_sha256_r *input);
...
static bool encode_repeated_profile_info_created_by(zcbor_state_t *state, const struct profile_info_created_by_r *input);
static bool encode_repeated_profile_info_owner(zcbor_state_t *state, const struct profile_info_owner_r *input);
...
static bool encode_response_soul_text(zcbor_state_t *state, const struct response_soul_text *input);
static bool encode_repeated_credential_info_label(zcbor_state_t *state, const struct credential_info_label_r *input);
...
static bool encode_repeated_model_page_next(zcbor_state_t *state, const struct model_page_next_r *input);
static bool encode_model_page(zcbor_state_t *state, const struct model_page *input);
...
static bool encode_provider_sign_in(zcbor_state_t *state, const struct provider_sign_in *input);
static bool encode_repeated_provider_descriptor_sign_in(zcbor_state_t *state, const struct provider_descriptor_sign_in_r *input);
...
static bool encode_repeated_revision_page_next(zcbor_state_t *state, const struct revision_page_next_r *input);
static bool encode_revision_page(zcbor_state_t *state, const struct revision_page *input);
...
static bool encode_repeated_checkpoint_page_next(zcbor_state_t *state, const struct checkpoint_page_next_r *input);
static bool encode_checkpoint_page(zcbor_state_t *state, const struct checkpoint_page *input);
...
static bool encode_repeated_session_detail_engine(zcbor_state_t *state, const struct session_detail_engine *input);
static bool encode_repeated_session_detail_foreign_backend(zcbor_state_t *state, const struct session_detail_foreign_backend *input);
static bool encode_model_choice(zcbor_state_t *state, const struct model_choice *input);
static bool encode_model_selector(zcbor_state_t *state, const struct model_selector *input);
static bool encode_repeated_session_detail_model_selector(zcbor_state_t *state, const struct session_detail_model_selector_r *input);
...
static bool encode_repeated_top_tools_name_l(zcbor_state_t *state, const struct top_tools_name_l *input);
static bool encode_session_recap(zcbor_state_t *state, const struct session_recap *input);
static bool encode_response_session_recap(zcbor_state_t *state, const struct response_session_recap *input);
static bool encode_response_agent_catalog(zcbor_state_t *state, const struct response_agent_catalog *input);
...
static bool encode_gateway_status(zcbor_state_t *state, const struct gateway_status *input);
static bool encode_response_gateway_status(zcbor_state_t *state, const struct response_gateway_status *input);
static bool encode_repeated_caps_report_max_composed_profiles(zcbor_state_t *state, const struct caps_report_max_composed_profiles *input);
static bool encode_repeated_caps_report_max_ephemeral_per_session(zcbor_state_t *state, const struct caps_report_max_ephemeral_per_session *input);
static bool encode_caps_report(zcbor_state_t *state, const struct caps_report *input);
static bool encode_response_caps(zcbor_state_t *state, const struct response_caps *input);
...
static bool encode_repeated_chat_route_page_next(zcbor_state_t *state, const struct chat_route_page_next_r *input);
static bool encode_chat_route_page(zcbor_state_t *state, const struct chat_route_page *input);
...
static bool encode_repeated_room_page_next(zcbor_state_t *state, const struct room_page_next_r *input);
static bool encode_room_page(zcbor_state_t *state, const struct room_page *input);
...
static bool encode_policy_entry(zcbor_state_t *state, const struct policy_entry *input);
static bool encode_repeated_adapter_info_policies(zcbor_state_t *state, const struct adapter_info_policies_r *input);
static bool encode_conversation_ops(zcbor_state_t *state, const struct conversation_ops *input);
static bool encode_repeated_adapter_info_conversation_ops(zcbor_state_t *state, const struct adapter_info_conversation_ops_r *input);
static bool encode_membership_ops(zcbor_state_t *state, const struct membership_ops *input);
static bool encode_repeated_adapter_info_membership_ops(zcbor_state_t *state, const struct adapter_info_membership_ops_r *input);
static bool encode_contacts_ops(zcbor_state_t *state, const struct contacts_ops *input);
static bool encode_repeated_adapter_info_contacts_ops(zcbor_state_t *state, const struct adapter_info_contacts_ops_r *input);
static bool encode_roster_ops(zcbor_state_t *state, const struct roster_ops *input);
static bool encode_repeated_adapter_info_roster_ops(zcbor_state_t *state, const struct adapter_info_roster_ops_r *input);
static bool encode_repeated_adapter_info_directory(zcbor_state_t *state, const struct adapter_info_directory *input);
...
static bool encode_repeated_transport_instance_info_reason(zcbor_state_t *state, const struct transport_instance_info_reason_r *input);
static bool encode_repeated_transport_instance_info_message(zcbor_state_t *state, const struct transport_instance_info_message_r *input);
static bool encode_repeated_transport_instance_info_fatal(zcbor_state_t *state, const struct transport_instance_info_fatal *input);
static bool encode_repeated_transport_instance_info_enabled(zcbor_state_t *state, const struct transport_instance_info_enabled *input);
static bool encode_repeated_transport_instance_info_label(zcbor_state_t *state, const struct transport_instance_info_label_r *input);
...
static bool encode_repeated_conversation_info_parent(zcbor_state_t *state, const struct conversation_info_parent_r *input);
static bool encode_conversation_info(zcbor_state_t *state, const struct conversation_info *input);
static bool encode_repeated_conv_page_next(zcbor_state_t *state, const struct conv_page_next_r *input);
static bool encode_conv_page(zcbor_state_t *state, const struct conv_page *input);
...
static bool encode_repeated_fs_list_page_next(zcbor_state_t *state, const struct fs_list_page_next_r *input);
static bool encode_fs_list_page(zcbor_state_t *state, const struct fs_list_page *input);
...
static bool encode_response_transport_settings(zcbor_state_t *state, const struct response_transport_settings *input);
...
static bool encode_repeated_completion_notice_ref_call_id(
		zcbor_state_t *state, const struct completion_notice_ref_call_id_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"call_id", tmp_str.len = sizeof("call_id") - 1, &tmp_str)))))
	&& (((*input).completion_notice_ref_call_id_choice == completion_notice_ref_call_id_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).completion_notice_ref_call_id_tstr))))
	: (((*input).completion_notice_ref_call_id_choice == completion_notice_ref_call_id_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_completion_notice_ref(
		zcbor_state_t *state, const struct completion_notice_ref *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"child", tmp_str.len = sizeof("child") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).completion_notice_ref_child))))
	&& (!(*input).completion_notice_ref_call_id_present || encode_repeated_completion_notice_ref_call_id(state, (&(*input).completion_notice_ref_call_id)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_user_msg_notice(
		zcbor_state_t *state, const struct user_msg_notice_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"notice", tmp_str.len = sizeof("notice") - 1, &tmp_str)))))
	&& (((*input).user_msg_notice_choice == user_msg_notice_completion_notice_ref_m_c) ? ((encode_completion_notice_ref(state, (&(*input).user_msg_notice_completion_notice_ref_m))))
	: (((*input).user_msg_notice_choice == user_msg_notice_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct user_msg *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"text", tmp_str.len = sizeof("text") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).user_msg_text))))
	&& (!(*input).user_msg_attachments_present || encode_repeated_user_msg_attachments(state, (&(*input).user_msg_attachments)))
	&& (!(*input).user_msg_notice_present || encode_repeated_user_msg_notice(state, (&(*input).user_msg_notice)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));
...
static bool encode_repeated_origin_sender(
		zcbor_state_t *state, const struct origin_sender_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"sender", tmp_str.len = sizeof("sender") - 1, &tmp_str)))))
	&& (((*input).origin_sender_choice == origin_sender_sender_id_m_c) ? ((zcbor_tstr_encode(state, (&(*input).origin_sender_sender_id_m))))
	: (((*input).origin_sender_choice == origin_sender_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct origin *input)
{
	...
	&& (encode_origin_scope_t(state, (&(*input).origin_scope))))
	&& (!(*input).origin_sender_present || encode_repeated_origin_sender(state, (&(*input).origin_sender)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));
...
static bool encode_repeated_Approved_reason(
		zcbor_state_t *state, const struct Approved_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (((*input).Approved_reason_choice == Approved_reason_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).Approved_reason_tstr))))
	: (((*input).Approved_reason_choice == Approved_reason_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct host_response_body_approved *input)
{
	...
	&& (zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"approved", tmp_str.len = sizeof("approved") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).Approved_approved))))
	&& (!(*input).Approved_allow_permanent_present || encode_repeated_Approved_allow_permanent(state, (&(*input).Approved_allow_permanent)))
	&& (!(*input).Approved_reason_present || encode_repeated_Approved_reason(state, (&(*input).Approved_reason)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_Tree_after(
		zcbor_state_t *state, const struct Tree_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).Tree_after_choice == Tree_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).Tree_after_tstr))))
	: (((*input).Tree_after_choice == Tree_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_request_tree(
		zcbor_state_t *state, const struct request_tree *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_map_start_encode(state, 1) && (((!(*input).Tree_after_present || encode_repeated_Tree_after(state, (&(*input).Tree_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_DeliverySessions_after(
		zcbor_state_t *state, const struct DeliverySessions_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).DeliverySessions_after_choice == DeliverySessions_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).DeliverySessions_after_tstr))))
	: (((*input).DeliverySessions_after_choice == DeliverySessions_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_delivery_sessions *input)
{
	...
	&& (zcbor_tstr_encode(state, (&(*input).DeliverySessions_transport))))
	&& (!(*input).DeliverySessions_after_present || encode_repeated_DeliverySessions_after(state, (&(*input).DeliverySessions_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_ApprovalsPending_after(
		zcbor_state_t *state, const struct ApprovalsPending_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).ApprovalsPending_after_choice == ApprovalsPending_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ApprovalsPending_after_tstr))))
	: (((*input).ApprovalsPending_after_choice == ApprovalsPending_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_approvals_pending *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((!(*input).ApprovalsPending_session_present || encode_repeated_ApprovalsPending_session(state, (&(*input).ApprovalsPending_session)))
	&& (!(*input).ApprovalsPending_after_present || encode_repeated_ApprovalsPending_after(state, (&(*input).ApprovalsPending_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_ApprovalDecide_reason(
		zcbor_state_t *state, const struct ApprovalDecide_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (((*input).ApprovalDecide_reason_choice == ApprovalDecide_reason_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ApprovalDecide_reason_tstr))))
	: (((*input).ApprovalDecide_reason_choice == ApprovalDecide_reason_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_approval_decide *input)
{
	...
	&& (zcbor_map_start_encode(state, 5) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	...
	&& (!(*input).ApprovalDecide_allow_permanent_present || encode_repeated_ApprovalDecide_allow_permanent(state, (&(*input).ApprovalDecide_allow_permanent)))
	&& (!(*input).ApprovalDecide_reason_present || encode_repeated_ApprovalDecide_reason(state, (&(*input).ApprovalDecide_reason)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 5)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_fingerprint_list(
		zcbor_state_t *state, const struct request_fingerprint_list *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"FingerprintList", tmp_str.len = sizeof("FingerprintList") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).FingerprintList_session))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_fingerprint_revoke(
		zcbor_state_t *state, const struct request_fingerprint_revoke *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"FingerprintRevoke", tmp_str.len = sizeof("FingerprintRevoke") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).FingerprintRevoke_session))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"fingerprint", tmp_str.len = sizeof("fingerprint") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).FingerprintRevoke_fingerprint))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_engine_foreign_agent(
		zcbor_state_t *state, const struct engine_foreign_agent *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_tstr_encode(state, (&(*input).engine_foreign_agent_agent))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_engine_foreign(
		zcbor_state_t *state, const struct engine_foreign *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Foreign", tmp_str.len = sizeof("Foreign") - 1, &tmp_str)))))
	&& (encode_engine_foreign_agent(state, (&(*input).engine_foreign_Foreign))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct engine_selector_r *input)
{
	...
	: (((*input).engine_selector_choice == engine_selector_engine_foreign_m_c) ? ((encode_engine_foreign(state, (&(*input).engine_selector_engine_foreign_m))))
	: false))));
...
static bool encode_foreign_backend_agent_native(
		zcbor_state_t *state, const struct foreign_backend_agent_native *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"AgentNative", tmp_str.len = sizeof("AgentNative") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"model", tmp_str.len = sizeof("model") - 1, &tmp_str)))))
	&& (((*input).AgentNative_model_choice == AgentNative_model_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).AgentNative_model_tstr))))
	: (((*input).AgentNative_model_choice == AgentNative_model_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_foreign_backend_node_provider(
		zcbor_state_t *state, const struct foreign_backend_node_provider *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"NodeProvider", tmp_str.len = sizeof("NodeProvider") - 1, &tmp_str)))))
	...
	&& (encode_provider_selector(state, (&(*input).NodeProvider_provider))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"model", tmp_str.len = sizeof("model") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).NodeProvider_model))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"credential_ref", tmp_str.len = sizeof("credential_ref") - 1, &tmp_str)))))
	&& (((*input).NodeProvider_credential_ref_choice == NodeProvider_credential_ref_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).NodeProvider_credential_ref_tstr))))
	: (((*input).NodeProvider_credential_ref_choice == NodeProvider_credential_ref_null_m_c) ? ((zcbor_nil_put(state, NULL)))
...
static bool encode_foreign_backend(
		zcbor_state_t *state, const struct foreign_backend_r *input)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((((*input).foreign_backend_choice == foreign_backend_agent_native_m_c) ? ((encode_foreign_backend_agent_native(state, (&(*input).foreign_backend_agent_native_m))))
	: (((*input).foreign_backend_choice == foreign_backend_node_provider_m_c) ? ((encode_foreign_backend_node_provider(state, (&(*input).foreign_backend_node_provider_m))))
	: false))));
...
static bool encode_repeated_profile_spec_foreign_backend(
		zcbor_state_t *state, const struct profile_spec_foreign_backend *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"foreign_backend", tmp_str.len = sizeof("foreign_backend") - 1, &tmp_str)))))
	&& (encode_foreign_backend(state, (&(*input).profile_spec_foreign_backend)))));
...
static bool encode_repeated_profile_spec_created_by(
		zcbor_state_t *state, const struct profile_spec_created_by_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"created_by", tmp_str.len = sizeof("created_by") - 1, &tmp_str)))))
	&& (((*input).profile_spec_created_by_choice == profile_spec_created_by_author_m_c) ? ((encode_author(state, (&(*input).profile_spec_created_by_author_m))))
	: (((*input).profile_spec_created_by_choice == profile_spec_created_by_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_profile_spec_owner(
		zcbor_state_t *state, const struct profile_spec_owner_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"owner", tmp_str.len = sizeof("owner") - 1, &tmp_str)))))
	&& (((*input).profile_spec_owner_choice == profile_spec_owner_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).profile_spec_owner_tstr))))
	: (((*input).profile_spec_owner_choice == profile_spec_owner_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct profile_spec *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 16) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	...
	&& (!(*input).profile_spec_engine_present || encode_repeated_profile_spec_engine(state, (&(*input).profile_spec_engine)))
	&& (!(*input).profile_spec_foreign_backend_present || encode_repeated_profile_spec_foreign_backend(state, (&(*input).profile_spec_foreign_backend)))
	&& (!(*input).profile_spec_created_by_present || encode_repeated_profile_spec_created_by(state, (&(*input).profile_spec_created_by)))
	&& (!(*input).profile_spec_owner_present || encode_repeated_profile_spec_owner(state, (&(*input).profile_spec_owner)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 16))));
...
static bool encode_repeated_skill_bundle_signature(
		zcbor_state_t *state, const struct skill_bundle_signature_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"signature", tmp_str.len = sizeof("signature") - 1, &tmp_str)))))
	&& (((*input).skill_bundle_signature_choice == skill_bundle_signature_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).skill_bundle_signature_tstr))))
	: (((*input).skill_bundle_signature_choice == skill_bundle_signature_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct skill_bundle *input)
{
	...
	&& (zcbor_map_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).files_tstrtstr_count, (zcbor_encoder_t *)encode_repeated_files_tstrtstr, state, (*&(*input).files_tstrtstr), sizeof(struct files_tstrtstr))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 64)))
	&& (!(*input).skill_bundle_signature_present || encode_repeated_skill_bundle_signature(state, (&(*input).skill_bundle_signature)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));
...
static bool encode_repeated_distribution_soul(
		zcbor_state_t *state, const struct distribution_soul_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"soul", tmp_str.len = sizeof("soul") - 1, &tmp_str)))))
	&& (((*input).distribution_soul_choice == distribution_soul_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).distribution_soul_tstr))))
	: (((*input).distribution_soul_choice == distribution_soul_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct distribution *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 6) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"wire_version", tmp_str.len = sizeof("wire_version") - 1, &tmp_str)))))
	...
	&& (!(*input).distribution_source_present || encode_repeated_distribution_source(state, (&(*input).distribution_source)))
	&& (!(*input).distribution_soul_present || encode_repeated_distribution_soul(state, (&(*input).distribution_soul)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 6))));
...
static bool encode_repeated_ProfileHistory_after(
		zcbor_state_t *state, const struct ProfileHistory_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).ProfileHistory_after_choice == ProfileHistory_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ProfileHistory_after_tstr))))
	: (((*input).ProfileHistory_after_choice == ProfileHistory_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_profile_history *input)
{
	...
	&& (zcbor_tstr_encode(state, (&(*input).ProfileHistory_id))))
	&& (!(*input).ProfileHistory_after_present || encode_repeated_ProfileHistory_after(state, (&(*input).ProfileHistory_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_request_soul_get(
		zcbor_state_t *state, const struct request_soul_get *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"SoulGet", tmp_str.len = sizeof("SoulGet") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).SoulGet_id))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_soul_set(
		zcbor_state_t *state, const struct request_soul_set *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"SoulSet", tmp_str.len = sizeof("SoulSet") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).SoulSet_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"text", tmp_str.len = sizeof("text") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).SoulSet_text))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_SkillHistory_after(
		zcbor_state_t *state, const struct SkillHistory_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).SkillHistory_after_choice == SkillHistory_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).SkillHistory_after_tstr))))
	: (((*input).SkillHistory_after_choice == SkillHistory_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_skill_history *input)
{
	...
	&& (zcbor_tstr_encode(state, (&(*input).SkillHistory_name))))
	&& (!(*input).SkillHistory_after_present || encode_repeated_SkillHistory_after(state, (&(*input).SkillHistory_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_CredentialSetLabel_label(
		zcbor_state_t *state, const struct CredentialSetLabel_label_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (((*input).CredentialSetLabel_label_choice == CredentialSetLabel_label_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).CredentialSetLabel_label_tstr))))
	: (((*input).CredentialSetLabel_label_choice == CredentialSetLabel_label_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_request_credential_set_label(
		zcbor_state_t *state, const struct request_credential_set_label *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"CredentialSetLabel", tmp_str.len = sizeof("CredentialSetLabel") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"profile", tmp_str.len = sizeof("profile") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).CredentialSetLabel_profile))))
	&& (!(*input).CredentialSetLabel_label_present || encode_repeated_CredentialSetLabel_label(state, (&(*input).CredentialSetLabel_label)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_ModelFiles_after(
		zcbor_state_t *state, const struct ModelFiles_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).ModelFiles_after_choice == ModelFiles_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ModelFiles_after_tstr))))
	: (((*input).ModelFiles_after_choice == ModelFiles_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_model_files *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"repo", tmp_str.len = sizeof("repo") - 1, &tmp_str)))))
	...
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (encode_model_engine(state, (&(*input).ModelFiles_engine))))
	&& (!(*input).ModelFiles_after_present || encode_repeated_ModelFiles_after(state, (&(*input).ModelFiles_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_Models_after(
		zcbor_state_t *state, const struct Models_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).Models_after_choice == Models_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).Models_after_tstr))))
	: (((*input).Models_after_choice == Models_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_request_models(
		zcbor_state_t *state, const struct request_models *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_map_start_encode(state, 1) && (((!(*input).Models_after_present || encode_repeated_Models_after(state, (&(*input).Models_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_ProviderModels_after(
		zcbor_state_t *state, const struct ProviderModels_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).ProviderModels_after_choice == ProviderModels_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ProviderModels_after_tstr))))
	: (((*input).ProviderModels_after_choice == ProviderModels_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_provider_models *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"provider", tmp_str.len = sizeof("provider") - 1, &tmp_str)))))
...
static bool encode_repeated_CheckpointList_after(
		zcbor_state_t *state, const struct CheckpointList_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).CheckpointList_after_choice == CheckpointList_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).CheckpointList_after_tstr))))
	: (((*input).CheckpointList_after_choice == CheckpointList_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_checkpoint_list *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((!(*input).CheckpointList_session_present || encode_repeated_CheckpointList_session(state, (&(*input).CheckpointList_session)))
	&& (!(*input).CheckpointList_after_present || encode_repeated_CheckpointList_after(state, (&(*input).CheckpointList_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_request_session_recap(
		zcbor_state_t *state, const struct request_session_recap *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"SessionRecap", tmp_str.len = sizeof("SessionRecap") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).SessionRecap_session))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_agent_recipe_program(
		zcbor_state_t *state, const struct agent_recipe_program_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"program", tmp_str.len = sizeof("program") - 1, &tmp_str)))))
	&& (((*input).agent_recipe_program_choice == agent_recipe_program_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).agent_recipe_program_tstr))))
	: (((*input).agent_recipe_program_choice == agent_recipe_program_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_agent_recipe_args(
		zcbor_state_t *state, const struct agent_recipe_args_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"args", tmp_str.len = sizeof("args") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).agent_recipe_args_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).agent_recipe_args_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64))));
...
static bool encode_repeated_agent_recipe_env(
		zcbor_state_t *state, const struct agent_recipe_env_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"env", tmp_str.len = sizeof("env") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).agent_recipe_env_kv_pair_m_count, (zcbor_encoder_t *)encode_kv_pair, state, (*&(*input).agent_recipe_env_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_agent_recipe_endpoint(
		zcbor_state_t *state, const struct agent_recipe_endpoint_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"endpoint", tmp_str.len = sizeof("endpoint") - 1, &tmp_str)))))
	&& (((*input).agent_recipe_endpoint_choice == agent_recipe_endpoint_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).agent_recipe_endpoint_tstr))))
	: (((*input).agent_recipe_endpoint_choice == agent_recipe_endpoint_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_agent_recipe(
		zcbor_state_t *state, const struct agent_recipe *input)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_map_start_encode(state, 4) && (((!(*input).agent_recipe_program_present || encode_repeated_agent_recipe_program(state, (&(*input).agent_recipe_program)))
	&& (!(*input).agent_recipe_args_present || encode_repeated_agent_recipe_args(state, (&(*input).agent_recipe_args)))
	&& (!(*input).agent_recipe_env_present || encode_repeated_agent_recipe_env(state, (&(*input).agent_recipe_env)))
	&& (!(*input).agent_recipe_endpoint_present || encode_repeated_agent_recipe_endpoint(state, (&(*input).agent_recipe_endpoint)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_agent_source(
		zcbor_state_t *state, const struct agent_source_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).agent_source_choice == agent_source_Builtin_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Builtin", tmp_str.len = sizeof("Builtin") - 1, &tmp_str)))))
	: (((*input).agent_source_choice == agent_source_Manual_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Manual", tmp_str.len = sizeof("Manual") - 1, &tmp_str)))))
	: (((*input).agent_source_choice == agent_source_Endpoint_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Endpoint", tmp_str.len = sizeof("Endpoint") - 1, &tmp_str)))))
	: false)))));
...
static bool encode_agent_protocol(
		zcbor_state_t *state, const struct agent_protocol_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).agent_protocol_choice == agent_protocol_Acp_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Acp", tmp_str.len = sizeof("Acp") - 1, &tmp_str)))))
	: (((*input).agent_protocol_choice == agent_protocol_StreamJson_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"StreamJson", tmp_str.len = sizeof("StreamJson") - 1, &tmp_str)))))
	: false))));
...
static bool encode_repeated_agent_entry_protocol(
		zcbor_state_t *state, const struct agent_entry_protocol *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"protocol", tmp_str.len = sizeof("protocol") - 1, &tmp_str)))))
	&& (encode_agent_protocol(state, (&(*input).agent_entry_protocol)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_agent_entry_installed(
		zcbor_state_t *state, const struct agent_entry_installed *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"installed", tmp_str.len = sizeof("installed") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).agent_entry_installed)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_agent_entry_version(
		zcbor_state_t *state, const struct agent_entry_version_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"version", tmp_str.len = sizeof("version") - 1, &tmp_str)))))
	&& (((*input).agent_entry_version_choice == agent_entry_version_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).agent_entry_version_tstr))))
	: (((*input).agent_entry_version_choice == agent_entry_version_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_agent_entry_capabilities(
		zcbor_state_t *state, const struct agent_entry_capabilities_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"capabilities", tmp_str.len = sizeof("capabilities") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).agent_entry_capabilities_kv_pair_m_count, (zcbor_encoder_t *)encode_kv_pair, state, (*&(*input).agent_entry_capabilities_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_agent_verification(
		zcbor_state_t *state, const struct agent_verification_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).agent_verification_choice == agent_verification_Verified_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Verified", tmp_str.len = sizeof("Verified") - 1, &tmp_str)))))
	: (((*input).agent_verification_choice == agent_verification_Unverified_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Unverified", tmp_str.len = sizeof("Unverified") - 1, &tmp_str)))))
	: (((*input).agent_verification_choice == agent_verification_NotInstalled_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"NotInstalled", tmp_str.len = sizeof("NotInstalled") - 1, &tmp_str)))))
	: false)))));
...
static bool encode_repeated_agent_entry_verification(
		zcbor_state_t *state, const struct agent_entry_verification *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"verification", tmp_str.len = sizeof("verification") - 1, &tmp_str)))))
	&& (encode_agent_verification(state, (&(*input).agent_entry_verification)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_agent_entry(
		zcbor_state_t *state, const struct agent_entry *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 8) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"name", tmp_str.len = sizeof("name") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).agent_entry_name))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"recipe", tmp_str.len = sizeof("recipe") - 1, &tmp_str)))))
	&& (encode_agent_recipe(state, (&(*input).agent_entry_recipe))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"source", tmp_str.len = sizeof("source") - 1, &tmp_str)))))
	&& (encode_agent_source(state, (&(*input).agent_entry_source))))
	&& (!(*input).agent_entry_protocol_present || encode_repeated_agent_entry_protocol(state, (&(*input).agent_entry_protocol)))
	&& (!(*input).agent_entry_installed_present || encode_repeated_agent_entry_installed(state, (&(*input).agent_entry_installed)))
	&& (!(*input).agent_entry_version_present || encode_repeated_agent_entry_version(state, (&(*input).agent_entry_version)))
	&& (!(*input).agent_entry_capabilities_present || encode_repeated_agent_entry_capabilities(state, (&(*input).agent_entry_capabilities)))
	&& (!(*input).agent_entry_verification_present || encode_repeated_agent_entry_verification(state, (&(*input).agent_entry_verification)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 8))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_agent_register(
		zcbor_state_t *state, const struct request_agent_register *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"AgentRegister", tmp_str.len = sizeof("AgentRegister") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"entry", tmp_str.len = sizeof("entry") - 1, &tmp_str)))))
	&& (encode_agent_entry(state, (&(*input).AgentRegister_entry))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_agent_remove(
		zcbor_state_t *state, const struct request_agent_remove *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"AgentRemove", tmp_str.len = sizeof("AgentRemove") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"name", tmp_str.len = sizeof("name") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).AgentRemove_name))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_tool_info_requires(
		zcbor_state_t *state, const struct tool_info_requires_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"requires", tmp_str.len = sizeof("requires") - 1, &tmp_str)))))
	&& (((*input).tool_info_requires_choice == tool_info_requires_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).tool_info_requires_tstr))))
	: (((*input).tool_info_requires_choice == tool_info_requires_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct tool_info *input)
{
	...
	&& (!(*input).tool_info_description_present || encode_repeated_tool_info_description(state, (&(*input).tool_info_description)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).tool_info_enabled))))
	&& (!(*input).tool_info_requires_present || encode_repeated_tool_info_requires(state, (&(*input).tool_info_requires)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));
...
static bool encode_request_tool_set_enabled(
		zcbor_state_t *state, const struct request_tool_set_enabled *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ToolSetEnabled", tmp_str.len = sizeof("ToolSetEnabled") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"tool", tmp_str.len = sizeof("tool") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ToolSetEnabled_tool))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).ToolSetEnabled_enabled))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_GatewaySet_addr(
		zcbor_state_t *state, const struct GatewaySet_addr_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"addr", tmp_str.len = sizeof("addr") - 1, &tmp_str)))))
	&& (((*input).GatewaySet_addr_choice == GatewaySet_addr_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).GatewaySet_addr_tstr))))
	: (((*input).GatewaySet_addr_choice == GatewaySet_addr_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_request_gateway_set(
		zcbor_state_t *state, const struct request_gateway_set *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"GatewaySet", tmp_str.len = sizeof("GatewaySet") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).GatewaySet_enabled))))
	&& (!(*input).GatewaySet_addr_present || encode_repeated_GatewaySet_addr(state, (&(*input).GatewaySet_addr)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_RoutingListChats_after(
		zcbor_state_t *state, const struct RoutingListChats_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).RoutingListChats_after_choice == RoutingListChats_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).RoutingListChats_after_tstr))))
	: (((*input).RoutingListChats_after_choice == RoutingListChats_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_request_routing_list_chats(
		zcbor_state_t *state, const struct request_routing_list_chats *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"RoutingListChats", tmp_str.len = sizeof("RoutingListChats") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((!(*input).RoutingListChats_after_present || encode_repeated_RoutingListChats_after(state, (&(*input).RoutingListChats_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_TransportRooms_after(
		zcbor_state_t *state, const struct TransportRooms_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).TransportRooms_after_choice == TransportRooms_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).TransportRooms_after_tstr))))
	: (((*input).TransportRooms_after_choice == TransportRooms_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_transport_rooms *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportRooms_transport))))
	&& (!(*input).TransportRooms_after_present || encode_repeated_TransportRooms_after(state, (&(*input).TransportRooms_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_transport_disconnect(
		zcbor_state_t *state, const struct request_transport_disconnect *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportDisconnect", tmp_str.len = sizeof("TransportDisconnect") - 1, &tmp_str)))))
	...
	&& (zcbor_tstr_encode(state, (&(*input).TransportDisconnect_transport))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_transport_remove(
		zcbor_state_t *state, const struct request_transport_remove *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportRemove", tmp_str.len = sizeof("TransportRemove") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportRemove_transport))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_transport_connect(
		zcbor_state_t *state, const struct request_transport_connect *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportConnect", tmp_str.len = sizeof("TransportConnect") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportConnect_transport))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_transport_set_enabled(
		zcbor_state_t *state, const struct request_transport_set_enabled *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportSetEnabled", tmp_str.len = sizeof("TransportSetEnabled") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportSetEnabled_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).TransportSetEnabled_enabled))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_TransportSetLabel_label(
		zcbor_state_t *state, const struct TransportSetLabel_label_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (((*input).TransportSetLabel_label_choice == TransportSetLabel_label_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).TransportSetLabel_label_tstr))))
	: (((*input).TransportSetLabel_label_choice == TransportSetLabel_label_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_request_transport_set_label(
		zcbor_state_t *state, const struct request_transport_set_label *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportSetLabel", tmp_str.len = sizeof("TransportSetLabel") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportSetLabel_transport))))
	&& (!(*input).TransportSetLabel_label_present || encode_repeated_TransportSetLabel_label(state, (&(*input).TransportSetLabel_label)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_ConvList_after(
		zcbor_state_t *state, const struct ConvList_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).ConvList_after_choice == ConvList_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ConvList_after_tstr))))
	: (((*input).ConvList_after_choice == ConvList_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_conv_list *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ConvList_transport))))
	&& (!(*input).ConvList_after_present || encode_repeated_ConvList_after(state, (&(*input).ConvList_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_auth_field_kind(
		zcbor_state_t *state, const struct auth_field_kind_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).auth_field_kind_choice == auth_field_kind_Text_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Text", tmp_str.len = sizeof("Text") - 1, &tmp_str)))))
	: (((*input).auth_field_kind_choice == auth_field_kind_Password_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Password", tmp_str.len = sizeof("Password") - 1, &tmp_str)))))
	: (((*input).auth_field_kind_choice == auth_field_kind_Number_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Number", tmp_str.len = sizeof("Number") - 1, &tmp_str)))))
	: (((*input).auth_field_kind_choice == auth_field_kind_Choice_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Choice", tmp_str.len = sizeof("Choice") - 1, &tmp_str)))))
	: false))))));
...
static bool encode_repeated_auth_param_field_kind(
		zcbor_state_t *state, const struct auth_param_field_kind *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
	&& (encode_auth_field_kind(state, (&(*input).auth_param_field_kind)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_auth_param_field_default(
		zcbor_state_t *state, const struct auth_param_field_default_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"default", tmp_str.len = sizeof("default") - 1, &tmp_str)))))
	&& (((*input).auth_param_field_default_choice == auth_param_field_default_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).auth_param_field_default_tstr))))
	: (((*input).auth_param_field_default_choice == auth_param_field_default_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_auth_param_field_placeholder(
		zcbor_state_t *state, const struct auth_param_field_placeholder_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"placeholder", tmp_str.len = sizeof("placeholder") - 1, &tmp_str)))))
	&& (((*input).auth_param_field_placeholder_choice == auth_param_field_placeholder_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).auth_param_field_placeholder_tstr))))
	: (((*input).auth_param_field_placeholder_choice == auth_param_field_placeholder_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_auth_param_field_choices(
		zcbor_state_t *state, const struct auth_param_field_choices_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"choices", tmp_str.len = sizeof("choices") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).auth_param_field_choices_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).auth_param_field_choices_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64))));
		...
		zcbor_state_t *state, const struct auth_param_field *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 7) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"key", tmp_str.len = sizeof("key") - 1, &tmp_str)))))
	...
	&& (zcbor_bool_encode(state, (&(*input).auth_param_field_required))))
	&& (!(*input).auth_param_field_kind_present || encode_repeated_auth_param_field_kind(state, (&(*input).auth_param_field_kind)))
	&& (!(*input).auth_param_field_default_present || encode_repeated_auth_param_field_default(state, (&(*input).auth_param_field_default)))
	&& (!(*input).auth_param_field_placeholder_present || encode_repeated_auth_param_field_placeholder(state, (&(*input).auth_param_field_placeholder)))
	&& (!(*input).auth_param_field_choices_present || encode_repeated_auth_param_field_choices(state, (&(*input).auth_param_field_choices)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 7))));
...
static bool encode_repeated_FsList_after(
		zcbor_state_t *state, const struct FsList_after_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after", tmp_str.len = sizeof("after") - 1, &tmp_str)))))
	&& (((*input).FsList_after_choice == FsList_after_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).FsList_after_tstr))))
	: (((*input).FsList_after_choice == FsList_after_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_fs_list *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"root", tmp_str.len = sizeof("root") - 1, &tmp_str)))))
	...
	&& (!(*input).FsList_show_ignored_present || encode_repeated_FsList_show_ignored(state, (&(*input).FsList_show_ignored)))
	&& (!(*input).FsList_after_present || encode_repeated_FsList_after(state, (&(*input).FsList_after)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_feedback_kind(
		zcbor_state_t *state, const struct feedback_kind_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).feedback_kind_choice == feedback_kind_response_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"response", tmp_str.len = sizeof("response") - 1, &tmp_str)))))
	: (((*input).feedback_kind_choice == feedback_kind_app_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"app", tmp_str.len = sizeof("app") - 1, &tmp_str)))))
	: false))));
...
static bool encode_repeated_feedback_target_trace(
		zcbor_state_t *state, const struct feedback_target_trace_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"trace", tmp_str.len = sizeof("trace") - 1, &tmp_str)))))
	&& (((*input).feedback_target_trace_choice == feedback_target_trace_trace_id_m_c) ? ((zcbor_uint64_encode(state, (&(*input).feedback_target_trace_trace_id_m))))
	: (((*input).feedback_target_trace_choice == feedback_target_trace_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_feedback_target(
		zcbor_state_t *state, const struct feedback_target *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_tstr_encode(state, (&(*input).feedback_target_session))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"cursor", tmp_str.len = sizeof("cursor") - 1, &tmp_str)))))
	&& (zcbor_uint64_encode(state, (&(*input).feedback_target_cursor))))
	&& (!(*input).feedback_target_trace_present || encode_repeated_feedback_target_trace(state, (&(*input).feedback_target_trace)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_FeedbackSubmit_target(
		zcbor_state_t *state, const struct FeedbackSubmit_target_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"target", tmp_str.len = sizeof("target") - 1, &tmp_str)))))
	&& (((*input).FeedbackSubmit_target_choice == FeedbackSubmit_target_feedback_target_m_c) ? ((encode_feedback_target(state, (&(*input).FeedbackSubmit_target_feedback_target_m))))
	: (((*input).FeedbackSubmit_target_choice == FeedbackSubmit_target_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_feedback_rating(
		zcbor_state_t *state, const struct feedback_rating_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).feedback_rating_choice == feedback_rating_up_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"up", tmp_str.len = sizeof("up") - 1, &tmp_str)))))
	: (((*input).feedback_rating_choice == feedback_rating_down_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"down", tmp_str.len = sizeof("down") - 1, &tmp_str)))))
	: false))));
...
static bool encode_repeated_FeedbackSubmit_rating(
		zcbor_state_t *state, const struct FeedbackSubmit_rating_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"rating", tmp_str.len = sizeof("rating") - 1, &tmp_str)))))
	&& (((*input).FeedbackSubmit_rating_choice == FeedbackSubmit_rating_feedback_rating_m_c) ? ((encode_feedback_rating(state, (&(*input).FeedbackSubmit_rating_feedback_rating_m))))
	: (((*input).FeedbackSubmit_rating_choice == FeedbackSubmit_rating_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_FeedbackSubmit_comment(
		zcbor_state_t *state, const struct FeedbackSubmit_comment_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"comment", tmp_str.len = sizeof("comment") - 1, &tmp_str)))))
	&& (((*input).FeedbackSubmit_comment_choice == FeedbackSubmit_comment_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).FeedbackSubmit_comment_tstr))))
	: (((*input).FeedbackSubmit_comment_choice == FeedbackSubmit_comment_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_feedback_diagnostics_app_version(
		zcbor_state_t *state, const struct feedback_diagnostics_app_version_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"app_version", tmp_str.len = sizeof("app_version") - 1, &tmp_str)))))
	&& (((*input).feedback_diagnostics_app_version_choice == feedback_diagnostics_app_version_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).feedback_diagnostics_app_version_tstr))))
	: (((*input).feedback_diagnostics_app_version_choice == feedback_diagnostics_app_version_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_feedback_diagnostics_os(
		zcbor_state_t *state, const struct feedback_diagnostics_os_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"os", tmp_str.len = sizeof("os") - 1, &tmp_str)))))
	&& (((*input).feedback_diagnostics_os_choice == feedback_diagnostics_os_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).feedback_diagnostics_os_tstr))))
	: (((*input).feedback_diagnostics_os_choice == feedback_diagnostics_os_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_feedback_diagnostics(
		zcbor_state_t *state, const struct feedback_diagnostics *input)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_map_start_encode(state, 2) && (((!(*input).feedback_diagnostics_app_version_present || encode_repeated_feedback_diagnostics_app_version(state, (&(*input).feedback_diagnostics_app_version)))
	&& (!(*input).feedback_diagnostics_os_present || encode_repeated_feedback_diagnostics_os(state, (&(*input).feedback_diagnostics_os)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_FeedbackSubmit_diagnostics(
		zcbor_state_t *state, const struct FeedbackSubmit_diagnostics_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"diagnostics", tmp_str.len = sizeof("diagnostics") - 1, &tmp_str)))))
	&& (((*input).FeedbackSubmit_diagnostics_choice == FeedbackSubmit_diagnostics_feedback_diagnostics_m_c) ? ((encode_feedback_diagnostics(state, (&(*input).FeedbackSubmit_diagnostics_feedback_diagnostics_m))))
	: (((*input).FeedbackSubmit_diagnostics_choice == FeedbackSubmit_diagnostics_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_request_feedback_submit(
		zcbor_state_t *state, const struct request_feedback_submit *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"FeedbackSubmit", tmp_str.len = sizeof("FeedbackSubmit") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 7) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
	&& (encode_feedback_kind(state, (&(*input).FeedbackSubmit_kind))))
	&& (!(*input).FeedbackSubmit_target_present || encode_repeated_FeedbackSubmit_target(state, (&(*input).FeedbackSubmit_target)))
	&& (!(*input).FeedbackSubmit_rating_present || encode_repeated_FeedbackSubmit_rating(state, (&(*input).FeedbackSubmit_rating)))
	&& (!(*input).FeedbackSubmit_comment_present || encode_repeated_FeedbackSubmit_comment(state, (&(*input).FeedbackSubmit_comment)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"include_content", tmp_str.len = sizeof("include_content") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).FeedbackSubmit_include_content))))
	&& (!(*input).FeedbackSubmit_diagnostics_present || encode_repeated_FeedbackSubmit_diagnostics(state, (&(*input).FeedbackSubmit_diagnostics)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"surface", tmp_str.len = sizeof("surface") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).FeedbackSubmit_surface))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 7)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_telemetry_consent_set(
		zcbor_state_t *state, const struct request_telemetry_consent_set *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
...
static bool encode_request_transport_settings(
		zcbor_state_t *state, const struct request_transport_settings *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportSettings", tmp_str.len = sizeof("TransportSettings") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportSettings_transport))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_request_transport_configure(
		zcbor_state_t *state, const struct request_transport_configure *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportConfigure", tmp_str.len = sizeof("TransportConfigure") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportConfigure_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"settings", tmp_str.len = sizeof("settings") - 1, &tmp_str)))))
	&& (encode_account_settings_values(state, (&(*input).TransportConfigure_settings))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_foreign_stage(
		zcbor_state_t *state, const struct foreign_stage_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).foreign_stage_choice == foreign_stage_Spawn_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Spawn", tmp_str.len = sizeof("Spawn") - 1, &tmp_str)))))
	: (((*input).foreign_stage_choice == foreign_stage_Handshake_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Handshake", tmp_str.len = sizeof("Handshake") - 1, &tmp_str)))))
	: (((*input).foreign_stage_choice == foreign_stage_Turn_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Turn", tmp_str.len = sizeof("Turn") - 1, &tmp_str)))))
	: (((*input).foreign_stage_choice == foreign_stage_Unknown_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Unknown", tmp_str.len = sizeof("Unknown") - 1, &tmp_str)))))
	: false))))));
...
static bool encode_repeated_foreign_failure_agent(
		zcbor_state_t *state, const struct foreign_failure_agent_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"agent", tmp_str.len = sizeof("agent") - 1, &tmp_str)))))
	&& (((*input).foreign_failure_agent_choice == foreign_failure_agent_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).foreign_failure_agent_tstr))))
	: (((*input).foreign_failure_agent_choice == foreign_failure_agent_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_foreign_failure(
		zcbor_state_t *state, const struct foreign_failure *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"stage", tmp_str.len = sizeof("stage") - 1, &tmp_str)))))
	&& (encode_foreign_stage(state, (&(*input).foreign_failure_stage))))
	&& (!(*input).foreign_failure_agent_present || encode_repeated_foreign_failure_agent(state, (&(*input).foreign_failure_agent)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_turn_summary_failure(
		zcbor_state_t *state, const struct turn_summary_failure_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"failure", tmp_str.len = sizeof("failure") - 1, &tmp_str)))))
	&& (((*input).turn_summary_failure_choice == turn_summary_failure_foreign_failure_m_c) ? ((encode_foreign_failure(state, (&(*input).turn_summary_failure_foreign_failure_m))))
	: (((*input).turn_summary_failure_choice == turn_summary_failure_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct turn_summary *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"end_reason", tmp_str.len = sizeof("end_reason") - 1, &tmp_str)))))
	...
	&& (encode_usage_delta(state, (&(*input).turn_summary_usage))))
	&& (!(*input).turn_summary_failure_present || encode_repeated_turn_summary_failure(state, (&(*input).turn_summary_failure)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));
...
static bool encode_repeated_approval_info_fingerprint(
		zcbor_state_t *state, const struct approval_info_fingerprint_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"fingerprint", tmp_str.len = sizeof("fingerprint") - 1, &tmp_str)))))
	&& (((*input).approval_info_fingerprint_choice == approval_info_fingerprint_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).approval_info_fingerprint_tstr))))
	: (((*input).approval_info_fingerprint_choice == approval_info_fingerprint_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_approval_info_detail(
		zcbor_state_t *state, const struct approval_info_detail_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"detail", tmp_str.len = sizeof("detail") - 1, &tmp_str)))))
	&& (((*input).approval_info_detail_choice == approval_info_detail_tool_detail_m_c) ? ((encode_tool_detail(state, (&(*input).approval_info_detail_tool_detail_m))))
	: (((*input).approval_info_detail_choice == approval_info_detail_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct approval_info *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 6) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	...
	&& (!(*input).approval_info_path_present || encode_repeated_approval_info_path(state, (&(*input).approval_info_path)))
	&& (!(*input).approval_info_fingerprint_present || encode_repeated_approval_info_fingerprint(state, (&(*input).approval_info_fingerprint)))
	&& (!(*input).approval_info_detail_present || encode_repeated_approval_info_detail(state, (&(*input).approval_info_detail)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 6))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_approval_page_next(
		zcbor_state_t *state, const struct approval_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).approval_page_next_choice == approval_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).approval_page_next_tstr))))
	: (((*input).approval_page_next_choice == approval_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_approval_page(
		zcbor_state_t *state, const struct approval_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).approval_page_items_approval_info_m_count, (zcbor_encoder_t *)encode_approval_info, state, (*&(*input).approval_page_items_approval_info_m), sizeof(struct approval_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).approval_page_next_present || encode_repeated_approval_page_next(state, (&(*input).approval_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_approvals *input)
{
	...
	&& (encode_approval_page(state, (&(*input).response_approvals_Approvals))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_remembered_fingerprint_label(
		zcbor_state_t *state, const struct remembered_fingerprint_label_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (((*input).remembered_fingerprint_label_choice == remembered_fingerprint_label_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).remembered_fingerprint_label_tstr))))
	: (((*input).remembered_fingerprint_label_choice == remembered_fingerprint_label_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_remembered_fingerprint_remembered_at_ms(
		zcbor_state_t *state, const struct remembered_fingerprint_remembered_at_ms *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"remembered_at_ms", tmp_str.len = sizeof("remembered_at_ms") - 1, &tmp_str)))))
	&& (zcbor_uint64_encode(state, (&(*input).remembered_fingerprint_remembered_at_ms)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_remembered_fingerprint(
		zcbor_state_t *state, const struct remembered_fingerprint *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"fingerprint", tmp_str.len = sizeof("fingerprint") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).remembered_fingerprint_fingerprint))))
	&& (!(*input).remembered_fingerprint_label_present || encode_repeated_remembered_fingerprint_label(state, (&(*input).remembered_fingerprint_label)))
	&& (!(*input).remembered_fingerprint_remembered_at_ms_present || encode_repeated_remembered_fingerprint_remembered_at_ms(state, (&(*input).remembered_fingerprint_remembered_at_ms)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_response_fingerprints(
		zcbor_state_t *state, const struct response_fingerprints *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Fingerprints", tmp_str.len = sizeof("Fingerprints") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).response_fingerprints_Fingerprints_remembered_fingerprint_m_count, (zcbor_encoder_t *)encode_remembered_fingerprint, state, (*&(*input).response_fingerprints_Fingerprints_remembered_fingerprint_m), sizeof(struct remembered_fingerprint))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_delegation_lifetime(
		zcbor_state_t *state, const struct delegation_lifetime_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).delegation_lifetime_choice == delegation_lifetime_Persistent_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Persistent", tmp_str.len = sizeof("Persistent") - 1, &tmp_str)))))
	: (((*input).delegation_lifetime_choice == delegation_lifetime_Ephemeral_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Ephemeral", tmp_str.len = sizeof("Ephemeral") - 1, &tmp_str)))))
	: false))));
...
static bool encode_repeated_unit_node_lifetime(
		zcbor_state_t *state, const struct unit_node_lifetime_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"lifetime", tmp_str.len = sizeof("lifetime") - 1, &tmp_str)))))
	&& (((*input).unit_node_lifetime_choice == unit_node_lifetime_delegation_lifetime_m_c) ? ((encode_delegation_lifetime(state, (&(*input).unit_node_lifetime_delegation_lifetime_m))))
	: (((*input).unit_node_lifetime_choice == unit_node_lifetime_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_unit_node_engine(
		zcbor_state_t *state, const struct unit_node_engine_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (((*input).unit_node_engine_choice == unit_node_engine_engine_selector_m_c) ? ((encode_engine_selector(state, (&(*input).unit_node_engine_engine_selector_m))))
	: (((*input).unit_node_engine_choice == unit_node_engine_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct unit_node *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 12) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	...
	&& (!(*input).unit_node_role_present || encode_repeated_unit_node_role(state, (&(*input).unit_node_role)))
	&& (!(*input).unit_node_lifetime_present || encode_repeated_unit_node_lifetime(state, (&(*input).unit_node_lifetime)))
	&& (!(*input).unit_node_engine_present || encode_repeated_unit_node_engine(state, (&(*input).unit_node_engine)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 12))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_tree_report_next(
		zcbor_state_t *state, const struct tree_report_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).tree_report_next_choice == tree_report_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).tree_report_next_tstr))))
	: (((*input).tree_report_next_choice == tree_report_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct tree_report *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"root", tmp_str.len = sizeof("root") - 1, &tmp_str)))))
	...
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).tree_report_nodes_unit_node_m_count, (zcbor_encoder_t *)encode_unit_node, state, (*&(*input).tree_report_nodes_unit_node_m), sizeof(struct unit_node))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).tree_report_next_present || encode_repeated_tree_report_next(state, (&(*input).tree_report_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));
...
static bool encode_node_event_profiles_changed(
		zcbor_state_t *state, const struct node_event_profiles_changed *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ProfilesChanged", tmp_str.len = sizeof("ProfilesChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"rev", tmp_str.len = sizeof("rev") - 1, &tmp_str)))))
	&& (zcbor_uint64_encode(state, (&(*input).ProfilesChanged_rev))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct node_event_download_progress *input)
{
	...
	&& (zcbor_map_start_encode(state, 5) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"state", tmp_str.len = sizeof("state") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).DownloadProgress_state))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"downloaded_bytes", tmp_str.len = sizeof("downloaded_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint64_encode(state, (&(*input).DownloadProgress_downloaded_bytes))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"total_bytes", tmp_str.len = sizeof("total_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint64_encode(state, (&(*input).DownloadProgress_total_bytes))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 5)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct connection_state_r *input)
{
	...
	: (((*input).connection_state_choice == connection_state_Disconnecting_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Disconnecting", tmp_str.len = sizeof("Disconnecting") - 1, &tmp_str)))))
...
static bool encode_repeated_TransportChanged_presence(
		zcbor_state_t *state, const struct TransportChanged_presence *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"presence", tmp_str.len = sizeof("presence") - 1, &tmp_str)))))
	&& (encode_presence_state(state, (&(*input).TransportChanged_presence)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_disconnect_reason(
		zcbor_state_t *state, const struct disconnect_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).disconnect_reason_choice == disconnect_reason_UserRequested_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"UserRequested", tmp_str.len = sizeof("UserRequested") - 1, &tmp_str)))))
	: (((*input).disconnect_reason_choice == disconnect_reason_NetworkError_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"NetworkError", tmp_str.len = sizeof("NetworkError") - 1, &tmp_str)))))
	: (((*input).disconnect_reason_choice == disconnect_reason_AuthenticationFailed_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"AuthenticationFailed", tmp_str.len = sizeof("AuthenticationFailed") - 1, &tmp_str)))))
	: (((*input).disconnect_reason_choice == disconnect_reason_ReplacedByOtherClient_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ReplacedByOtherClient", tmp_str.len = sizeof("ReplacedByOtherClient") - 1, &tmp_str)))))
	: (((*input).disconnect_reason_choice == disconnect_reason_InvalidSettings_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"InvalidSettings", tmp_str.len = sizeof("InvalidSettings") - 1, &tmp_str)))))
	: (((*input).disconnect_reason_choice == disconnect_reason_CertificateError_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"CertificateError", tmp_str.len = sizeof("CertificateError") - 1, &tmp_str)))))
	: (((*input).disconnect_reason_choice == disconnect_reason_Other_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Other", tmp_str.len = sizeof("Other") - 1, &tmp_str)))))
	: false)))))))));
...
static bool encode_repeated_TransportChanged_reason(
		zcbor_state_t *state, const struct TransportChanged_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (((*input).TransportChanged_reason_choice == TransportChanged_reason_disconnect_reason_m_c) ? ((encode_disconnect_reason(state, (&(*input).TransportChanged_reason_disconnect_reason_m))))
	: (((*input).TransportChanged_reason_choice == TransportChanged_reason_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_TransportChanged_message(
		zcbor_state_t *state, const struct TransportChanged_message_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (((*input).TransportChanged_message_choice == TransportChanged_message_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).TransportChanged_message_tstr))))
	: (((*input).TransportChanged_message_choice == TransportChanged_message_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_TransportChanged_fatal(
		zcbor_state_t *state, const struct TransportChanged_fatal *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"fatal", tmp_str.len = sizeof("fatal") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).TransportChanged_fatal)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_node_event_transport_changed(
		zcbor_state_t *state, const struct node_event_transport_changed *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportChanged", tmp_str.len = sizeof("TransportChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 6) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).TransportChanged_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"connection", tmp_str.len = sizeof("connection") - 1, &tmp_str)))))
	&& (encode_connection_state(state, (&(*input).TransportChanged_connection))))
	&& (!(*input).TransportChanged_presence_present || encode_repeated_TransportChanged_presence(state, (&(*input).TransportChanged_presence)))
	&& (!(*input).TransportChanged_reason_present || encode_repeated_TransportChanged_reason(state, (&(*input).TransportChanged_reason)))
	&& (!(*input).TransportChanged_message_present || encode_repeated_TransportChanged_message(state, (&(*input).TransportChanged_message)))
	&& (!(*input).TransportChanged_fatal_present || encode_repeated_TransportChanged_fatal(state, (&(*input).TransportChanged_fatal)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 6)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_conv_change(
		zcbor_state_t *state, const struct conv_change_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).conv_change_choice == conv_change_Added_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Added", tmp_str.len = sizeof("Added") - 1, &tmp_str)))))
	: (((*input).conv_change_choice == conv_change_Removed_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Removed", tmp_str.len = sizeof("Removed") - 1, &tmp_str)))))
	: false))));
...
static bool encode_node_event_conversations_changed(
		zcbor_state_t *state, const struct node_event_conversations_changed *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ConversationsChanged", tmp_str.len = sizeof("ConversationsChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ConversationsChanged_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ConversationsChanged_conv))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"change", tmp_str.len = sizeof("change") - 1, &tmp_str)))))
	&& (encode_conv_change(state, (&(*input).ConversationsChanged_change))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_membership_change(
		zcbor_state_t *state, const struct membership_change_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((((*input).membership_change_choice == membership_change_Joined_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Joined", tmp_str.len = sizeof("Joined") - 1, &tmp_str)))))
	: (((*input).membership_change_choice == membership_change_Left_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Left", tmp_str.len = sizeof("Left") - 1, &tmp_str)))))
	: (((*input).membership_change_choice == membership_change_Invited_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Invited", tmp_str.len = sizeof("Invited") - 1, &tmp_str)))))
	: (((*input).membership_change_choice == membership_change_Kicked_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Kicked", tmp_str.len = sizeof("Kicked") - 1, &tmp_str)))))
	: (((*input).membership_change_choice == membership_change_Banned_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Banned", tmp_str.len = sizeof("Banned") - 1, &tmp_str)))))
	: false)))))));
...
static bool encode_repeated_MembershipChanged_actor(
		zcbor_state_t *state, const struct MembershipChanged_actor_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"actor", tmp_str.len = sizeof("actor") - 1, &tmp_str)))))
	&& (((*input).MembershipChanged_actor_choice == MembershipChanged_actor_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).MembershipChanged_actor_tstr))))
	: (((*input).MembershipChanged_actor_choice == MembershipChanged_actor_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_MembershipChanged_reason(
		zcbor_state_t *state, const struct MembershipChanged_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (((*input).MembershipChanged_reason_choice == MembershipChanged_reason_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).MembershipChanged_reason_tstr))))
	: (((*input).MembershipChanged_reason_choice == MembershipChanged_reason_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_node_event_membership_changed(
		zcbor_state_t *state, const struct node_event_membership_changed *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"MembershipChanged", tmp_str.len = sizeof("MembershipChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 7) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MembershipChanged_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MembershipChanged_conv))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"member", tmp_str.len = sizeof("member") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MembershipChanged_member))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"change", tmp_str.len = sizeof("change") - 1, &tmp_str)))))
	&& (encode_membership_change(state, (&(*input).MembershipChanged_change))))
	&& (!(*input).MembershipChanged_actor_present || encode_repeated_MembershipChanged_actor(state, (&(*input).MembershipChanged_actor)))
	&& (!(*input).MembershipChanged_reason_present || encode_repeated_MembershipChanged_reason(state, (&(*input).MembershipChanged_reason)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"is_self", tmp_str.len = sizeof("is_self") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).MembershipChanged_is_self))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 7)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_node_event_messages_changed(
		zcbor_state_t *state, const struct node_event_messages_changed *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"MessagesChanged", tmp_str.len = sizeof("MessagesChanged") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MessagesChanged_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MessagesChanged_conv))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct node_event_r *input)
{
	...
	: (((*input).node_event_choice == node_event_profiles_changed_m_c) ? ((encode_node_event_profiles_changed(state, (&(*input).node_event_profiles_changed_m))))
	...
	: (((*input).node_event_choice == node_event_catalog_changed_m_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"CatalogChanged", tmp_str.len = sizeof("CatalogChanged") - 1, &tmp_str)))))
	...
	: (((*input).node_event_choice == node_event_messages_changed_m_c) ? ((encode_node_event_messages_changed(state, (&(*input).node_event_messages_changed_m))))
	: false))))))))))))))))));
...
static bool encode_repeated_delivery_session_page_next(
		zcbor_state_t *state, const struct delivery_session_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).delivery_session_page_next_choice == delivery_session_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).delivery_session_page_next_tstr))))
	: (((*input).delivery_session_page_next_choice == delivery_session_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_delivery_session_page(
		zcbor_state_t *state, const struct delivery_session_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).delivery_session_page_items_session_id_m_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).delivery_session_page_items_session_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).delivery_session_page_next_present || encode_repeated_delivery_session_page_next(state, (&(*input).delivery_session_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_delivery_sessions *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"DeliverySessions", tmp_str.len = sizeof("DeliverySessions") - 1, &tmp_str)))))
	&& (encode_delivery_session_page(state, (&(*input).response_delivery_sessions_DeliverySessions))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct model_file *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 6) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"path", tmp_str.len = sizeof("path") - 1, &tmp_str)))))
	...
	&& (zcbor_bool_encode(state, (&(*input).model_file_is_first_shard))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"is_mmproj", tmp_str.len = sizeof("is_mmproj") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).model_file_is_mmproj))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 6))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_model_file_page_next(
		zcbor_state_t *state, const struct model_file_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).model_file_page_next_choice == model_file_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).model_file_page_next_tstr))))
	: (((*input).model_file_page_next_choice == model_file_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_model_file_page(
		zcbor_state_t *state, const struct model_file_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).model_file_page_items_model_file_m_count, (zcbor_encoder_t *)encode_model_file, state, (*&(*input).model_file_page_items_model_file_m), sizeof(struct model_file))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).model_file_page_next_present || encode_repeated_model_file_page_next(state, (&(*input).model_file_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_model_files *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ModelFiles", tmp_str.len = sizeof("ModelFiles") - 1, &tmp_str)))))
	&& (encode_model_file_page(state, (&(*input).response_model_files_ModelFiles))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_installed_model_mmproj_path(
		zcbor_state_t *state, const struct installed_model_mmproj_path_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"mmproj_path", tmp_str.len = sizeof("mmproj_path") - 1, &tmp_str)))))
	&& (((*input).installed_model_mmproj_path_choice == installed_model_mmproj_path_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).installed_model_mmproj_path_tstr))))
	: (((*input).installed_model_mmproj_path_choice == installed_model_mmproj_path_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_installed_model_sha256(
		zcbor_state_t *state, const struct installed_model_sha256_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"sha256", tmp_str.len = sizeof("sha256") - 1, &tmp_str)))))
	&& (((*input).installed_model_sha256_choice == installed_model_sha256_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).installed_model_sha256_tstr))))
	: (((*input).installed_model_sha256_choice == installed_model_sha256_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct installed_model *input)
{
	...
	&& (!(*input).installed_model_file_type_present || encode_repeated_installed_model_file_type(state, (&(*input).installed_model_file_type)))
	&& (!(*input).installed_model_mmproj_path_present || encode_repeated_installed_model_mmproj_path(state, (&(*input).installed_model_mmproj_path)))
	&& (!(*input).installed_model_sha256_present || encode_repeated_installed_model_sha256(state, (&(*input).installed_model_sha256)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 12))));
...
static bool encode_repeated_profile_info_created_by(
		zcbor_state_t *state, const struct profile_info_created_by_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"created_by", tmp_str.len = sizeof("created_by") - 1, &tmp_str)))))
	&& (((*input).profile_info_created_by_choice == profile_info_created_by_author_m_c) ? ((encode_author(state, (&(*input).profile_info_created_by_author_m))))
	: (((*input).profile_info_created_by_choice == profile_info_created_by_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_profile_info_owner(
		zcbor_state_t *state, const struct profile_info_owner_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"owner", tmp_str.len = sizeof("owner") - 1, &tmp_str)))))
	&& (((*input).profile_info_owner_choice == profile_info_owner_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).profile_info_owner_tstr))))
	: (((*input).profile_info_owner_choice == profile_info_owner_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct profile_info *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"bound_accounts", tmp_str.len = sizeof("bound_accounts") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).profile_info_bound_accounts_bound_account_m_count, (zcbor_encoder_t *)encode_bound_account, state, (*&(*input).profile_info_bound_accounts_bound_account_m), sizeof(struct bound_account))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).profile_info_created_by_present || encode_repeated_profile_info_created_by(state, (&(*input).profile_info_created_by)))
	&& (!(*input).profile_info_owner_present || encode_repeated_profile_info_owner(state, (&(*input).profile_info_owner)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 7))));
...
static bool encode_response_soul_text(
		zcbor_state_t *state, const struct response_soul_text *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"SoulText", tmp_str.len = sizeof("SoulText") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).response_soul_text_SoulText))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_credential_info_label(
		zcbor_state_t *state, const struct credential_info_label_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (((*input).credential_info_label_choice == credential_info_label_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).credential_info_label_tstr))))
	: (((*input).credential_info_label_choice == credential_info_label_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct credential_info *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"profile", tmp_str.len = sizeof("profile") - 1, &tmp_str)))))
	...
	&& (zcbor_tstr_encode(state, (&(*input).credential_info_hint))))
	&& (!(*input).credential_info_label_present || encode_repeated_credential_info_label(state, (&(*input).credential_info_label)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));
...
static bool encode_repeated_model_page_next(
		zcbor_state_t *state, const struct model_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).model_page_next_choice == model_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).model_page_next_tstr))))
	: (((*input).model_page_next_choice == model_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_model_page(
		zcbor_state_t *state, const struct model_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).model_page_items_model_descriptor_m_count, (zcbor_encoder_t *)encode_model_descriptor, state, (*&(*input).model_page_items_model_descriptor_m), sizeof(struct model_descriptor))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).model_page_next_present || encode_repeated_model_page_next(state, (&(*input).model_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_models *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Models", tmp_str.len = sizeof("Models") - 1, &tmp_str)))))
	&& (encode_model_page(state, (&(*input).response_models_Models))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_provider_sign_in(
		zcbor_state_t *state, const struct provider_sign_in *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"family", tmp_str.len = sizeof("family") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).provider_sign_in_family))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).provider_sign_in_label))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_provider_descriptor_sign_in(
		zcbor_state_t *state, const struct provider_descriptor_sign_in_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"sign_in", tmp_str.len = sizeof("sign_in") - 1, &tmp_str)))))
	&& (((*input).provider_descriptor_sign_in_choice == provider_descriptor_sign_in_provider_sign_in_m_c) ? ((encode_provider_sign_in(state, (&(*input).provider_descriptor_sign_in_provider_sign_in_m))))
	: (((*input).provider_descriptor_sign_in_choice == provider_descriptor_sign_in_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct provider_descriptor *input)
{
	...
	: false)))
	&& (!(*input).provider_descriptor_sign_in_present || encode_repeated_provider_descriptor_sign_in(state, (&(*input).provider_descriptor_sign_in)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 8))));
		...
		zcbor_state_t *state, const struct response_provider_models *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ProviderModels", tmp_str.len = sizeof("ProviderModels") - 1, &tmp_str)))))
	&& (encode_model_page(state, (&(*input).response_provider_models_ProviderModels))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_revision_page_next(
		zcbor_state_t *state, const struct revision_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).revision_page_next_choice == revision_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).revision_page_next_tstr))))
	: (((*input).revision_page_next_choice == revision_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_revision_page(
		zcbor_state_t *state, const struct revision_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).revision_page_items_revision_m_count, (zcbor_encoder_t *)encode_revision, state, (*&(*input).revision_page_items_revision_m), sizeof(struct revision))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).revision_page_next_present || encode_repeated_revision_page_next(state, (&(*input).revision_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_revisions *input)
{
	...
	&& (encode_revision_page(state, (&(*input).response_revisions_Revisions))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct auth_flow_kind_r *input)
{
	...
	: (((*input).auth_flow_kind_choice == auth_flow_kind_UserPassword_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"UserPassword", tmp_str.len = sizeof("UserPassword") - 1, &tmp_str)))))
	: false)))))))));
...
static bool encode_repeated_checkpoint_page_next(
		zcbor_state_t *state, const struct checkpoint_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).checkpoint_page_next_choice == checkpoint_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).checkpoint_page_next_tstr))))
	: (((*input).checkpoint_page_next_choice == checkpoint_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_checkpoint_page(
		zcbor_state_t *state, const struct checkpoint_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).checkpoint_page_items_checkpoint_info_m_count, (zcbor_encoder_t *)encode_checkpoint_info, state, (*&(*input).checkpoint_page_items_checkpoint_info_m), sizeof(struct checkpoint_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).checkpoint_page_next_present || encode_repeated_checkpoint_page_next(state, (&(*input).checkpoint_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_checkpoints *input)
{
	...
	&& (encode_checkpoint_page(state, (&(*input).response_checkpoints_Checkpoints))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_session_detail_engine(
		zcbor_state_t *state, const struct session_detail_engine *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (encode_engine_selector(state, (&(*input).session_detail_engine)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_session_detail_foreign_backend(
		zcbor_state_t *state, const struct session_detail_foreign_backend *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"foreign_backend", tmp_str.len = sizeof("foreign_backend") - 1, &tmp_str)))))
	&& (encode_foreign_backend(state, (&(*input).session_detail_foreign_backend)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_model_choice(
		zcbor_state_t *state, const struct model_choice *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).model_choice_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).model_choice_label))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_model_selector(
		zcbor_state_t *state, const struct model_selector *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"option_id", tmp_str.len = sizeof("option_id") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).model_selector_option_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"current", tmp_str.len = sizeof("current") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).model_selector_current))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"choices", tmp_str.len = sizeof("choices") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).model_selector_choices_model_choice_m_count, (zcbor_encoder_t *)encode_model_choice, state, (*&(*input).model_selector_choices_model_choice_m), sizeof(struct model_choice))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_session_detail_model_selector(
		zcbor_state_t *state, const struct session_detail_model_selector_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"model_selector", tmp_str.len = sizeof("model_selector") - 1, &tmp_str)))))
	&& (((*input).session_detail_model_selector_choice == session_detail_model_selector_model_selector_m_c) ? ((encode_model_selector(state, (&(*input).session_detail_model_selector_model_selector_m))))
	: (((*input).session_detail_model_selector_choice == session_detail_model_selector_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct session_detail *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 9) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"info", tmp_str.len = sizeof("info") - 1, &tmp_str)))))
	...
	&& (!(*input).session_detail_checkpoints_present || encode_repeated_session_detail_checkpoints(state, (&(*input).session_detail_checkpoints)))
	&& (!(*input).session_detail_engine_present || encode_repeated_session_detail_engine(state, (&(*input).session_detail_engine)))
	&& (!(*input).session_detail_foreign_backend_present || encode_repeated_session_detail_foreign_backend(state, (&(*input).session_detail_foreign_backend)))
	&& (!(*input).session_detail_model_selector_present || encode_repeated_session_detail_model_selector(state, (&(*input).session_detail_model_selector)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 9))));
...
static bool encode_repeated_top_tools_name_l(
		zcbor_state_t *state, const struct top_tools_name_l *input)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_list_start_encode(state, 2) && ((((zcbor_tstr_encode(state, (&(*input).top_tools_name_l_name))))
	&& ((zcbor_uint32_encode(state, (&(*input).top_tools_name_l_count))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 2))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_session_recap(
		zcbor_state_t *state, const struct session_recap *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 8) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"title", tmp_str.len = sizeof("title") - 1, &tmp_str)))))
	&& (((*input).session_recap_title_choice == session_recap_title_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).session_recap_title_tstr))))
	: (((*input).session_recap_title_choice == session_recap_title_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"user_turns", tmp_str.len = sizeof("user_turns") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).session_recap_user_turns))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"assistant_turns", tmp_str.len = sizeof("assistant_turns") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).session_recap_assistant_turns))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"tool_results", tmp_str.len = sizeof("tool_results") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).session_recap_tool_results))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"top_tools", tmp_str.len = sizeof("top_tools") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).top_tools_name_l_count, (zcbor_encoder_t *)encode_repeated_top_tools_name_l, state, (*&(*input).top_tools_name_l), sizeof(struct top_tools_name_l))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"files_touched", tmp_str.len = sizeof("files_touched") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).session_recap_files_touched_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).session_recap_files_touched_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"last_ask", tmp_str.len = sizeof("last_ask") - 1, &tmp_str)))))
	&& (((*input).session_recap_last_ask_choice == session_recap_last_ask_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).session_recap_last_ask_tstr))))
	: (((*input).session_recap_last_ask_choice == session_recap_last_ask_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"last_reply", tmp_str.len = sizeof("last_reply") - 1, &tmp_str)))))
	&& (((*input).session_recap_last_reply_choice == session_recap_last_reply_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).session_recap_last_reply_tstr))))
	: (((*input).session_recap_last_reply_choice == session_recap_last_reply_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 8))));
...
static bool encode_response_session_recap(
		zcbor_state_t *state, const struct response_session_recap *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"SessionRecap", tmp_str.len = sizeof("SessionRecap") - 1, &tmp_str)))))
	&& (((*input).response_session_recap_SessionRecap_choice == response_session_recap_SessionRecap_session_recap_m_c) ? ((encode_session_recap(state, (&(*input).response_session_recap_SessionRecap_session_recap_m))))
	: (((*input).response_session_recap_SessionRecap_choice == response_session_recap_SessionRecap_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_response_agent_catalog(
		zcbor_state_t *state, const struct response_agent_catalog *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"AgentCatalog", tmp_str.len = sizeof("AgentCatalog") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).response_agent_catalog_AgentCatalog_agent_entry_m_count, (zcbor_encoder_t *)encode_agent_entry, state, (*&(*input).response_agent_catalog_AgentCatalog_agent_entry_m), sizeof(struct agent_entry))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_gateway_status(
		zcbor_state_t *state, const struct gateway_status *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).gateway_status_enabled))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"addr", tmp_str.len = sizeof("addr") - 1, &tmp_str)))))
	&& (((*input).gateway_status_addr_choice == gateway_status_addr_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).gateway_status_addr_tstr))))
	: (((*input).gateway_status_addr_choice == gateway_status_addr_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"listening", tmp_str.len = sizeof("listening") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).gateway_status_listening))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"last_error", tmp_str.len = sizeof("last_error") - 1, &tmp_str)))))
	&& (((*input).gateway_status_last_error_choice == gateway_status_last_error_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).gateway_status_last_error_tstr))))
	: (((*input).gateway_status_last_error_choice == gateway_status_last_error_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));
...
static bool encode_response_gateway_status(
		zcbor_state_t *state, const struct response_gateway_status *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"GatewayStatus", tmp_str.len = sizeof("GatewayStatus") - 1, &tmp_str)))))
	&& (encode_gateway_status(state, (&(*input).response_gateway_status_GatewayStatus))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_caps_report_max_composed_profiles(
		zcbor_state_t *state, const struct caps_report_max_composed_profiles *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"max_composed_profiles", tmp_str.len = sizeof("max_composed_profiles") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).caps_report_max_composed_profiles)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_caps_report_max_ephemeral_per_session(
		zcbor_state_t *state, const struct caps_report_max_ephemeral_per_session *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"max_ephemeral_per_session", tmp_str.len = sizeof("max_ephemeral_per_session") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).caps_report_max_ephemeral_per_session)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_caps_report(
		zcbor_state_t *state, const struct caps_report *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"orchestrate_max_depth", tmp_str.len = sizeof("orchestrate_max_depth") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).caps_report_orchestrate_max_depth))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"orchestrate_max_fanout", tmp_str.len = sizeof("orchestrate_max_fanout") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).caps_report_orchestrate_max_fanout))))
	&& (!(*input).caps_report_max_composed_profiles_present || encode_repeated_caps_report_max_composed_profiles(state, (&(*input).caps_report_max_composed_profiles)))
	&& (!(*input).caps_report_max_ephemeral_per_session_present || encode_repeated_caps_report_max_ephemeral_per_session(state, (&(*input).caps_report_max_ephemeral_per_session)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_response_caps(
		zcbor_state_t *state, const struct response_caps *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Caps", tmp_str.len = sizeof("Caps") - 1, &tmp_str)))))
	&& (encode_caps_report(state, (&(*input).response_caps_Caps))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_chat_route_page_next(
		zcbor_state_t *state, const struct chat_route_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).chat_route_page_next_choice == chat_route_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).chat_route_page_next_tstr))))
	: (((*input).chat_route_page_next_choice == chat_route_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_chat_route_page(
		zcbor_state_t *state, const struct chat_route_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).chat_route_page_items_chat_route_m_count, (zcbor_encoder_t *)encode_chat_route, state, (*&(*input).chat_route_page_items_chat_route_m), sizeof(struct chat_route))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).chat_route_page_next_present || encode_repeated_chat_route_page_next(state, (&(*input).chat_route_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_chat_routes *input)
{
	...
	&& (encode_chat_route_page(state, (&(*input).response_chat_routes_ChatRoutes))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_room_page_next(
		zcbor_state_t *state, const struct room_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).room_page_next_choice == room_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).room_page_next_tstr))))
	: (((*input).room_page_next_choice == room_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_room_page(
		zcbor_state_t *state, const struct room_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).room_page_items_room_info_m_count, (zcbor_encoder_t *)encode_room_info, state, (*&(*input).room_page_items_room_info_m), sizeof(struct room_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).room_page_next_present || encode_repeated_room_page_next(state, (&(*input).room_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_rooms *input)
{
	...
	&& (encode_room_page(state, (&(*input).response_rooms_Rooms))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_policy_entry(
		zcbor_state_t *state, const struct policy_entry *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
	...
	&& (zcbor_tstr_encode(state, (&(*input).policy_entry_key))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).policy_entry_label))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"value", tmp_str.len = sizeof("value") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).policy_entry_value))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_adapter_info_policies(
		zcbor_state_t *state, const struct adapter_info_policies_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"policies", tmp_str.len = sizeof("policies") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).adapter_info_policies_policy_entry_m_count, (zcbor_encoder_t *)encode_policy_entry, state, (*&(*input).adapter_info_policies_policy_entry_m), sizeof(struct policy_entry))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_conversation_ops(
		zcbor_state_t *state, const struct conversation_ops *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 8) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"create", tmp_str.len = sizeof("create") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_create))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"join_channel", tmp_str.len = sizeof("join_channel") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_join_channel))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"leave", tmp_str.len = sizeof("leave") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_leave))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"delete", tmp_str.len = sizeof("delete") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_delete))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"send", tmp_str.len = sizeof("send") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_send))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"set_topic", tmp_str.len = sizeof("set_topic") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_set_topic))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"set_title", tmp_str.len = sizeof("set_title") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_set_title))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"set_description", tmp_str.len = sizeof("set_description") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).conversation_ops_set_description))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 8))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_adapter_info_conversation_ops(
		zcbor_state_t *state, const struct adapter_info_conversation_ops_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conversation_ops", tmp_str.len = sizeof("conversation_ops") - 1, &tmp_str)))))
	&& (((*input).adapter_info_conversation_ops_choice == adapter_info_conversation_ops_conversation_ops_m_c) ? ((encode_conversation_ops(state, (&(*input).adapter_info_conversation_ops_conversation_ops_m))))
	: (((*input).adapter_info_conversation_ops_choice == adapter_info_conversation_ops_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_membership_ops(
		zcbor_state_t *state, const struct membership_ops *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"invite", tmp_str.len = sizeof("invite") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).membership_ops_invite))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"remove", tmp_str.len = sizeof("remove") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).membership_ops_remove))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ban", tmp_str.len = sizeof("ban") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).membership_ops_ban))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"set_role", tmp_str.len = sizeof("set_role") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).membership_ops_set_role))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_adapter_info_membership_ops(
		zcbor_state_t *state, const struct adapter_info_membership_ops_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"membership_ops", tmp_str.len = sizeof("membership_ops") - 1, &tmp_str)))))
	&& (((*input).adapter_info_membership_ops_choice == adapter_info_membership_ops_membership_ops_m_c) ? ((encode_membership_ops(state, (&(*input).adapter_info_membership_ops_membership_ops_m))))
	: (((*input).adapter_info_membership_ops_choice == adapter_info_membership_ops_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_contacts_ops(
		zcbor_state_t *state, const struct contacts_ops *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"get_profile", tmp_str.len = sizeof("get_profile") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).contacts_ops_get_profile))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"action_menu", tmp_str.len = sizeof("action_menu") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).contacts_ops_action_menu))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"set_alias", tmp_str.len = sizeof("set_alias") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).contacts_ops_set_alias))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_adapter_info_contacts_ops(
		zcbor_state_t *state, const struct adapter_info_contacts_ops_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"contacts_ops", tmp_str.len = sizeof("contacts_ops") - 1, &tmp_str)))))
	&& (((*input).adapter_info_contacts_ops_choice == adapter_info_contacts_ops_contacts_ops_m_c) ? ((encode_contacts_ops(state, (&(*input).adapter_info_contacts_ops_contacts_ops_m))))
	: (((*input).adapter_info_contacts_ops_choice == adapter_info_contacts_ops_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_roster_ops(
		zcbor_state_t *state, const struct roster_ops *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;
...
static bool encode_repeated_adapter_info_roster_ops(
		zcbor_state_t *state, const struct adapter_info_roster_ops_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"roster_ops", tmp_str.len = sizeof("roster_ops") - 1, &tmp_str)))))
	&& (((*input).adapter_info_roster_ops_choice == adapter_info_roster_ops_roster_ops_m_c) ? ((encode_roster_ops(state, (&(*input).adapter_info_roster_ops_roster_ops_m))))
	: (((*input).adapter_info_roster_ops_choice == adapter_info_roster_ops_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_adapter_info_directory(
		zcbor_state_t *state, const struct adapter_info_directory *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"directory", tmp_str.len = sizeof("directory") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).adapter_info_directory)))));
		...
		zcbor_state_t *state, const struct adapter_info *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 10) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"family", tmp_str.len = sizeof("family") - 1, &tmp_str)))))
	...
	&& (!(*input).adapter_info_account_schema_present || encode_repeated_adapter_info_account_schema(state, (&(*input).adapter_info_account_schema)))
	&& (!(*input).adapter_info_policies_present || encode_repeated_adapter_info_policies(state, (&(*input).adapter_info_policies)))
	&& (!(*input).adapter_info_conversation_ops_present || encode_repeated_adapter_info_conversation_ops(state, (&(*input).adapter_info_conversation_ops)))
	&& (!(*input).adapter_info_membership_ops_present || encode_repeated_adapter_info_membership_ops(state, (&(*input).adapter_info_membership_ops)))
	&& (!(*input).adapter_info_contacts_ops_present || encode_repeated_adapter_info_contacts_ops(state, (&(*input).adapter_info_contacts_ops)))
	&& (!(*input).adapter_info_roster_ops_present || encode_repeated_adapter_info_roster_ops(state, (&(*input).adapter_info_roster_ops)))
	&& (!(*input).adapter_info_directory_present || encode_repeated_adapter_info_directory(state, (&(*input).adapter_info_directory)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 10))));
...
static bool encode_repeated_transport_instance_info_reason(
		zcbor_state_t *state, const struct transport_instance_info_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (((*input).transport_instance_info_reason_choice == transport_instance_info_reason_disconnect_reason_m_c) ? ((encode_disconnect_reason(state, (&(*input).transport_instance_info_reason_disconnect_reason_m))))
	: (((*input).transport_instance_info_reason_choice == transport_instance_info_reason_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_transport_instance_info_message(
		zcbor_state_t *state, const struct transport_instance_info_message_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (((*input).transport_instance_info_message_choice == transport_instance_info_message_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).transport_instance_info_message_tstr))))
	: (((*input).transport_instance_info_message_choice == transport_instance_info_message_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_transport_instance_info_fatal(
		zcbor_state_t *state, const struct transport_instance_info_fatal *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"fatal", tmp_str.len = sizeof("fatal") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).transport_instance_info_fatal)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_transport_instance_info_enabled(
		zcbor_state_t *state, const struct transport_instance_info_enabled *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).transport_instance_info_enabled)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_transport_instance_info_label(
		zcbor_state_t *state, const struct transport_instance_info_label_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"label", tmp_str.len = sizeof("label") - 1, &tmp_str)))))
	&& (((*input).transport_instance_info_label_choice == transport_instance_info_label_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).transport_instance_info_label_tstr))))
	: (((*input).transport_instance_info_label_choice == transport_instance_info_label_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct transport_instance_info *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 11) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	...
	&& (!(*input).transport_instance_info_bound_profile_present || encode_repeated_transport_instance_info_bound_profile(state, (&(*input).transport_instance_info_bound_profile)))
	&& (!(*input).transport_instance_info_reason_present || encode_repeated_transport_instance_info_reason(state, (&(*input).transport_instance_info_reason)))
	&& (!(*input).transport_instance_info_message_present || encode_repeated_transport_instance_info_message(state, (&(*input).transport_instance_info_message)))
	&& (!(*input).transport_instance_info_fatal_present || encode_repeated_transport_instance_info_fatal(state, (&(*input).transport_instance_info_fatal)))
	&& (!(*input).transport_instance_info_enabled_present || encode_repeated_transport_instance_info_enabled(state, (&(*input).transport_instance_info_enabled)))
	&& (!(*input).transport_instance_info_label_present || encode_repeated_transport_instance_info_label(state, (&(*input).transport_instance_info_label)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 11))));
		...
		zcbor_state_t *state, const struct conversation_type_r *input)
{
	...
	: (((*input).conversation_type_choice == conversation_type_Space_tstr_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Space", tmp_str.len = sizeof("Space") - 1, &tmp_str)))))
	: false))))))));
...
static bool encode_repeated_conversation_info_parent(
		zcbor_state_t *state, const struct conversation_info_parent_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"parent", tmp_str.len = sizeof("parent") - 1, &tmp_str)))))
	&& (((*input).conversation_info_parent_choice == conversation_info_parent_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).conversation_info_parent_tstr))))
	: (((*input).conversation_info_parent_choice == conversation_info_parent_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct conversation_info *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 8) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	...
	&& (!(*input).conversation_info_members_present || encode_repeated_conversation_info_members(state, (&(*input).conversation_info_members)))
	&& (!(*input).conversation_info_parent_present || encode_repeated_conversation_info_parent(state, (&(*input).conversation_info_parent)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 8))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_conv_page_next(
		zcbor_state_t *state, const struct conv_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).conv_page_next_choice == conv_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).conv_page_next_tstr))))
	: (((*input).conv_page_next_choice == conv_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_conv_page(
		zcbor_state_t *state, const struct conv_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).conv_page_items_conversation_info_m_count, (zcbor_encoder_t *)encode_conversation_info, state, (*&(*input).conv_page_items_conversation_info_m), sizeof(struct conversation_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).conv_page_next_present || encode_repeated_conv_page_next(state, (&(*input).conv_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_conversations *input)
{
	...
	&& (encode_conv_page(state, (&(*input).response_conversations_Conversations))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_fs_list_page_next(
		zcbor_state_t *state, const struct fs_list_page_next_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next", tmp_str.len = sizeof("next") - 1, &tmp_str)))))
	&& (((*input).fs_list_page_next_choice == fs_list_page_next_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).fs_list_page_next_tstr))))
	: (((*input).fs_list_page_next_choice == fs_list_page_next_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_fs_list_page(
		zcbor_state_t *state, const struct fs_list_page *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"items", tmp_str.len = sizeof("items") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 64) && ((zcbor_multi_encode_minmax(0, 64, &(*input).fs_list_page_items_fs_entry_m_count, (zcbor_encoder_t *)encode_fs_entry, state, (*&(*input).fs_list_page_items_fs_entry_m), sizeof(struct fs_entry))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 64)))
	&& (!(*input).fs_list_page_next_present || encode_repeated_fs_list_page_next(state, (&(*input).fs_list_page_next)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_fs_list *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"FsList", tmp_str.len = sizeof("FsList") - 1, &tmp_str)))))
	&& (encode_fs_list_page(state, (&(*input).response_fs_list_FsList))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_feedback_ack(
		zcbor_state_t *state, const struct feedback_ack *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"accepted", tmp_str.len = sizeof("accepted") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).feedback_ack_accepted))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"queued", tmp_str.len = sizeof("queued") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).feedback_ack_queued))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_response_feedback_ack(
		zcbor_state_t *state, const struct response_feedback_ack *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"FeedbackAck", tmp_str.len = sizeof("FeedbackAck") - 1, &tmp_str)))))
	&& (encode_feedback_ack(state, (&(*input).response_feedback_ack_FeedbackAck))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_response_telemetry_consent(
		zcbor_state_t *state, const struct response_telemetry_consent *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TelemetryConsent", tmp_str.len = sizeof("TelemetryConsent") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"enabled", tmp_str.len = sizeof("enabled") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).TelemetryConsent_enabled))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_response_transport_settings(
		zcbor_state_t *state, const struct response_transport_settings *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"TransportSettings", tmp_str.len = sizeof("TransportSettings") - 1, &tmp_str)))))
	&& (encode_account_settings_values(state, (&(*input).response_transport_settings_TransportSettings))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct api_response_r *input)
{
	...
	: (((*input).api_response_choice == api_response_response_fingerprints_m_c) ? ((encode_response_fingerprints(state, (&(*input).api_response_response_fingerprints_m))))
	...
	: (((*input).api_response_choice == api_response_response_soul_text_m_c) ? ((encode_response_soul_text(state, (&(*input).api_response_response_soul_text_m))))
	...
	: (((*input).api_response_choice == api_response_response_session_recap_m_c) ? ((encode_response_session_recap(state, (&(*input).api_response_response_session_recap_m))))
	: (((*input).api_response_choice == api_response_response_agent_catalog_m_c) ? ((encode_response_agent_catalog(state, (&(*input).api_response_response_agent_catalog_m))))
	...
	: (((*input).api_response_choice == api_response_response_gateway_status_m_c) ? ((encode_response_gateway_status(state, (&(*input).api_response_response_gateway_status_m))))
	: (((*input).api_response_choice == api_response_response_caps_m_c) ? ((encode_response_caps(state, (&(*input).api_response_response_caps_m))))
		...
		zcbor_state_t *state, const struct api_request_r *input)
{
	...
	: (((*input).api_request_choice == api_request_request_tree_m_c) ? ((encode_request_tree(state, (&(*input).api_request_request_tree_m))))
	...
	: (((*input).api_request_choice == api_request_request_fingerprint_list_m_c) ? ((encode_request_fingerprint_list(state, (&(*input).api_request_request_fingerprint_list_m))))
	: (((*input).api_request_choice == api_request_request_fingerprint_revoke_m_c) ? ((encode_request_fingerprint_revoke(state, (&(*input).api_request_request_fingerprint_revoke_m))))
	...
	: (((*input).api_request_choice == api_request_request_soul_get_m_c) ? ((encode_request_soul_get(state, (&(*input).api_request_request_soul_get_m))))
	: (((*input).api_request_choice == api_request_request_soul_set_m_c) ? ((encode_request_soul_set(state, (&(*input).api_request_request_soul_set_m))))
	...
	: (((*input).api_request_choice == api_request_request_credential_set_label_m_c) ? ((encode_request_credential_set_label(state, (&(*input).api_request_request_credential_set_label_m))))
	...
	: (((*input).api_request_choice == api_request_request_models_m_c) ? ((encode_request_models(state, (&(*input).api_request_request_models_m))))
	...
	: (((*input).api_request_choice == api_request_request_session_recap_m_c) ? ((encode_request_session_recap(state, (&(*input).api_request_request_session_recap_m))))
	...
	: (((*input).api_request_choice == api_request_request_agent_discover_m_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"AgentDiscover", tmp_str.len = sizeof("AgentDiscover") - 1, &tmp_str)))))
	: (((*input).api_request_choice == api_request_request_agent_catalog_m_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"AgentCatalog", tmp_str.len = sizeof("AgentCatalog") - 1, &tmp_str)))))
	: (((*input).api_request_choice == api_request_request_agent_register_m_c) ? ((encode_request_agent_register(state, (&(*input).api_request_request_agent_register_m))))
	: (((*input).api_request_choice == api_request_request_agent_remove_m_c) ? ((encode_request_agent_remove(state, (&(*input).api_request_request_agent_remove_m))))
	...
	: (((*input).api_request_choice == api_request_request_tool_set_enabled_m_c) ? ((encode_request_tool_set_enabled(state, (&(*input).api_request_request_tool_set_enabled_m))))
	...
	: (((*input).api_request_choice == api_request_request_caps_m_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Caps", tmp_str.len = sizeof("Caps") - 1, &tmp_str)))))
	...
	: (((*input).api_request_choice == api_request_request_gateway_get_m_c) ? ((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"GatewayGet", tmp_str.len = sizeof("GatewayGet") - 1, &tmp_str)))))
	: (((*input).api_request_choice == api_request_request_gateway_set_m_c) ? ((encode_request_gateway_set(state, (&(*input).api_request_request_gateway_set_m))))
	...
	: (((*input).api_request_choice == api_request_request_routing_list_chats_m_c) ? ((encode_request_routing_list_chats(state, (&(*input).api_request_request_routing_list_chats_m))))
	...
	: (((*input).api_request_choice == api_request_request_transport_disconnect_m_c) ? ((encode_request_transport_disconnect(state, (&(*input).api_request_request_transport_disconnect_m))))
	: (((*input).api_request_choice == api_request_request_transport_remove_m_c) ? ((encode_request_transport_remove(state, (&(*input).api_request_request_transport_remove_m))))
	: (((*input).api_request_choice == api_request_request_transport_connect_m_c) ? ((encode_request_transport_connect(state, (&(*input).api_request_request_transport_connect_m))))
	: (((*input).api_request_choice == api_request_request_transport_set_enabled_m_c) ? ((encode_request_transport_set_enabled(state, (&(*input).api_request_request_transport_set_enabled_m))))
	: (((*input).api_request_choice == api_request_request_transport_set_label_m_c) ? ((encode_request_transport_set_label(state, (&(*input).api_request_request_transport_set_label_m))))
