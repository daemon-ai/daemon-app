...
static bool encode_byte_array(zcbor_state_t *state, const struct byte_array *input);
...
static bool encode_request_profile_create(zcbor_state_t *state, const void *input);
static bool encode_request_profile_update(zcbor_state_t *state, const void *input);
...
static bool encode_repeated_ConvSend_from(zcbor_state_t *state, const struct ConvSend_from_r *input);
...
static bool encode_repeated_ConvHistory_after_cursor(zcbor_state_t *state, const struct ConvHistory_after_cursor *input);
static bool encode_repeated_ConvHistory_max(zcbor_state_t *state, const struct ConvHistory_max *input);
static bool encode_request_conv_history(zcbor_state_t *state, const struct request_conv_history *input);
static bool encode_repeated_MemberInvite_message(zcbor_state_t *state, const struct MemberInvite_message_r *input);
static bool encode_request_member_invite(zcbor_state_t *state, const struct request_member_invite *input);
static bool encode_repeated_MemberRemove_reason(zcbor_state_t *state, const struct MemberRemove_reason_r *input);
static bool encode_request_member_remove(zcbor_state_t *state, const struct request_member_remove *input);
static bool encode_repeated_MemberBan_reason(zcbor_state_t *state, const struct MemberBan_reason_r *input);
...
static bool encode_repeated_FsWrite_base_revision(zcbor_state_t *state, const struct FsWrite_base_revision_r *input);
static bool encode_repeated_FsWrite_force(zcbor_state_t *state, const struct FsWrite_force *input);
...
static bool encode_repeated_FsWriteFromBlob_base_revision(zcbor_state_t *state, const struct FsWriteFromBlob_base_revision_r *input);
static bool encode_repeated_FsWriteFromBlob_force(zcbor_state_t *state, const struct FsWriteFromBlob_force *input);
...
static bool encode_response_profile(zcbor_state_t *state, const void *input);
...
static bool encode_byte_array(
		zcbor_state_t *state, const struct byte_array *input)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).byte_array_uint_count, (zcbor_encoder_t *)zcbor_uint32_encode, state, (*&(*input).byte_array_uint), sizeof(uint32_t))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct blob_ref *input)
{
	...
	&& (encode_byte_array(state, (&(*input).blob_ref_hash))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"size", tmp_str.len = sizeof("size") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).blob_ref_size))))
		...
		zcbor_state_t *state, const struct agent_command_observe *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Observe_request_id))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct agent_command_snapshot *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).Snapshot_request_id))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct rewind_anchor_user_turn *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).UserTurn_ordinal))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct rewind_anchor_reply_after *input)
{
	...
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ordinal", tmp_str.len = sizeof("ordinal") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ReplyAfter_ordinal))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct rewind_anchor_cursor *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).Cursor_seq))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct agent_command_rewind_to *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).RewindTo_request_id))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct host_response *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).host_response_request_id))))
		...
		zcbor_state_t *state, const struct request_session_history *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).SessionHistory_after_cursor))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct request_record_meta *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"session", tmp_str.len = sizeof("session") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).RecordMeta_session))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"origin", tmp_str.len = sizeof("origin") - 1, &tmp_str)))))
	&& (encode_origin(state, (&(*input).RecordMeta_origin))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).RecordMeta_kind))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"body", tmp_str.len = sizeof("body") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).RecordMeta_body))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_unit_history *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after_cursor", tmp_str.len = sizeof("after_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).UnitHistory_after_cursor))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct tools_override_allowlist *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).tools_override_allowlist_allowlist_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).tools_override_allowlist_allowlist_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const void *input)
{
	...
	&& (zcbor_nil_put(state, NULL)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct skill_bundle *input)
{
	...
	&& (zcbor_map_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).files_tstrtstr_count, (zcbor_encoder_t *)encode_repeated_files_tstrtstr, state, (*&(*input).files_tstrtstr), sizeof(struct files_tstrtstr))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));
		...
		zcbor_state_t *state, const struct distribution_head_seq_r *input)
{
	...
	&& (((*input).distribution_head_seq_choice == distribution_head_seq_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).distribution_head_seq_uint))))
		...
		zcbor_state_t *state, const struct distribution *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).distribution_skills_skill_bundle_m_count, (zcbor_encoder_t *)encode_skill_bundle, state, (*&(*input).distribution_skills_skill_bundle_m), sizeof(struct skill_bundle))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
		...
		zcbor_state_t *state, const struct request_profile_at *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).ProfileAt_seq))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_profile_revert *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ProfileRevert_seq))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_skill_at *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).SkillAt_seq))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_skill_revert *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).SkillRevert_seq))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_model_cancel *input)
{
	...
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ModelCancel_id))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_model_pause *input)
{
	...
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ModelPause_id))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_model_resume *input)
{
	...
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ModelResume_id))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_model_recommend *input)
{
	...
	&& (zcbor_tstr_encode(state, (&(*input).ModelRecommend_repo))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"revision", tmp_str.len = sizeof("revision") - 1, &tmp_str)))))
	&& (((*input).ModelRecommend_revision_choice == ModelRecommend_revision_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ModelRecommend_revision_tstr))))
	: (((*input).ModelRecommend_revision_choice == ModelRecommend_revision_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"engine", tmp_str.len = sizeof("engine") - 1, &tmp_str)))))
	&& (encode_model_engine(state, (&(*input).ModelRecommend_engine))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"budget_bytes", tmp_str.len = sizeof("budget_bytes") - 1, &tmp_str)))))
	&& (((*input).ModelRecommend_budget_bytes_choice == ModelRecommend_budget_bytes_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).ModelRecommend_budget_bytes_uint))))
	: (((*input).ModelRecommend_budget_bytes_choice == ModelRecommend_budget_bytes_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_model_quantize *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"repo", tmp_str.len = sizeof("repo") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ModelQuantize_repo))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"revision", tmp_str.len = sizeof("revision") - 1, &tmp_str)))))
	&& (((*input).ModelQuantize_revision_choice == ModelQuantize_revision_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ModelQuantize_revision_tstr))))
	: (((*input).ModelQuantize_revision_choice == ModelQuantize_revision_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"target_quant", tmp_str.len = sizeof("target_quant") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ModelQuantize_target_quant))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"source_file", tmp_str.len = sizeof("source_file") - 1, &tmp_str)))))
	&& (((*input).ModelQuantize_source_file_choice == ModelQuantize_source_file_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).ModelQuantize_source_file_tstr))))
	: (((*input).ModelQuantize_source_file_choice == ModelQuantize_source_file_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct auth_begin_request *input)
{
	...
	&& (zcbor_map_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).params_tstrtstr_count, (zcbor_encoder_t *)encode_repeated_params_tstrtstr, state, (*&(*input).params_tstrtstr), sizeof(struct params_tstrtstr))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 16)))
		...
		zcbor_state_t *state, const struct acp_recipe_args_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).acp_recipe_args_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).acp_recipe_args_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct acp_recipe_env_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).acp_recipe_env_kv_pair_m_count, (zcbor_encoder_t *)encode_kv_pair, state, (*&(*input).acp_recipe_env_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct acp_agent_entry_capabilities_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).acp_agent_entry_capabilities_kv_pair_m_count, (zcbor_encoder_t *)encode_kv_pair, state, (*&(*input).acp_agent_entry_capabilities_kv_pair_m), sizeof(struct kv_pair))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct cron_spec_payload *input)
{
	...
	&& (encode_byte_array(state, (&(*input).cron_spec_payload)))));
		...
		zcbor_state_t *state, const struct cron_spec_context_from_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).cron_spec_context_from_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).cron_spec_context_from_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct cron_spec_enabled_toolsets_r *input)
{
	...
	&& (((*input).cron_spec_enabled_toolsets_choice == enabled_toolsets_tstr_l_c) ? ((zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).enabled_toolsets_tstr_l_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).enabled_toolsets_tstr_l_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
		...
		zcbor_state_t *state, const struct cron_spec_skills_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).cron_spec_skills_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).cron_spec_skills_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct presence_idle_since_r *input)
{
	...
	&& (((*input).presence_idle_since_choice == presence_idle_since_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).presence_idle_since_uint))))
		...
		zcbor_state_t *state, const struct account_settings_schema_fields_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).account_settings_schema_fields_auth_param_field_m_count, (zcbor_encoder_t *)encode_auth_param_field, state, (*&(*input).account_settings_schema_fields_auth_param_field_m), sizeof(struct auth_param_field))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct account_settings_values_values_r *input)
{
	...
	&& (zcbor_map_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).values_tstrtstr_count, (zcbor_encoder_t *)encode_repeated_values_tstrtstr, state, (*&(*input).values_tstrtstr), sizeof(struct values_tstrtstr))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 16))));
...
static bool encode_repeated_ConvSend_from(
		zcbor_state_t *state, const struct ConvSend_from_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"from", tmp_str.len = sizeof("from") - 1, &tmp_str)))))
	&& (((*input).ConvSend_from_choice == ConvSend_from_participant_m_c) ? ((encode_participant(state, (&(*input).ConvSend_from_participant_m))))
	: (((*input).ConvSend_from_choice == ConvSend_from_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_conv_send *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ConvSend_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ConvSend_conv))))
	&& (!(*input).ConvSend_from_present || encode_repeated_ConvSend_from(state, (&(*input).ConvSend_from)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (encode_user_msg(state, (&(*input).ConvSend_message))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
...
static bool encode_repeated_ConvHistory_after_cursor(
		zcbor_state_t *state, const struct ConvHistory_after_cursor *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after_cursor", tmp_str.len = sizeof("after_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ConvHistory_after_cursor)))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_ConvHistory_max(
		zcbor_state_t *state, const struct ConvHistory_max *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ConvHistory_max)))));
		...
		zcbor_state_t *state, const struct request_conv_history *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ConvHistory_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ConvHistory_conv))))
	&& (!(*input).ConvHistory_after_cursor_present || encode_repeated_ConvHistory_after_cursor(state, (&(*input).ConvHistory_after_cursor)))
	&& (!(*input).ConvHistory_max_present || encode_repeated_ConvHistory_max(state, (&(*input).ConvHistory_max)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_MemberInvite_message(
		zcbor_state_t *state, const struct MemberInvite_message_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"message", tmp_str.len = sizeof("message") - 1, &tmp_str)))))
	&& (((*input).MemberInvite_message_choice == MemberInvite_message_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).MemberInvite_message_tstr))))
	: (((*input).MemberInvite_message_choice == MemberInvite_message_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_member_invite *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberInvite_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberInvite_conv))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (encode_participant(state, (&(*input).MemberInvite_who))))
	&& (!(*input).MemberInvite_message_present || encode_repeated_MemberInvite_message(state, (&(*input).MemberInvite_message)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_MemberRemove_reason(
		zcbor_state_t *state, const struct MemberRemove_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (((*input).MemberRemove_reason_choice == MemberRemove_reason_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).MemberRemove_reason_tstr))))
	: (((*input).MemberRemove_reason_choice == MemberRemove_reason_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_member_remove *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberRemove_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberRemove_conv))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (encode_participant(state, (&(*input).MemberRemove_who))))
	&& (!(*input).MemberRemove_reason_present || encode_repeated_MemberRemove_reason(state, (&(*input).MemberRemove_reason)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_MemberBan_reason(
		zcbor_state_t *state, const struct MemberBan_reason_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"reason", tmp_str.len = sizeof("reason") - 1, &tmp_str)))))
	&& (((*input).MemberBan_reason_choice == MemberBan_reason_tstr_c) ? ((zcbor_tstr_encode(state, (&(*input).MemberBan_reason_tstr))))
	: (((*input).MemberBan_reason_choice == MemberBan_reason_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
		...
		zcbor_state_t *state, const struct request_member_ban *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberBan_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberBan_conv))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (encode_participant(state, (&(*input).MemberBan_who))))
	&& (!(*input).MemberBan_reason_present || encode_repeated_MemberBan_reason(state, (&(*input).MemberBan_reason)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_member_set_role *input)
{
	...
	&& (zcbor_map_start_encode(state, 4) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"transport", tmp_str.len = sizeof("transport") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberSetRole_transport))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"conv", tmp_str.len = sizeof("conv") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).MemberSetRole_conv))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"who", tmp_str.len = sizeof("who") - 1, &tmp_str)))))
	&& (encode_participant(state, (&(*input).MemberSetRole_who))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"role", tmp_str.len = sizeof("role") - 1, &tmp_str)))))
	&& (encode_member_role(state, (&(*input).MemberSetRole_role))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct FsRead_max_bytes *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).FsRead_max_bytes)))));
...
static bool encode_repeated_FsWrite_base_revision(
		zcbor_state_t *state, const struct FsWrite_base_revision_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"base_revision", tmp_str.len = sizeof("base_revision") - 1, &tmp_str)))))
	&& (((*input).FsWrite_base_revision_choice == FsWrite_base_revision_fs_revision_m_c) ? ((encode_fs_revision(state, (&(*input).FsWrite_base_revision_fs_revision_m))))
	: (((*input).FsWrite_base_revision_choice == FsWrite_base_revision_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_FsWrite_force(
		zcbor_state_t *state, const struct FsWrite_force *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"force", tmp_str.len = sizeof("force") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).FsWrite_force)))));
		...
		zcbor_state_t *state, const struct request_fs_write *input)
{
	...
	&& (zcbor_map_start_encode(state, 5) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"root", tmp_str.len = sizeof("root") - 1, &tmp_str)))))
	&& (encode_fs_root_id_t(state, (&(*input).FsWrite_root))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"path", tmp_str.len = sizeof("path") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).FsWrite_path))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"bytes", tmp_str.len = sizeof("bytes") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).FsWrite_bytes))))
	&& (!(*input).FsWrite_base_revision_present || encode_repeated_FsWrite_base_revision(state, (&(*input).FsWrite_base_revision)))
	&& (!(*input).FsWrite_force_present || encode_repeated_FsWrite_force(state, (&(*input).FsWrite_force)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 5)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_fs_watch_poll *input)
{
	...
	&& (encode_fs_root_id_t(state, (&(*input).FsWatchPoll_root))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"dir", tmp_str.len = sizeof("dir") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).FsWatchPoll_dir))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"after_seq", tmp_str.len = sizeof("after_seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).FsWatchPoll_after_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"max", tmp_str.len = sizeof("max") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).FsWatchPoll_max))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct request_blob_put *input)
{
	...
	&& (encode_byte_array(state, (&(*input).BlobPut_bytes))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct byte_range *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).byte_range_offset))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"len", tmp_str.len = sizeof("len") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).byte_range_len))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct request_blob_get *input)
{
	...
	&& (encode_byte_array(state, (&(*input).BlobGet_hash))))
		...
		zcbor_state_t *state, const struct request_blob_stat *input)
{
	...
	&& (encode_byte_array(state, (&(*input).BlobStat_hash))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));

	log_result(state, res, __func__);
	return res;
}

static bool encode_repeated_FsWriteFromBlob_base_revision(
		zcbor_state_t *state, const struct FsWriteFromBlob_base_revision_r *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"base_revision", tmp_str.len = sizeof("base_revision") - 1, &tmp_str)))))
	&& (((*input).FsWriteFromBlob_base_revision_choice == FsWriteFromBlob_base_revision_fs_revision_m_c) ? ((encode_fs_revision(state, (&(*input).FsWriteFromBlob_base_revision_fs_revision_m))))
	: (((*input).FsWriteFromBlob_base_revision_choice == FsWriteFromBlob_base_revision_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false))));
...
static bool encode_repeated_FsWriteFromBlob_force(
		zcbor_state_t *state, const struct FsWriteFromBlob_force *input)
{
	zcbor_log("%s\r\n", __func__);
	struct zcbor_string tmp_str;

	bool res = ((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"force", tmp_str.len = sizeof("force") - 1, &tmp_str)))))
	&& (zcbor_bool_encode(state, (&(*input).FsWriteFromBlob_force)))));
		...
		zcbor_state_t *state, const struct request_fs_write_from_blob *input)
{
	...
	&& (zcbor_map_start_encode(state, 5) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"root", tmp_str.len = sizeof("root") - 1, &tmp_str)))))
	&& (encode_fs_root_id_t(state, (&(*input).FsWriteFromBlob_root))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"path", tmp_str.len = sizeof("path") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).FsWriteFromBlob_path))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"hash", tmp_str.len = sizeof("hash") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).FsWriteFromBlob_hash))))
	&& (!(*input).FsWriteFromBlob_base_revision_present || encode_repeated_FsWriteFromBlob_base_revision(state, (&(*input).FsWriteFromBlob_base_revision)))
	&& (!(*input).FsWriteFromBlob_force_present || encode_repeated_FsWriteFromBlob_force(state, (&(*input).FsWriteFromBlob_force)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 5)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct agent_event_turn_started *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).TurnStarted_seq))))
		...
		zcbor_state_t *state, const struct agent_event_text_delta *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).TextDelta_seq))))
		...
		zcbor_state_t *state, const struct agent_event_reasoning_delta *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ReasoningDelta_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"text", tmp_str.len = sizeof("text") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct agent_event_content_delta *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).ContentDelta_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
	&& (zcbor_tstr_encode(state, (&(*input).ContentDelta_kind))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"body", tmp_str.len = sizeof("body") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).ContentDelta_body))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct tool_detail *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"body", tmp_str.len = sizeof("body") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).tool_detail_body))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct agent_event_tool_started *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ToolStarted_seq))))
		...
		zcbor_state_t *state, const struct agent_event_tool_finished *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).ToolFinished_seq))))
		...
		zcbor_state_t *state, const struct usage_delta *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).usage_delta_input_tokens))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"output_tokens", tmp_str.len = sizeof("output_tokens") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).usage_delta_output_tokens))))
		...
		zcbor_state_t *state, const struct agent_event_usage *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Usage_seq))))
		...
		zcbor_state_t *state, const struct context_status *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).context_status_used_tokens))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"max_tokens", tmp_str.len = sizeof("max_tokens") - 1, &tmp_str)))))
	&& (((*input).context_status_max_tokens_choice == context_status_max_tokens_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).context_status_max_tokens_uint))))
	...
	&& (((*input).context_status_budget_tokens_choice == context_status_budget_tokens_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).context_status_budget_tokens_uint))))
		...
		zcbor_state_t *state, const struct agent_event_context *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Context_seq))))
		...
		zcbor_state_t *state, const struct rate_limit_snapshot *input)
{
	...
	&& (((*input).rate_limit_snapshot_remaining_choice == rate_limit_snapshot_remaining_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).rate_limit_snapshot_remaining_uint))))
	: (((*input).rate_limit_snapshot_remaining_choice == rate_limit_snapshot_remaining_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"limit", tmp_str.len = sizeof("limit") - 1, &tmp_str)))))
	&& (((*input).rate_limit_snapshot_limit_choice == rate_limit_snapshot_limit_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).rate_limit_snapshot_limit_uint))))
	...
	&& (((*input).rate_limit_snapshot_reset_ms_choice == rate_limit_snapshot_reset_ms_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).rate_limit_snapshot_reset_ms_uint))))
		...
		zcbor_state_t *state, const struct agent_event_rate_limit *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).RateLimit_seq))))
		...
		zcbor_state_t *state, const struct agent_event_turn_finished *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).TurnFinished_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"summary", tmp_str.len = sizeof("summary") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct agent_event_error *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Error_seq))))
		...
		zcbor_state_t *state, const struct agent_event_steered *input)
{
	...
	&& (zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Steered_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Steered_request_id))))
		...
		zcbor_state_t *state, const struct conv_turn_view *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).conv_turn_view_tools_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).conv_turn_view_tools_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));
		...
		zcbor_state_t *state, const struct conv_view *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).conv_view_epoch))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"turns", tmp_str.len = sizeof("turns") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).conv_view_turns_conv_turn_view_m_count, (zcbor_encoder_t *)encode_conv_turn_view, state, (*&(*input).conv_view_turns_conv_turn_view_m), sizeof(struct conv_turn_view))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"waiting_for", tmp_str.len = sizeof("waiting_for") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).conv_view_waiting_for_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).conv_view_waiting_for_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 3))));
		...
		zcbor_state_t *state, const struct agent_event_snapshot *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Snapshot", tmp_str.len = sizeof("Snapshot") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Snapshot_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Snapshot_request_id))))
		...
		zcbor_state_t *state, const struct agent_event_rewound *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).Rewound_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Rewound_request_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"to_cursor", tmp_str.len = sizeof("to_cursor") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Rewound_to_cursor))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"epoch", tmp_str.len = sizeof("epoch") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Rewound_epoch))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct budget *input)
{
	...
	&& (((*input).budget_tokens_choice == budget_tokens_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).budget_tokens_uint))))
	...
	&& (((*input).budget_wall_ms_choice == budget_wall_ms_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).budget_wall_ms_uint))))
		...
		zcbor_state_t *state, const struct host_request *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"request_id", tmp_str.len = sizeof("request_id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).host_request_request_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct response_drained *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_drained_Drained_outbound_m_count, (zcbor_encoder_t *)encode_outbound, state, (*&(*input).response_drained_Drained_outbound_m), sizeof(struct outbound_r))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct telemetry_dump *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).telemetry_dump_events))))
	...
	&& (zcbor_uint32_encode(state, (&(*input).telemetry_dump_pending_jobs))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"pending_wakes", tmp_str.len = sizeof("pending_wakes") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).telemetry_dump_pending_wakes))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"sessions", tmp_str.len = sizeof("sessions") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).telemetry_dump_sessions))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"active", tmp_str.len = sizeof("active") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).telemetry_dump_active))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 7))));
		...
		zcbor_state_t *state, const struct session_info_last_activity_ms_r *input)
{
	...
	&& (((*input).session_info_last_activity_ms_choice == session_info_last_activity_ms_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).session_info_last_activity_ms_uint))))
		...
		zcbor_state_t *state, const struct response_sessions *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_sessions_Sessions_session_info_m_count, (zcbor_encoder_t *)encode_session_info, state, (*&(*input).response_sessions_Sessions_session_info_m), sizeof(struct session_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct fleet_report *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).fleet_report_children_unit_id_m_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).fleet_report_children_unit_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"usage", tmp_str.len = sizeof("usage") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct unit_node *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).unit_node_children_unit_id_m_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).unit_node_children_unit_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
		...
		zcbor_state_t *state, const struct tree_report *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).tree_report_nodes_unit_node_m_count, (zcbor_encoder_t *)encode_unit_node, state, (*&(*input).tree_report_nodes_unit_node_m), sizeof(struct unit_node))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct manage_event_view_started *input)
{
	...
	&& (zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Started_seq))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct manage_event_view_progress *input)
{
	...
	&& (zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Progress_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"text", tmp_str.len = sizeof("text") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct manage_event_view_finished *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"Finished", tmp_str.len = sizeof("Finished") - 1, &tmp_str)))))
	&& (zcbor_map_start_encode(state, 3) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).Finished_seq))))
		...
		zcbor_state_t *state, const struct manage_event_view_subagent *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).Subagent_seq))))
		...
		zcbor_state_t *state, const struct response_unit_events *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"UnitEvents", tmp_str.len = sizeof("UnitEvents") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_unit_events_UnitEvents_manage_event_view_m_count, (zcbor_encoder_t *)encode_manage_event_view, state, (*&(*input).response_unit_events_UnitEvents_manage_event_view_m), sizeof(struct manage_event_view_r))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct transcript_block_request *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).Request_request_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct transcript_block_content *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"body", tmp_str.len = sizeof("body") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).Content_body))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct journal_record *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).journal_record_cursor))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"segment", tmp_str.len = sizeof("segment") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).journal_record_segment))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"seq", tmp_str.len = sizeof("seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).journal_record_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"epoch", tmp_str.len = sizeof("epoch") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).journal_record_epoch))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"trace", tmp_str.len = sizeof("trace") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).journal_record_trace))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"kind", tmp_str.len = sizeof("kind") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_encode(state, (&(*input).journal_record_timestamp_ms))))
		...
		zcbor_state_t *state, const struct session_payload_meta *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"body", tmp_str.len = sizeof("body") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).Meta_body))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_delivery_targets *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"DeliveryTargets", tmp_str.len = sizeof("DeliveryTargets") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_delivery_targets_DeliveryTargets_delivery_target_m_count, (zcbor_encoder_t *)encode_delivery_target, state, (*&(*input).response_delivery_targets_DeliveryTargets_delivery_target_m), sizeof(struct delivery_target))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_delivery_sessions *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"DeliverySessions", tmp_str.len = sizeof("DeliverySessions") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_delivery_sessions_DeliverySessions_session_id_m_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).response_delivery_sessions_DeliverySessions_session_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct search_hit *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).search_hit_downloads))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"likes", tmp_str.len = sizeof("likes") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).search_hit_likes))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"num_parameters", tmp_str.len = sizeof("num_parameters") - 1, &tmp_str)))))
	&& (((*input).search_hit_num_parameters_choice == search_hit_num_parameters_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).search_hit_num_parameters_uint))))
		...
		zcbor_state_t *state, const struct search_page *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).search_page_results_search_hit_m_count, (zcbor_encoder_t *)encode_search_hit, state, (*&(*input).search_page_results_search_hit_m), sizeof(struct search_hit))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
		...
		zcbor_state_t *state, const struct model_file *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).model_file_size_bytes))))
		...
		zcbor_state_t *state, const struct response_model_files *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ModelFiles", tmp_str.len = sizeof("ModelFiles") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_model_files_ModelFiles_model_file_m_count, (zcbor_encoder_t *)encode_model_file, state, (*&(*input).response_model_files_ModelFiles_model_file_m), sizeof(struct model_file))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_model_download_started *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).response_model_download_started_ModelDownloadStarted))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct download_status *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).download_status_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"model", tmp_str.len = sizeof("model") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_encode(state, (&(*input).download_status_downloaded_bytes))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"total_bytes", tmp_str.len = sizeof("total_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).download_status_total_bytes))))
		...
		zcbor_state_t *state, const struct response_model_downloads *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_model_downloads_ModelDownloads_download_status_m_count, (zcbor_encoder_t *)encode_download_status, state, (*&(*input).response_model_downloads_ModelDownloads_download_status_m), sizeof(struct download_status))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct installed_model *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).installed_model_size_bytes))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"quant", tmp_str.len = sizeof("quant") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_encode(state, (&(*input).installed_model_installed_at_ms))))
		...
		zcbor_state_t *state, const struct response_model_catalog *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_model_catalog_ModelCatalog_installed_model_m_count, (zcbor_encoder_t *)encode_installed_model, state, (*&(*input).response_model_catalog_ModelCatalog_installed_model_m), sizeof(struct installed_model))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct quant_candidate *input)
{
	...
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (((*input).quant_candidate_size_bytes_choice == quant_candidate_size_bytes_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).quant_candidate_size_bytes_uint))))
		...
		zcbor_state_t *state, const struct quant_recommendation *input)
{
	...
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (((*input).quant_recommendation_size_bytes_choice == quant_recommendation_size_bytes_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).quant_recommendation_size_bytes_uint))))
	: (((*input).quant_recommendation_size_bytes_choice == quant_recommendation_size_bytes_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"budget_bytes", tmp_str.len = sizeof("budget_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).quant_recommendation_budget_bytes))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"fits", tmp_str.len = sizeof("fits") - 1, &tmp_str)))))
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).quant_recommendation_candidates_quant_candidate_m_count, (zcbor_encoder_t *)encode_quant_candidate, state, (*&(*input).quant_recommendation_candidates_quant_candidate_m), sizeof(struct quant_candidate))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 9))));
		...
		zcbor_state_t *state, const struct response_model_quantize_started *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).response_model_quantize_started_ModelQuantizeStarted))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct quantize_status *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 8) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"id", tmp_str.len = sizeof("id") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).quantize_status_id))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"repo", tmp_str.len = sizeof("repo") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct response_model_quantizes *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_model_quantizes_ModelQuantizes_quantize_status_m_count, (zcbor_encoder_t *)encode_quantize_status, state, (*&(*input).response_model_quantizes_ModelQuantizes_quantize_status_m), sizeof(struct quantize_status))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct gguf_info *input)
{
	...
	&& (((*input).gguf_info_parameter_count_choice == gguf_info_parameter_count_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).gguf_info_parameter_count_uint))))
	: (((*input).gguf_info_parameter_count_choice == gguf_info_parameter_count_null_m_c) ? ((zcbor_nil_put(state, NULL)))
	: false)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"size_bytes", tmp_str.len = sizeof("size_bytes") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).gguf_info_size_bytes))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 8))));
		...
		zcbor_state_t *state, const struct profile_info *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).profile_info_bound_accounts_bound_account_m_count, (zcbor_encoder_t *)encode_bound_account, state, (*&(*input).profile_info_bound_accounts_bound_account_m), sizeof(struct bound_account))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 5))));
		...
		zcbor_state_t *state, const struct response_profiles *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_profiles_Profiles_profile_info_m_count, (zcbor_encoder_t *)encode_profile_info, state, (*&(*input).response_profiles_Profiles_profile_info_m), sizeof(struct profile_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const void *input)
{
	...
	&& (zcbor_nil_put(state, NULL)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_credentials *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_credentials_Credentials_credential_info_m_count, (zcbor_encoder_t *)encode_credential_info, state, (*&(*input).response_credentials_Credentials_credential_info_m), sizeof(struct credential_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct model_descriptor *input)
{
	...
	&& (((*input).model_descriptor_input_price_micros_per_mtok_choice == model_descriptor_input_price_micros_per_mtok_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).model_descriptor_input_price_micros_per_mtok_uint))))
	...
	&& (((*input).model_descriptor_output_price_micros_per_mtok_choice == model_descriptor_output_price_micros_per_mtok_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).model_descriptor_output_price_micros_per_mtok_uint))))
		...
		zcbor_state_t *state, const struct response_models *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_models_Models_model_descriptor_m_count, (zcbor_encoder_t *)encode_model_descriptor, state, (*&(*input).response_models_Models_model_descriptor_m), sizeof(struct model_descriptor))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct revision *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).revision_seq))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"parent", tmp_str.len = sizeof("parent") - 1, &tmp_str)))))
	&& (((*input).revision_parent_choice == revision_parent_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).revision_parent_uint))))
	...
	&& (encode_byte_array(state, (&(*input).revision_content_hash))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"author", tmp_str.len = sizeof("author") - 1, &tmp_str)))))
	...
	&& (zcbor_uint32_encode(state, (&(*input).revision_ts_ms))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 6))));
		...
		zcbor_state_t *state, const struct response_revisions *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_revisions_Revisions_revision_m_count, (zcbor_encoder_t *)encode_revision, state, (*&(*input).response_revisions_Revisions_revision_m), sizeof(struct revision))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct skill_usage *input)
{
	...
	&& (((*input).skill_usage_last_viewed_ms_choice == skill_usage_last_viewed_ms_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).skill_usage_last_viewed_ms_uint))))
	...
	&& (((*input).skill_usage_last_patched_ms_choice == skill_usage_last_patched_ms_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).skill_usage_last_patched_ms_uint))))
		...
		zcbor_state_t *state, const struct response_curator_skills *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_curator_skills_CuratorSkills_curator_entry_m_count, (zcbor_encoder_t *)encode_curator_entry, state, (*&(*input).response_curator_skills_CuratorSkills_curator_entry_m), sizeof(struct curator_entry))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_curator_run *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"CuratorRun", tmp_str.len = sizeof("CuratorRun") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_curator_run_CuratorRun_curator_change_m_count, (zcbor_encoder_t *)encode_curator_change, state, (*&(*input).response_curator_run_CuratorRun_curator_change_m), sizeof(struct curator_change))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct auth_begin_response *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).auth_begin_response_expires_at))))
		...
		zcbor_state_t *state, const struct auth_provider_info *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).auth_provider_info_params_schema_auth_param_field_m_count, (zcbor_encoder_t *)encode_auth_param_field, state, (*&(*input).auth_provider_info_params_schema_auth_param_field_m), sizeof(struct auth_param_field))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 4))));
		...
		zcbor_state_t *state, const struct response_auth_providers *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_auth_providers_AuthProviders_auth_provider_info_m_count, (zcbor_encoder_t *)encode_auth_provider_info, state, (*&(*input).response_auth_providers_AuthProviders_auth_provider_info_m), sizeof(struct auth_provider_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct checkpoint_info_turn_ordinal_r *input)
{
	...
	&& (((*input).checkpoint_info_turn_ordinal_choice == checkpoint_info_turn_ordinal_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).checkpoint_info_turn_ordinal_uint))))
		...
		zcbor_state_t *state, const struct checkpoint_info_cursor_r *input)
{
	...
	&& (((*input).checkpoint_info_cursor_choice == checkpoint_info_cursor_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).checkpoint_info_cursor_uint))))
		...
		zcbor_state_t *state, const struct checkpoint_info *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).checkpoint_info_created_unix))))
		...
		zcbor_state_t *state, const struct response_checkpoints *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_checkpoints_Checkpoints_checkpoint_info_m_count, (zcbor_encoder_t *)encode_checkpoint_info, state, (*&(*input).response_checkpoints_Checkpoints_checkpoint_info_m), sizeof(struct checkpoint_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct session_detail_delivery_targets_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).session_detail_delivery_targets_delivery_target_m_count, (zcbor_encoder_t *)encode_delivery_target, state, (*&(*input).session_detail_delivery_targets_delivery_target_m), sizeof(struct delivery_target))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct session_detail_children_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).session_detail_children_session_id_m_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).session_detail_children_session_id_m), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct SessionsByProfile_profile_l *input)
{
	...
	&& ((zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).profile_l_sessions_session_info_m_count, (zcbor_encoder_t *)encode_session_info, state, (*&(*input).profile_l_sessions_session_info_m), sizeof(struct session_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_sessions_by_profile *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).SessionsByProfile_profile_l_count, (zcbor_encoder_t *)encode_repeated_SessionsByProfile_profile_l, state, (*&(*input).SessionsByProfile_profile_l), sizeof(struct SessionsByProfile_profile_l))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_session_search *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"SessionSearch", tmp_str.len = sizeof("SessionSearch") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_session_search_SessionSearch_session_search_hit_m_count, (zcbor_encoder_t *)encode_session_search_hit, state, (*&(*input).response_session_search_SessionSearch_session_search_hit_m), sizeof(struct session_search_hit))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_acp_catalog *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_acp_catalog_AcpCatalog_acp_agent_entry_m_count, (zcbor_encoder_t *)encode_acp_agent_entry, state, (*&(*input).response_acp_catalog_AcpCatalog_acp_agent_entry_m), sizeof(struct acp_agent_entry))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_providers *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_providers_Providers_provider_info_m_count, (zcbor_encoder_t *)encode_provider_info, state, (*&(*input).response_providers_Providers_provider_info_m), sizeof(struct provider_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_tools *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_tools_Tools_tool_info_m_count, (zcbor_encoder_t *)encode_tool_info, state, (*&(*input).response_tools_Tools_tool_info_m), sizeof(struct tool_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct cron_job_next_fire_unix_r *input)
{
	...
	&& (((*input).cron_job_next_fire_unix_choice == cron_job_next_fire_unix_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).cron_job_next_fire_unix_uint))))
		...
		zcbor_state_t *state, const struct cron_job_last_run_unix_r *input)
{
	...
	&& (((*input).cron_job_last_run_unix_choice == cron_job_last_run_unix_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).cron_job_last_run_unix_uint))))
		...
		zcbor_state_t *state, const struct response_cron_jobs *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_cron_jobs_CronJobs_cron_job_m_count, (zcbor_encoder_t *)encode_cron_job, state, (*&(*input).response_cron_jobs_CronJobs_cron_job_m), sizeof(struct cron_job))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct cron_run_finished_unix_r *input)
{
	...
	&& (((*input).cron_run_finished_unix_choice == cron_run_finished_unix_uint_c) ? ((zcbor_uint32_encode(state, (&(*input).cron_run_finished_unix_uint))))
		...
		zcbor_state_t *state, const struct cron_run *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).cron_run_started_unix))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"ok", tmp_str.len = sizeof("ok") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct response_cron_runs *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"CronRuns", tmp_str.len = sizeof("CronRuns") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_cron_runs_CronRuns_cron_run_m_count, (zcbor_encoder_t *)encode_cron_run, state, (*&(*input).response_cron_runs_CronRuns_cron_run_m), sizeof(struct cron_run))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_cron_suggestions *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_cron_suggestions_CronSuggestions_cron_suggestion_m_count, (zcbor_encoder_t *)encode_cron_suggestion, state, (*&(*input).response_cron_suggestions_CronSuggestions_cron_suggestion_m), sizeof(struct cron_suggestion))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_chat_routes *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_chat_routes_ChatRoutes_chat_route_m_count, (zcbor_encoder_t *)encode_chat_route, state, (*&(*input).response_chat_routes_ChatRoutes_chat_route_m), sizeof(struct chat_route))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_rooms *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_rooms_Rooms_room_info_m_count, (zcbor_encoder_t *)encode_room_info, state, (*&(*input).response_rooms_Rooms_room_info_m), sizeof(struct room_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_adapters *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_adapters_Adapters_adapter_info_m_count, (zcbor_encoder_t *)encode_adapter_info, state, (*&(*input).response_adapters_Adapters_adapter_info_m), sizeof(struct adapter_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_transport_instances *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_transport_instances_TransportInstances_transport_instance_info_m_count, (zcbor_encoder_t *)encode_transport_instance_info, state, (*&(*input).response_transport_instances_TransportInstances_transport_instance_info_m), sizeof(struct transport_instance_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct conversation_info_members_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).conversation_info_members_conversation_member_m_count, (zcbor_encoder_t *)encode_conversation_member, state, (*&(*input).conversation_info_members_conversation_member_m), sizeof(struct conversation_member))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct response_conversations *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_conversations_Conversations_conversation_info_m_count, (zcbor_encoder_t *)encode_conversation_info, state, (*&(*input).response_conversations_Conversations_conversation_info_m), sizeof(struct conversation_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct response_contacts *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_contacts_Contacts_contact_info_m_count, (zcbor_encoder_t *)encode_contact_info, state, (*&(*input).response_contacts_Contacts_contact_info_m), sizeof(struct contact_info))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct action_menu_items_r *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).action_menu_items_tstr_count, (zcbor_encoder_t *)zcbor_tstr_encode, state, (*&(*input).action_menu_items_tstr), sizeof(struct zcbor_string))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16))));
		...
		zcbor_state_t *state, const struct response_fs_list *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"FsList", tmp_str.len = sizeof("FsList") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).response_fs_list_FsList_fs_entry_m_count, (zcbor_encoder_t *)encode_fs_entry, state, (*&(*input).response_fs_list_FsList_fs_entry_m), sizeof(struct fs_entry))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct fs_content *input)
{
	...
	&& (encode_byte_array(state, (&(*input).fs_content_bytes))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"revision", tmp_str.len = sizeof("revision") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct fs_search_page *input)
{
	...
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).fs_search_page_hits_fs_search_hit_m_count, (zcbor_encoder_t *)encode_fs_search_hit, state, (*&(*input).fs_search_page_hits_fs_search_hit_m), sizeof(struct fs_search_hit))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
		...
		zcbor_state_t *state, const struct fs_watch_page_view *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 2) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"events", tmp_str.len = sizeof("events") - 1, &tmp_str)))))
	&& (zcbor_list_start_encode(state, 16) && ((zcbor_multi_encode_minmax(0, 16, &(*input).fs_watch_page_view_events_fs_change_m_count, (zcbor_encoder_t *)encode_fs_change, state, (*&(*input).fs_watch_page_view_events_fs_change_m), sizeof(struct fs_change))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_list_end_encode(state, 16)))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"next_seq", tmp_str.len = sizeof("next_seq") - 1, &tmp_str)))))
	&& (zcbor_uint32_encode(state, (&(*input).fs_watch_page_view_next_seq))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 2))));
		...
		zcbor_state_t *state, const struct response_blob_get *input)
{
	...
	bool res = (((zcbor_map_start_encode(state, 1) && (((((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"BlobGet", tmp_str.len = sizeof("BlobGet") - 1, &tmp_str)))))
	&& (encode_byte_array(state, (&(*input).response_blob_get_BlobGet))))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 1))));
		...
		zcbor_state_t *state, const struct blob_stat *input)
{
	...
	&& (zcbor_uint32_encode(state, (&(*input).blob_stat_size))))
	&& (((zcbor_tstr_encode(state, ((tmp_str.value = (uint8_t *)"present", tmp_str.len = sizeof("present") - 1, &tmp_str)))))
		...
		zcbor_state_t *state, const struct api_response_r *input)
{
	...
	: (((*input).api_response_choice == api_response_response_profile_m_c) ? ((encode_response_profile(state, NULL)))
		...
		zcbor_state_t *state, const struct api_request_r *input)
{
	...
	: (((*input).api_request_choice == api_request_request_profile_create_m_c) ? ((encode_request_profile_create(state, NULL)))
	: (((*input).api_request_choice == api_request_request_profile_update_m_c) ? ((encode_request_profile_update(state, NULL)))
