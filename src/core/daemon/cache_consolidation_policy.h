...
inline constexpr PersistencePolicy kPersistencePolicies[] = {
    ...
    },
    {
        ...
        "Use only when ServiceMode::Mock is active; do not write daemon-authoritative domains here in daemon mode.",
    },
    {
        "daemon_cache.db",
        PersistenceOwner::DaemonAuthoritativeCache,
        "Primary last-known cache for daemon sessions, logs, cursors, profiles, approvals, and filesystem metadata.",
    },
    {
        "sessions.db",
        PersistenceOwner::ImportOnlyLegacy,
        "Retain for existing mock/local sessions and future one-time import; do not dual-write daemon sessions long term.",
    },
};
