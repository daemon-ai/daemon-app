...
public:
    ...
    BlockProjection project(const BlockRecord &block, bool revealMarkdown = false, qsizetype rawCursor = -1,
                            qreal contentWidth = 0) const;
...
private:
    ...
    void appendVisual(BlockProjection &projection, const QString &raw, qsizetype rawIndex, qsizetype length, SpanKind kind) const;
