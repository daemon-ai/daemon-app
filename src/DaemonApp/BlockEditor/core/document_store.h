...
public:
    ...
    bool splitBlock(BlockId id, qsizetype utf16Offset, BlockId* resultBlock = nullptr,
                    qsizetype* resultCursor = nullptr, bool trimBoundary = false);
    ...
    BlockId appendTypedBlock(BlockType type, const QVariantMap& metadata,
                             BlockChangeSet* changeSet = nullptr);
    ...
    void spliceBlocks(qsizetype firstRow, qsizetype removeCount,
