...
// The android and iOS builds link KSyntaxHighlighting's QML plugin statically
// (BUILD_SHARED_LIBS=OFF / static Qt, see App/CMakeLists.txt); on every other
// platform the module is a shared plugin resolved via the engine import path.
