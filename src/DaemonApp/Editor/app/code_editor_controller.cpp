...
CodeEditorController::CodeEditorController(QObject* parent)
    ...
    , m_hl(new CodeHighlighter(m_doc, this))
...
int CodeEditorController::lineCount() const { return m_doc->lineCount(); }
bool CodeEditorController::modified() const { return m_doc->modified(); }
bool CodeEditorController::canUndo() const { return m_doc->canUndo(); }
bool CodeEditorController::canRedo() const { return m_doc->canRedo(); }
QString CodeEditorController::languageName() const { return m_hl->definitionName(); }
QString CodeEditorController::text() const { return m_doc->text(); }
int CodeEditorController::columnsInLine(int line) const { return m_doc->line(line).size(); }

Pos CodeEditorController::selMin() const { return (m_caret < m_anchor) ? m_caret : m_anchor; }
Pos CodeEditorController::selMax() const { return (m_caret < m_anchor) ? m_anchor : m_caret; }
int CodeEditorController::selStartLine() const { return selMin().line; }
int CodeEditorController::selStartColumn() const { return selMin().col; }
int CodeEditorController::selEndLine() const { return selMax().line; }
int CodeEditorController::selEndColumn() const { return selMax().col; }
