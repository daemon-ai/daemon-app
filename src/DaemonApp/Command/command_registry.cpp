    ...
    : QAbstractListModel(parent)
{
    ...
    m_all = {
        { QStringLiteral("new"), tr("New conversation"), tr("Conversation"),
          tr("Start a fresh chat"), QStringLiteral("Ctrl+T") },
        { QStringLiteral("search"), tr("Search conversations"), tr("Navigation"),
        ...
        { QStringLiteral("clear"), tr("Clear conversation"), tr("Session"),
